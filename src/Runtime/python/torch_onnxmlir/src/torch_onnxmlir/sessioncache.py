...
# These are extensions of onnx files generated by torch.onnx.export.
ONNX_FILE_EXTS = [".onnx", ".onnx_data", ".data"]
# These are extensions of files generated by onnx-mlir compiler.
OM_COMPILED_FILE_EXTS = [".so", ".constants.bin"]
