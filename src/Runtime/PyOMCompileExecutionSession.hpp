...
#include "../Compiler/PyOMCompileSession.hpp"
...
class PyOMCompileExecutionSession {
public:
...
private:
  ...
  onnx_mlir::PyExecutionSession *executionSession;
  onnx_mlir::PyOMCompileSession *pyOMCompileSession;
  int64_t rc;
};
} // namespace onnx_mlir
