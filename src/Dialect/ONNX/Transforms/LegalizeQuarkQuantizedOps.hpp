...
#ifndef ONNX_MLIR_LEGALIZE_QUARK_QUANTIZED_OPS_H
#define ONNX_MLIR_LEGALIZE_QUARK_QUANTIZED_OPS_H
...
void getLegalizeQuarkQuantizedOpsPatterns(mlir::RewritePatternSet &patterns);
