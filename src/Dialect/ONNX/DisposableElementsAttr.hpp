...
private:
  static DisposableElementsAttr get(ShapedType type, size_t id, const Buffer &buffer,
  ...
  static DisposableElementsAttr create(ShapedType type, size_t id, const Buffer &buffer,
