...
//     llvm::cl::desc(
//         "call onnx version converter to convert ONNX model to current
//         version"),
...
//     llvm::cl::desc(
//         "invoke extra onnx transform pass(shape inference, constant and
//         etc.)"),
...
//     llvm::cl::cat(OnnxMlirOptions), llvm::cl::Hidden,
...
//   // from ONNX dialect to Standard dialect exposes additional
//   canonicalization
//   // opportunities.
//   pm.addPass(mlir::createCanonicalizerPass());
...
//   // Currently this has to be done *after* lowering the affine dialect
//   because
