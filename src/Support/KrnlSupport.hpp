...
// casting.
mlir::Value emitConstantOp(
    mlir::OpBuilder &rewriter, mlir::Location loc, mlir::Type type, double value);
...
bool usedBySameOp(mlir::KrnlGetRefOp *firstGetRef, mlir::KrnlGetRefOp *secondGetRef);
...
bool opBeforeOp(mlir::Block *block, mlir::Operation *beforeOp, mlir::Operation *afterOp);
...
mlir::Value getDynamicMemRefSizeInBytes(mlir::MemRefType type, mlir::Location loc,
    mlir::PatternRewriter &rewriter, mlir::memref::AllocOp allocOp);
