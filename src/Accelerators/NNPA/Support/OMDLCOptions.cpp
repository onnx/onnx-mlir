...
#include "OMDLCOptions.hpp"

llvm::cl::OptionCategory OMDLCPassOptions(
    "DLC Pass Options", "These are options to provide fine control on passes");
...
llvm::cl::opt<std::string> instrumentZHighOps("instrument-zhigh-ops",
    ...
    llvm::cl::init(""), llvm::cl::cat(OMDLCPassOptions));
