...
//===-------------- DLCOpt.cpp - Optimization Driver --------------------===//
//
...
#include "src/InitDLCPasses.hpp"
#include "third_party/onnx-mlir/src/Dialect/Krnl/KrnlOps.hpp"
#include "third_party/onnx-mlir/src/Dialect/ONNX/ONNXOps.hpp"
#include "third_party/onnx-mlir/src/InitMLIRPasses.hpp"
...
int main(int argc, char **argv) {
  ...
  initMLIRPasses();
  initDLCPasses(OptimizationLevel);
