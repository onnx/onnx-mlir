...
llvm::cl::opt<bool> profileZHighIR("profile-zhigh-ir",
    llvm::cl::desc("Profile operations in ZHighIR, including ONNX and ZHigh "
                   "ops. ZHighIR means the IR generated by --EmitZHighIR"),
