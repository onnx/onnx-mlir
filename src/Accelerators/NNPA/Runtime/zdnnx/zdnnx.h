 ...
 * @note For clang compilers, this function needs to be static inline if the implementation
 * is in a header file. Otherwise, it will cause errors when linking multiple object files
 * that include this header file. This is a common issue with inline functions defined
 * in header files.
 **/
