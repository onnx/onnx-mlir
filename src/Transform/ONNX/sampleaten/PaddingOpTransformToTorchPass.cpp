 ...
 *
 * Operands :
 * data		tensor of 16-bit/32-bit/64-bit float values or memref of any
 *type values
 * pads	        tensor of 64-bit signless integer values or memref of any type
 *values constant_value tensor of 16-bit/32-bit/64-bit float values or memref of
 *any type values
 *
 * Output   :
 *
...
class ApplyONNXPaddingToAtenConstantPadNdOp
    : public OpRewritePattern<ONNXPadOp> {
public:
...
class ONNXToAtenConstantPadNdOpTransformPass
    : public PassWrapper<ONNXToAtenConstantPadNdOpTransformPass,
          OperationPass<::mlir::FuncOp>> {

  StringRef getArgument() const override {
    return "onnx-to-aten-constantpadnd-transform";
  }
  ...
  void runOnOperation() override {
    ...
    // auto *dialect1 =
    // context->getOrLoadDialect<::mlir::torch::Torch::TorchDialect>(); auto
    // *dialect2 =
