...
class DecomposeONNXToAtenLeakyReluOp
...
public:
  ...
  LogicalResult matchAndRewrite(
    ...
    auto f3 = FloatAttr::get(
        /*alpha.getType()*/ mlir::FloatType::getF64(op.getContext()),
...
class ONNXToAtenLeakyReluOpTransformPass
    : public PassWrapper<ONNXToAtenLeakyReluOpTransformPass,
          OperationPass<::mlir::FuncOp>> {
  StringRef getArgument() const override {
    return "onnx-to-aten-leakyrelu-transform";
  }
