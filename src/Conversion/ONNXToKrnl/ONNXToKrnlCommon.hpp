...
void insertInstrumentBefore(Operation *currentOp, PatternRewriter &rewwriter, Location loc);

// Insert an instrument function after an op
void insertInstrumentAfter(Operation *currentOp, PatternRewriter &rewwriter, Location loc);
