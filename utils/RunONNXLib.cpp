...
/*
  ...
  Compile as follows. Command verified on MacOS and Z.

  g++ RunONNXLib-v2.cpp -o run-onnx-lib -I $LLVM_PROJ_SRC/llvm/include -I
    $LLVM_PROJ_BUILD/include -I $ONNX_PROJ_SRC/include -std=c++14 -L
    $LLVM_PROJ_BUILD/lib -lLLVMSupport -lLLVMDemangle -lcurses -lpthread -ldl
