...
def print_usage(msg = ""):
    if msg:
        print("Error:", msg, "\n")
    print("make-report -[h] -i <file_log> [-d <num>] [-p <op regexp>]")
    print("")
...
def make_report():
    global report_pattern_count, report_level_pattern_count
    global report_level, stat_message
...
def main(argv):
    global report_level, focus_on_op_with_pattern

    file_name = ""
    try:
        opts, args = getopt.getopt(
            argv, "d:fhi:p:", ["detail=", "full", "help", "input=", "pattern="])
