...
// #include "mlir-onnx/Dialect/Mlir/DialectBuilder.hpp"
#include "onnx-mlir/Utils/IndexExpr.hpp"
...
mlir::onnx_mlir::ONNXConstantOp getONNXConstantOp(mlir::Value value);
...
template <typename RESULT_TYPE>
RESULT_TYPE getScalarValue(ONNXConstantOp constantOp, mlir::Type type);
