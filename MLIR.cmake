...
function(add_onnx_mlir_dialect_new dialect)
  ...
  mlir_tablegen(${dialect}Dialect.hpp.inc -gen-dialect-decls -dialect=onnx "-I${ONNX_MLIR_SRC_ROOT}")
  mlir_tablegen(${dialect}Dialect.cpp.inc -gen-dialect-defs -dialect=onnx "-I${ONNX_MLIR_SRC_ROOT}")
  add_public_tablegen_target(OM${dialect}IncGen)
endfunction()
