...
function(add_onnx_mlir_dialect_new tdfile dialect_namespace)
  set(LLVM_TARGET_DEFINITIONS ${tdfile}.td)
  mlir_tablegen(${tdfile}.hpp.inc -gen-op-decls "-I${ONNX_MLIR_SRC_ROOT}")
  mlir_tablegen(${tdfile}.cpp.inc -gen-op-defs "-I${ONNX_MLIR_SRC_ROOT}")
  mlir_tablegen(${tdfile}Dialect.hpp.inc -gen-dialect-decls -dialect=${dialect_namespace} "-I${ONNX_MLIR_SRC_ROOT}")
  mlir_tablegen(${tdfile}Dialect.cpp.inc -gen-dialect-defs -dialect=${dialect_namespace} "-I${ONNX_MLIR_SRC_ROOT}")
  mlir_tablegen(${tdfile}Types.hpp.inc -gen-typedef-decls -typedefs-dialect=${dialect_namespace} "-I${ONNX_MLIR_SRC_ROOT}")
  mlir_tablegen(${tdfile}Types.cpp.inc -gen-typedef-defs -typedefs-dialect=${dialect_namespace} "-I${ONNX_MLIR_SRC_ROOT}")
  add_public_tablegen_target(OM${tdfile}IncGen)
endfunction()
