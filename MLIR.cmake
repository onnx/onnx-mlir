...
function(add_onnx_mlir_dialect tdfile)
  set(LLVM_TARGET_DEFINITIONS ${tdfile}.td)
  mlir_tablegen(${tdfile}Ops.hpp.inc -gen-op-decls "-I${ONNX_MLIR_SRC_ROOT}")
  mlir_tablegen(${tdfile}Ops.cpp.inc -gen-op-defs "-I${ONNX_MLIR_SRC_ROOT}")
  if (${ARGC} EQUAL 2) 
    set(dialect_name ${ARGN})
    mlir_tablegen(ONNXDialect.hpp.inc -gen-dialect-decls -dialect=${dialect_name} "-I${ONNX_MLIR_SRC_ROOT}")
    mlir_tablegen(${tdfile}Dialect.cpp.inc -gen-dialect-defs -dialect=${dialect_name} "-I${ONNX_MLIR_SRC_ROOT}")
    mlir_tablegen(${tdfile}Types.hpp.inc -gen-typedef-decls -typedefs-dialect=${dialect_name} "-I${ONNX_MLIR_SRC_ROOT}")
    mlir_tablegen(${tdfile}Types.cpp.inc -gen-typedef-defs -typedefs-dialect=${dialect_name} "-I${ONNX_MLIR_SRC_ROOT}")
  endif()
  add_public_tablegen_target(OM${tdfile}OpsIncGen)
endfunction()
