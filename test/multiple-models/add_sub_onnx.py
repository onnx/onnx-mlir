...
group.add_argument('--create-models',
                    action='store_true',
                    help="mode to create models")
group.add_argument('--run-models',
                    action='store_true',
                    help="mode to run models")
...
if args.create_models:
    ...
    add_model_def = helper.make_model(
        add_graph_def,
        producer_name='multi-models-test')
    ...
    sub_model_def = helper.make_model(
        sub_graph_def,
        producer_name='multi-models-test-1')
...
if args.run_models:
    ...
    if (not os.environ.get('PY_LIB', None)):
        raise RuntimeError("Environment variable PY_LIB is not set, "
