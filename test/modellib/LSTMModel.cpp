...
bool LSTMLibBuilder::build() {
  ...
  pOmt = omTensorCreateWithRandomData(
      pShape, ONNX_TYPE_FLOAT, 0.0, (isNoneP) ? 0.0 : 1.0);
...
bool LSTMLibBuilder::prepareInputs(float dataRangeLB, float dataRangeUB) {
  ...
  list[1] = omTensorCreateWithRandomData(
      hShape, ONNX_TYPE_FLOAT, dataRangeHLL, dataRangeHUL);
  list[2] = omTensorCreateWithRandomData(
      cShape, ONNX_TYPE_FLOAT, dataRangeCLL, dataRangeCUL);
