...
func.func @test_replace_add_zero_constantofshape(%arg0: tensor<2x4xf32>, %arg1: tensor<?xi64>) -> tensor<2x4xf32> {
    ...
    %4 = onnx.ConstantOfShape(%2) {value = dense<0.000000e+00> : tensor<1xf32>} : (tensor<2xi64>) -> tensor<1x?xf32>
    %5 = "onnx.Add"(%arg0, %4) : (tensor<2x4xf32>, tensor<1x?xf32>) -> tensor<2x4xf32>
    return %5: tensor<2x4xf32>
// CHECK-LABEL:  func.func @test_replace_add_zero_constantofshape
...
func.func @test_replace_sub_zero_constantofshape(%arg0: tensor<2x4xf32>, %arg1: tensor<?xi64>) -> tensor<2x4xf32> {
    %0 = onnx.Constant dense<1> : tensor<1xi64>
    %1 = "onnx.Dim"(%arg1) {axis = 0 : si64} : (tensor<?xi64>) -> tensor<1xi64>
    %2 = "onnx.Concat"(%0, %1) {axis = 0 : si64} : (tensor<1xi64>, tensor<1xi64>) -> tensor<2xi64>
    %4 = onnx.ConstantOfShape(%2) {value = dense<0.000000e+00> : tensor<1xf32>} : (tensor<2xi64>) -> tensor<1x?xf32>
...
// CHECK-LABEL:  func.func @test_replace_sub_zero_constantofshape
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<2x4xf32>, [[PARAM_1_:%.+]]: tensor<?xi64>) -> tensor<2x4xf32> {
// CHECK-NOT:       onnx.Sub
// CHECK:           return [[PARAM_0_]] : tensor<2x4xf32>
// CHECK:         }
