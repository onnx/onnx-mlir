...
// CONSTPROP-DAG:       [[VAR_0_:%.+]] = "onnx.Constant"() {value = dense<[-1, 256, 256]> : tensor<3xi64>} : () -> tensor<3xi64>
...
// CONSTPROP-DAG:       [[VAR_3_:%.+]] = "onnx.Reshape"([[PARAM_1_]], [[VAR_2_]]) {allowzero = 0 : si64} : (tensor<4x12x256x64xf32>, tensor<3xi64>) -> tensor<48x256x64xf32>
...
// CONSTPROP-DAG:       [[VAR_0_:%.+]] = "onnx.Constant"() {value = dense<[-1, 256, 64]> : tensor<3xi64>} : () -> tensor<3xi64>
// CONSTPROP-DAG:       [[VAR_1_:%.+]] = "onnx.Reshape"([[PARAM_1_]], [[VAR_0_]]) {allowzero = 0 : si64} : (tensor<4x12x256x64xf32>, tensor<3xi64>) -> tensor<48x256x64xf32>
...
// CONSTPROP-DAG:       [[CST_3_:%.+]] = "onnx.Constant"() {value = dense<3> : tensor<1xi64>} : () -> tensor<1xi64>
// CONSTPROP-DAG:       [[CST_0_:%.+]] = "onnx.Constant"() {value = dense<0> : tensor<1xi64>} : () -> tensor<1xi64>
// CONSTPROP-DAG:       [[CST_1_:%.+]] = "onnx.Constant"() {value = dense<1> : tensor<1xi64>} : () -> tensor<1xi64>
// CONSTPROP-DAG:       [[CST_MINUS1_:%.+]] = "onnx.Constant"() {value = dense<-1> : tensor<1xi64>} : () -> tensor<1xi64>
// CONSTPROP-DAG:       [[CST_2_:%.+]] = "onnx.Constant"() {value = dense<2> : tensor<1xi64>} : () -> tensor<1xi64>
// CONSTPROP-DAG:       [[CST_4_:%.+]] = "onnx.Constant"() {value = dense<4> : tensor<1xi64>} : () -> tensor<1xi64>
// CONSTPROP:           [[VAR_6_:%.+]] = "onnx.Slice"([[VAR_0_]], [[CST_2_]], [[CST_4_]], [[CST_0_]], [[CST_1_]]) : (tensor<4xi64>, tensor<1xi64>, tensor<1xi64>, tensor<1xi64>, tensor<1xi64>) -> tensor<2xi64>
// CONSTPROP:           [[VAR_7_:%.+]] = "onnx.Concat"([[CST_MINUS1_]], [[VAR_6_]]) {axis = 0 : si64} : (tensor<1xi64>, tensor<2xi64>) -> tensor<3xi64>
...
// CONSTPROP-DAG:       [[VAR_19_:%.+]] = "onnx.Slice"([[VAR_11_]], [[CST_0_]], [[CST_2_]], [[CST_0_]], [[CST_1_]]) : (tensor<4xi64>, tensor<1xi64>, tensor<1xi64>, tensor<1xi64>, tensor<1xi64>) -> tensor<2xi64>
// CONSTPROP-DAG:       [[VAR_20_:%.+]] = "onnx.Slice"([[VAR_10_]], [[CST_0_]], [[CST_1_]], [[CST_0_]], [[CST_1_]]) : (tensor<2xi64>, tensor<1xi64>, tensor<1xi64>, tensor<1xi64>, tensor<1xi64>) -> tensor<1xi64>
// CONSTPROP-DAG:       [[VAR_21_:%.+]] = "onnx.Slice"([[VAR_11_]], [[CST_3_]], [[CST_4_]], [[CST_0_]], [[CST_1_]]) : (tensor<4xi64>, tensor<1xi64>, tensor<1xi64>, tensor<1xi64>, tensor<1xi64>) -> tensor<1xi64>
