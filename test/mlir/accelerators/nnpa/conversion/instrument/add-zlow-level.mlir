// RUN: onnx-mlir --maccel=NNPA --printIR --EmitZLowIR --instrument-stage=nnpaAfterZhighToZlow --instrument-ops="zlow." --InstrumentBeforeOp --InstrumentAfterOp --InstrumentReportTime %s  | FileCheck %s
...
// CHECK:           krnl.store
// CHECK:           krnl.store
// CHECK:           "krnl.runtime_instrument"() {opName = "zlow.add", tag = 5 : i64} : () -> ()
// CHECK:           "zlow.add"
// CHECK:           "krnl.runtime_instrument"() {opName = "zlow.add", tag = 6 : i64} : () -> ()
// CHECK:           memref.alloc()
// CHECK:           "krnl.runtime_instrument"() {opName = "zlow.unstick", tag = 5 : i64} : () -> ()
// CHECK:           "zlow.unstick"
