...
func.func @test_instrument_add_onnx_zhigh(%arg0 : tensor<1000x1000xf32>, %arg1 : tensor<1000x1xf32>) -> tensor<*xf32> {
  %0 = "onnx.Add"(%arg0, %arg1) {onnx_node_name = "onnx.Add1"} : (tensor<1000x1000xf32>, tensor<1000x1xf32>) -> tensor<*xf32>
  %1 = "onnx.Add"(%arg0, %0) {onnx_node_name = "onnx.Add2"} : (tensor<1000x1000xf32>, tensor<*xf32>) -> tensor<*xf32>  
