// RUN: onnx-mlir --maccel=NNPA  --printIR --EmitZHighIR --instrument-stage=nnpaAfterOnnxToOnnx --instrument-ops=onnx. --InstrumentBeforeOp --InstrumentAfterOp --InstrumentReportTime %s | FileCheck %s
