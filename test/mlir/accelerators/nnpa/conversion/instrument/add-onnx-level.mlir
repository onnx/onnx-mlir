// RUN: onnx-mlir --maccel=NNPA --printIR --EmitZHighIR --instrument-dialects=onnx --instrument-ops=ALL --InstrumentBeforeOp --InstrumentAfterOp --InstrumentReportTime %s | FileCheck %s
