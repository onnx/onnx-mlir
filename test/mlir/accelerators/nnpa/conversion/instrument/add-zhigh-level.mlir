// RUN: onnx-mlir --maccel=NNPA --printIR --EmitZLowIR --instrument-stage=nnpa-before-onnx-to-krnl --instrument-ops="zhigh." --InstrumentBeforeOp --InstrumentAfterOp --InstrumentReportTime %s  | FileCheck %s
