// RUN: onnx-mlir --maccel=NNPA --printIR --EmitZLowIR --instrument-stage=nnpaAfterOnnxToZhigh --instrument-ops="zhigh." --InstrumentBeforeOp --InstrumentAfterOp --InstrumentReportTime %s  | FileCheck %s
