...
func.func @test_load_config_file_all_on_cpu(%arg0: tensor<?x?x?xf32>) -> tensor<?x?x?xf32> {
  ...
  %1 = "onnx.MatMul"(%0,%arg0) {onnx_node_name = "MatMul_1"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
  %2 = "onnx.MatMul"(%1,%arg0) {onnx_node_name = "MatMul_2"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
...
// ALL-ON-CPU:           [[VAR_0_:%.+]] = "onnx.MatMul"([[PARAM_0_]], [[PARAM_0_]]) {device = "cpu", onnx_node_name = "MatMul_0"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
// ALL-ON-CPU:           [[VAR_1_:%.+]] = "onnx.MatMul"([[VAR_0_]], [[PARAM_0_]]) {device = "cpu", onnx_node_name = "MatMul_1"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
// ALL-ON-CPU:           [[VAR_2_:%.+]] = "onnx.MatMul"([[VAR_1_]], [[PARAM_0_]]) {device = "cpu", onnx_node_name = "MatMul_2"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
...
// ALL-RELU-ON-CPU:           [[VAR_0_:%.+]] = "onnx.MatMul"([[PARAM_0_]], [[PARAM_0_]]) {device = "cpu", onnx_node_name = "MatMul_0"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
// ALL-RELU-ON-CPU:           [[VAR_1_:%.+]] = "onnx.MatMul"([[VAR_0_]], [[PARAM_0_]]) {device = "cpu", onnx_node_name = "MatMul_1"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
// ALL-RELU-ON-CPU:           [[VAR_2_:%.+]] = "onnx.MatMul"([[VAR_1_]], [[PARAM_0_]]) {device = "cpu", onnx_node_name = "MatMul_2"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
...
// SOME-RELU-ON-CPU:           [[VAR_0_:%.+]] = "onnx.MatMul"([[PARAM_0_]], [[PARAM_0_]]) {device = "nnpa", onnx_node_name = "MatMul_0"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
// SOME-RELU-ON-CPU:           [[VAR_1_:%.+]] = "onnx.MatMul"([[VAR_0_]], [[PARAM_0_]]) {device = "cpu", onnx_node_name = "MatMul_1"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
// SOME-RELU-ON-CPU:           [[VAR_2_:%.+]] = "onnx.MatMul"([[VAR_1_]], [[PARAM_0_]]) {device = "cpu", onnx_node_name = "MatMul_2"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
...
// NOT-MATCH-RELU:           [[VAR_0_:%.+]] = "onnx.MatMul"([[PARAM_0_]], [[PARAM_0_]]) {device = "nnpa", onnx_node_name = "MatMul_0"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
// NOT-MATCH-RELU:           [[VAR_1_:%.+]] = "onnx.MatMul"([[VAR_0_]], [[PARAM_0_]]) {device = "nnpa", onnx_node_name = "MatMul_1"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
// NOT-MATCH-RELU:           [[VAR_2_:%.+]] = "onnx.MatMul"([[VAR_1_]], [[PARAM_0_]]) {device = "nnpa", onnx_node_name = "MatMul_2"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
...
// OVERLAPPING:           [[VAR_0_:%.+]] = "onnx.MatMul"([[PARAM_0_]], [[PARAM_0_]]) {device = "nnpa", onnx_node_name = "MatMul_0"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
// OVERLAPPING:           [[VAR_1_:%.+]] = "onnx.MatMul"([[VAR_0_]], [[PARAM_0_]]) {device = "cpu", onnx_node_name = "MatMul_1"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
// OVERLAPPING:           [[VAR_2_:%.+]] = "onnx.MatMul"([[VAR_1_]], [[PARAM_0_]]) {device = "cpu", onnx_node_name = "MatMul_2"} : (tensor<?x?x?xf32>, tensor<?x?x?xf32>) -> tensor<?x?x?xf32>
