// RUN: onnx-mlir-opt --device-placement=save-config-file=%S/save-cfg.json --march=z16 --maccel=NNPA --split-input-file %s && cat %S/save-cfg.json | FileCheck %s && rm %S/save-cfg.json
