...
func.func @test_div() -> tensor<10x10xf32> {
  ...
  %1 = "zhigh.Stick"(%cst1) {layout = "2D"} : (tensor<10x10xf32>) -> tensor<10x10xf32, #zhigh.layout<{dataLayout = "2D"}>>
  %2 = "zhigh.Div"(%0, %1) : (tensor<10x10xf32, #zhigh.layout<{dataLayout = "2D"}>>, tensor<10x10xf32, #zhigh.layout<{dataLayout = "2D"}>>) -> tensor<10x10xf32, #zhigh.layout<{dataLayout = "2D"}>>
  %3 = "zhigh.Unstick"(%2) : (tensor<10x10xf32, #zhigh.layout<{dataLayout = "2D"}>>) -> tensor<10x10xf32>
...
// CHECK:           [[VAR_1_:%.+]] = "onnx.Div"([[VAR_0_]], [[VAR_0_]]) : (tensor<10x10xf32>, tensor<10x10xf32>) -> tensor<10x10xf32>
