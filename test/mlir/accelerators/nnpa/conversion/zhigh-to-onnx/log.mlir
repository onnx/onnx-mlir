...
func.func @test_log() -> tensor<10x10xf32> {
  ...
  %1 = "zhigh.Log"(%0) : (tensor<10x10xf32, #zhigh.layout<{dataLayout = "2D"}>>) -> tensor<10x10xf32, #zhigh.layout<{dataLayout = "2D"}>>
...
// CHECK:           [[VAR_1_:%.+]] = "onnx.Log"([[VAR_0_]]) : (tensor<10x10xf32>) -> tensor<10x10xf32>
