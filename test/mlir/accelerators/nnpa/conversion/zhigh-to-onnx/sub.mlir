...
func.func @test_sub() -> tensor<10x10xf32> {
  ...
  %2 = "zhigh.Sub"(%0, %1) : (tensor<10x10xf32, #zhigh.layout<{dataLayout = "2D"}>>, tensor<10x10xf32, #zhigh.layout<{dataLayout = "2D"}>>) -> tensor<10x10xf32, #zhigh.layout<{dataLayout = "2D"}>>
...
// CHECK:           [[VAR_1_:%.+]] = "onnx.Sub"([[VAR_0_]], [[VAR_0_]]) : (tensor<10x10xf32>, tensor<10x10xf32>) -> tensor<10x10xf32>
