...
// CHECK-DAG:       [[VAR_0_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {toLayout = "2D"} : (tensor<4x8xf32>) -> tensor<4x8xf32, #zhigh.encoding<{dataLayout = "2D"}>>
// CHECK-DAG:       [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_1_]]) {toLayout = "2D"} : (tensor<8x16xf32>) -> tensor<8x16xf32, #zhigh.encoding<{dataLayout = "2D"}>>
...
// CHECK-DAG:       [[VAR_0_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {toLayout = "3DS"} : (tensor<100x4x8xf32>) -> tensor<100x4x8xf32, #zhigh.encoding<{dataLayout = "3DS"}>>
// CHECK-DAG:       [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_1_]]) {toLayout = "3DS"} : (tensor<100x8x16xf32>) -> tensor<100x8x16xf32, #zhigh.encoding<{dataLayout = "3DS"}>>
// CHECK-DAG:       [[VAR_cst_:%.+]] = "onnx.NoValue"() {value} : () -> none
...
// CHECK-DAG:       [[VAR_0_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {toLayout = "2D"} : (tensor<4x8xf32>) -> tensor<4x8xf32, #zhigh.encoding<{dataLayout = "2D"}>>
// CHECK-DAG:       [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_1_]]) {toLayout = "2D"} : (tensor<8x16xf32>) -> tensor<8x16xf32, #zhigh.encoding<{dataLayout = "2D"}>>
// CHECK-DAG:       [[VAR_2_:%.+]] = "zhigh.Stick"([[PARAM_2_]]) {toLayout = "1D"} : (tensor<16xf32>) -> tensor<16xf32, #zhigh.encoding<{dataLayout = "1D"}>>
...
// CHECK-DAG:       [[VAR_0_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {toLayout = "2D"} : (tensor<?x?xf32>) -> tensor<?x?xf32, #zhigh.encoding<{dataLayout = "2D"}>>
// CHECK-DAG:       [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_1_]]) {toLayout = "2D"} : (tensor<?x?xf32>) -> tensor<?x?xf32, #zhigh.encoding<{dataLayout = "2D"}>>
// CHECK-DAG:       [[VAR_cst_:%.+]] = "onnx.NoValue"() {value} : () -> none
...
// CHECK-DAG:       [[VAR_0_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {toLayout = "3DS"} : (tensor<?x?x?xf32>) -> tensor<?x?x?xf32, #zhigh.encoding<{dataLayout = "3DS"}>>
// CHECK-DAG:       [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_1_]]) {toLayout = "3DS"} : (tensor<?x?x?xf32>) -> tensor<?x?x?xf32, #zhigh.encoding<{dataLayout = "3DS"}>>
// CHECK-DAG:       [[VAR_cst_:%.+]] = "onnx.NoValue"() {value} : () -> none
