...
// CHECK:           [[VAR_2_:%.+]] = "zhigh.Add"([[VAR_0_]], [[VAR_1_]]) : (tensor<10x10x10xf32, #zhigh.layout<{dataLayout = "3DS"}>>, tensor<10x10x10xf32, #zhigh.layout<{dataLayout = "3DS"}>>) -> tensor<10x10x10xf32, #zhigh.layout<{dataLayout = "3DS"}>>
...
func.func @test_exceed_limit_add(%arg0 : tensor<32769x10xf32>, %arg1 : tensor<32769x10xf32>) -> tensor<*xf32> {
