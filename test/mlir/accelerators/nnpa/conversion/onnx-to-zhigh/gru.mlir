...
// CHECK-DAG:       [[VAR_5_:%.+]]:3 = "onnx.SplitV11"([[VAR_4_]]) {axis = 2 : si64} : (tensor<1x204x600xf32>) -> (tensor<1x204x200xf32>, tensor<1x204x200xf32>, tensor<1x204x200xf32>)
...
// CHECK-DAG:       [[VAR_8_:%.+]]:3 = "onnx.SplitV11"([[VAR_7_]]) {axis = 2 : si64} : (tensor<1x200x600xf32>) -> (tensor<1x200x200xf32>, tensor<1x200x200xf32>, tensor<1x200x200xf32>)
// CHECK-DAG:       [[VAR_9_:%.+]] = "zhigh.StickForGRU"([[VAR_8_]]#0, [[VAR_8_]]#1, [[VAR_8_]]#2) : (tensor<1x200x200xf32>, tensor<1x200x200xf32>, tensor<1x200x200xf32>) -> tensor<*xf32>
// CHECK-DAG:       [[VAR_10_:%.+]] = "zhigh.GRU"([[VAR_3_]], [[VAR_cst_]], [[VAR_6_]], [[VAR_1_]], [[VAR_9_]], [[VAR_2_]]) {direction = "forward", hidden_size = 200 : si64, return_all_steps = -1 : si64} : (tensor<7x2000x204xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, none, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>) -> tensor<*xf32>
// CHECK-DAG:       [[VAR_11_:%.+]] = "zhigh.Unstick"([[VAR_10_]]) : (tensor<*xf32>) -> tensor<7x1x2000x200xf32>
...
// CHECK-DAG:       [[VAR_6_:%.+]]:3 = "onnx.SplitV11"([[VAR_5_]]) {axis = 2 : si64} : (tensor<1x204x600xf32>) -> (tensor<1x204x200xf32>, tensor<1x204x200xf32>, tensor<1x204x200xf32>)
...
// CHECK-DAG:       [[VAR_9_:%.+]]:3 = "onnx.SplitV11"([[VAR_8_]]) {axis = 2 : si64} : (tensor<1x200x600xf32>) -> (tensor<1x200x200xf32>, tensor<1x200x200xf32>, tensor<1x200x200xf32>)
// CHECK-DAG:       [[VAR_10_:%.+]] = "zhigh.StickForGRU"([[VAR_9_]]#0, [[VAR_9_]]#1, [[VAR_9_]]#2) : (tensor<1x200x200xf32>, tensor<1x200x200xf32>, tensor<1x200x200xf32>) -> tensor<*xf32>
// CHECK-DAG:       [[VAR_11_:%.+]] = "zhigh.GRU"([[VAR_3_]], [[VAR_4_]], [[VAR_7_]], [[VAR_1_]], [[VAR_10_]], [[VAR_2_]]) {direction = "forward", hidden_size = 200 : si64, return_all_steps = -1 : si64} : (tensor<7x2000x204xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x2000x200xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>) -> tensor<*xf32>
// CHECK-DAG:       [[VAR_12_:%.+]] = "zhigh.Unstick"([[VAR_11_]]) : (tensor<*xf32>) -> tensor<7x1x2000x200xf32>
...
// CHECK-DAG:       [[VAR_3_:%.+]]:3 = "onnx.SplitV11"([[VAR_2_]]) {axis = 2 : si64} : (tensor<1x204x600xf32>) -> (tensor<1x204x200xf32>, tensor<1x204x200xf32>, tensor<1x204x200xf32>)
...
// CHECK-DAG:       [[VAR_6_:%.+]]:3 = "onnx.SplitV11"([[VAR_5_]]) {axis = 2 : si64} : (tensor<1x200x600xf32>) -> (tensor<1x200x200xf32>, tensor<1x200x200xf32>, tensor<1x200x200xf32>)
// CHECK-DAG:       [[VAR_7_:%.+]] = "zhigh.StickForGRU"([[VAR_6_]]#0, [[VAR_6_]]#1, [[VAR_6_]]#2) : (tensor<1x200x200xf32>, tensor<1x200x200xf32>, tensor<1x200x200xf32>) -> tensor<*xf32>
// CHECK-DAG:       [[VAR_8_:%.+]] = "zhigh.GRU"([[VAR_0_]], [[VAR_1_]], [[VAR_4_]], [[CST]], [[VAR_7_]], [[CST]]) {direction = "forward", hidden_size = 200 : si64, return_all_steps = 1 : si64} : (tensor<7x2000x204xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x2000x200xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<*xf32>, none, tensor<*xf32>, none) -> tensor<*xf32>
...
// CHECK-DAG:       [[VAR_5_:%.+]]:3 = "onnx.SplitV11"([[VAR_4_]]) {axis = 2 : si64} : (tensor<1x?x600xf32>) -> (tensor<1x?x200xf32>, tensor<1x?x200xf32>, tensor<1x?x200xf32>)
...
// CHECK-DAG:       [[VAR_8_:%.+]]:3 = "onnx.SplitV11"([[VAR_7_]]) {axis = 2 : si64} : (tensor<1x200x600xf32>) -> (tensor<1x200x200xf32>, tensor<1x200x200xf32>, tensor<1x200x200xf32>)
// CHECK-DAG:       [[VAR_9_:%.+]] = "zhigh.StickForGRU"([[VAR_8_]]#0, [[VAR_8_]]#1, [[VAR_8_]]#2) : (tensor<1x200x200xf32>, tensor<1x200x200xf32>, tensor<1x200x200xf32>) -> tensor<*xf32>
// CHECK-DAG:       [[VAR_10_:%.+]] = "zhigh.GRU"([[VAR_3_]], [[VAR_cst_]], [[VAR_6_]], [[VAR_1_]], [[VAR_9_]], [[VAR_2_]]) {direction = "forward", hidden_size = 200 : si64, return_all_steps = -1 : si64} : (tensor<?x?x?xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, none, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>) -> tensor<*xf32>
// CHECK-DAG:       [[VAR_11_:%.+]] = "zhigh.Unstick"([[VAR_10_]]) : (tensor<*xf32>) -> tensor<?x1x?x200xf32>
// CHECK-DAG:       [[VAR_12_:%.+]] = "onnx.Constant"() {value = dense<-1> : tensor<1xi64>} : () -> tensor<1xi64>
// CHECK-DAG:       [[VAR_13_:%.+]] = "onnx.Constant"() {value = dense<0> : tensor<1xi64>} : () -> tensor<1xi64>
// CHECK-DAG:       [[VAR_14_:%.+]] = "onnx.Constant"() {value = dense<1> : tensor<1xi64>} : () -> tensor<1xi64>
// CHECK-DAG:       [[VAR_15_:%.+]] = "onnx.Constant"() {value = dense<2147483647> : tensor<1xi64>} : () -> tensor<1xi64>
...
// CHECK-DAG:       [[VAR_5_:%.+]]:3 = "onnx.SplitV11"([[VAR_4_]]) {axis = 2 : si64} : (tensor<2x?x600xf32>) -> (tensor<2x?x200xf32>, tensor<2x?x200xf32>, tensor<2x?x200xf32>)
...
// CHECK-DAG:       [[VAR_8_:%.+]]:3 = "onnx.SplitV11"([[VAR_7_]]) {axis = 2 : si64} : (tensor<2x200x600xf32>) -> (tensor<2x200x200xf32>, tensor<2x200x200xf32>, tensor<2x200x200xf32>)
// CHECK-DAG:       [[VAR_9_:%.+]] = "zhigh.StickForGRU"([[VAR_8_]]#0, [[VAR_8_]]#1, [[VAR_8_]]#2) : (tensor<2x200x200xf32>, tensor<2x200x200xf32>, tensor<2x200x200xf32>) -> tensor<*xf32>
// CHECK-DAG:       [[VAR_10_:%.+]] = "zhigh.GRU"([[VAR_3_]], [[VAR_cst_]], [[VAR_6_]], [[VAR_1_]], [[VAR_9_]], [[VAR_2_]]) {direction = "bidirectional", hidden_size = 200 : si64, return_all_steps = -1 : si64} : (tensor<?x?x?xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, none, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>) -> tensor<*xf32>
// CHECK-DAG:       [[VAR_11_:%.+]] = "zhigh.Unstick"([[VAR_10_]]) : (tensor<*xf32>) -> tensor<?x2x?x200xf32>
// CHECK-DAG:       [[VAR_12_:%.+]] = "onnx.Constant"() {value = dense<-1> : tensor<1xi64>} : () -> tensor<1xi64>
// CHECK-DAG:       [[VAR_13_:%.+]] = "onnx.Constant"() {value = dense<0> : tensor<1xi64>} : () -> tensor<1xi64>
// CHECK-DAG:       [[VAR_14_:%.+]] = "onnx.Constant"() {value = dense<1> : tensor<1xi64>} : () -> tensor<1xi64>
// CHECK-DAG:       [[VAR_15_:%.+]] = "onnx.Constant"() {value = dense<2147483647> : tensor<1xi64>} : () -> tensor<1xi64>
