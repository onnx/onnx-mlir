...
// CHECK-DAG:       [[VAR_3_:%.+]] = "zhigh.Stick"([[X_]]) {layout = "3DS"} : (tensor<7x2000x204xf32>) -> tensor<7x2000x204xf32, #zhigh.layout<{dataLayout = "3DS"}>>
...
// CHECK:           [[VAR_10_:%.+]] = "zhigh.GRU"([[VAR_3_]], [[VAR_cst_]], [[VAR_6_]], [[VAR_1_]], [[VAR_9_]], [[VAR_2_]]) {direction = "forward", hidden_size = 200 : si64, return_all_steps = -1 : si64} : (tensor<7x2000x204xf32, #zhigh.layout<{dataLayout = "3DS"}>>, none, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>) -> tensor<*xf32>
...
// CHECK-DAG:       [[VAR_2_:%.+]] = "zhigh.StickForGRU"([[VAR_0_]]#3, [[VAR_0_]]#4, [[VAR_0_]]#5) : (tensor<1x200xf32>, tensor<1x200xf32>, tensor<1x200xf32>) -> tensor<*xf32>
// CHECK-DAG:       [[VAR_3_:%.+]] = "zhigh.Stick"([[X_]]) {layout = "3DS"} : (tensor<7x2000x204xf32>) -> tensor<7x2000x204xf32, #zhigh.layout<{dataLayout = "3DS"}>>
// CHECK-DAG:       [[VAR_4_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {layout = "3DS"} : (tensor<1x2000x200xf32>) -> tensor<1x2000x200xf32, #zhigh.layout<{dataLayout = "3DS"}>>
...
// CHECK:           [[VAR_11_:%.+]] = "zhigh.GRU"([[VAR_3_]], [[VAR_4_]], [[VAR_7_]], [[VAR_1_]], [[VAR_10_]], [[VAR_2_]]) {direction = "forward", hidden_size = 200 : si64, return_all_steps = -1 : si64} : (tensor<7x2000x204xf32, #zhigh.layout<{dataLayout = "3DS"}>>, tensor<1x2000x200xf32, #zhigh.layout<{dataLayout = "3DS"}>>, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>) -> tensor<*xf32>
...
// CHECK:           [[VAR_8_:%.+]] = "zhigh.GRU"([[VAR_0_]], [[VAR_1_]], [[VAR_4_]], [[CST]], [[VAR_7_]], [[CST]]) {direction = "forward", hidden_size = 200 : si64, return_all_steps = 1 : si64} : (tensor<7x2000x204xf32, #zhigh.layout<{dataLayout = "3DS"}>>, tensor<1x2000x200xf32, #zhigh.layout<{dataLayout = "3DS"}>>, tensor<*xf32>, none, tensor<*xf32>, none) -> tensor<*xf32>
...
// CHECK-DAG:       [[VAR_1_:%.+]] = "zhigh.StickForGRU"([[VAR_0_]]#0, [[VAR_0_]]#1, [[VAR_0_]]#2) : (tensor<1x200xf32>, tensor<1x200xf32>, tensor<1x200xf32>) -> tensor<*xf32>
// CHECK-DAG:       [[VAR_2_:%.+]] = "zhigh.StickForGRU"([[VAR_0_]]#3, [[VAR_0_]]#4, [[VAR_0_]]#5) : (tensor<1x200xf32>, tensor<1x200xf32>, tensor<1x200xf32>) -> tensor<*xf32>
// CHECK-DAG:       [[VAR_3_:%.+]] = "zhigh.Stick"([[X_]]) {layout = "3DS"} : (tensor<?x?x?xf32>) -> tensor<?x?x?xf32, #zhigh.layout<{dataLayout = "3DS"}>>
...
// CHECK:           [[VAR_8_:%.+]]:3 = "onnx.SplitV11"([[VAR_7_]]) {axis = 2 : si64} : (tensor<1x200x600xf32>) -> (tensor<1x200x200xf32>, tensor<1x200x200xf32>, tensor<1x200x200xf32>)
// CHECK:           [[VAR_9_:%.+]] = "zhigh.StickForGRU"([[VAR_8_]]#0, [[VAR_8_]]#1, [[VAR_8_]]#2) : (tensor<1x200x200xf32>, tensor<1x200x200xf32>, tensor<1x200x200xf32>) -> tensor<*xf32>
// CHECK:           [[VAR_10_:%.+]] = "zhigh.GRU"([[VAR_3_]], [[VAR_cst_]], [[VAR_6_]], [[VAR_1_]], [[VAR_9_]], [[VAR_2_]]) {direction = "forward", hidden_size = 200 : si64, return_all_steps = -1 : si64} : (tensor<?x?x?xf32, #zhigh.layout<{dataLayout = "3DS"}>>, none, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>) -> tensor<*xf32>
...
// CHECK:           [[VAR_10_:%.+]] = "zhigh.GRU"([[VAR_3_]], [[VAR_cst_]], [[VAR_6_]], [[VAR_1_]], [[VAR_9_]], [[VAR_2_]]) {direction = "bidirectional", hidden_size = 200 : si64, return_all_steps = -1 : si64} : (tensor<?x?x?xf32, #zhigh.layout<{dataLayout = "3DS"}>>, none, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>, tensor<*xf32>) -> tensor<*xf32>
