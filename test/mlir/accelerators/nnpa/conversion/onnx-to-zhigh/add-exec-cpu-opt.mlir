// RUN: onnx-mlir-opt --maccel=NNPA --maccel=NNPA --shape-inference --convert-onnx-to-zhigh=execNodesOnCpu=test/add0,test/add2 %s | FileCheck %s

func @test_add_force_cpu_opt(%arg0 : tensor<10x10xf32>, %arg1 : tensor<10x10xf32>) -> tensor<*xf32> {
