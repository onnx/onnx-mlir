...
func @test_tanh(%arg0 : tensor<10x10xf32>) -> tensor<*xf32> {
...
func @test_tanh_not_lowered_diff_shape(%arg0 : tensor<10x10xf32>) -> tensor<*xf32> {
  %0 = "onnx.Tanh"(%arg0) : (tensor<10x10xf32>) -> tensor<*xf32>
  "func.return"(%0) : (tensor<*xf32>) -> ()
...
func @test_exceed_limit_tanh(%arg0 : tensor<32769x10xf32>) -> tensor<*xf32> {
