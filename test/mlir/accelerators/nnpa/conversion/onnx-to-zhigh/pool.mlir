...
// CHECK:           [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {layout = "NHWC", saturation = -1 : si64} : (tensor<1x3x32x32xf32>) -> tensor<1x32x32x3xf16, #zhigh.layout<{dataLayout = "NHWC"}>>
...
// CHECK:           [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {layout = "NHWC", saturation = -1 : si64} : (tensor<1x1x5x5xf32>) -> tensor<1x5x5x1xf16, #zhigh.layout<{dataLayout = "NHWC"}>>
...
// CHECK:           [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {layout = "NHWC", saturation = -1 : si64} : (tensor<?x?x?x?xf32>) -> tensor<?x?x?x?xf16, #zhigh.layout<{dataLayout = "NHWC"}>>
