...
// -----
// CHECK-LABEL:  func @test_pool_not_lowered_1d
func @test_pool_not_lowered_1d(%arg0: tensor<1x3x32xf32>) -> (tensor<1x3x31xf32>, tensor<1x3x31xf32>) {
  %0 = "onnx.MaxPoolSingleOut"(%arg0) {kernel_shape = [2]} : (tensor<1x3x32xf32>) -> tensor<1x3x31xf32>
  // CHECK: "onnx.MaxPoolSingleOut"

  %1 = "onnx.AveragePool"(%arg0) {auto_pad = "NOTSET", kernel_shape = [2], pads = [0, 0], strides = [1]} : (tensor<1x3x32xf32>) -> tensor<1x3x31xf32>
