...
// CHECK-LABEL:  func @test_pool_not_lowered_input3d
func @test_pool_not_lowered_input3d(%arg0: tensor<1x3x32xf32>) -> (tensor<1x3x31xf32>, tensor<1x3x31xf32>) {
...
// -----
// COM: Pooling in zDNN only support 4D input (MaxPool1D and MaxPool3D not suported)
// CHECK-LABEL:  func @test_pool_not_lowered_input5d
func @test_pool_not_lowered_input5d(%arg0: tensor<1x3x32x32x32xf32>) -> (tensor<1x3x31x31x31xf32>, tensor<1x3x31x31x31xf32>) {
