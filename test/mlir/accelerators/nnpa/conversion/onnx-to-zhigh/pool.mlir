...
// CHECK:           [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {layout = "NHWC"} : (tensor<1x3x32x32xf32>) -> tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           [[VAR_2_:%.+]] = "zhigh.MaxPool2D"([[VAR_1_]]) {kernel_shape = [2, 2], padding_type = "VALID_PADDING", strides = [1, 1]} : (tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<*xf32>
...
// CHECK:           [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {layout = "NHWC"} : (tensor<1x1x5x5xf32>) -> tensor<1x5x5x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           [[VAR_2_:%.+]] = "zhigh.MaxPool2D"([[VAR_1_]]) {kernel_shape = [3, 3], padding_type = "SAME_PADDING", strides = [2, 2]} : (tensor<1x5x5x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<*xf32>
...
// CHECK:           [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {layout = "NHWC"} : (tensor<1x3x32x32xf32>) -> tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           [[VAR_2_:%.+]] = "zhigh.MaxPool2D"([[VAR_1_]]) {kernel_shape = [2, 2], padding_type = "SAME_PADDING", strides = [1, 1]} : (tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<*xf32>
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x3x32x32xf32>) -> tensor<1x3x31x31xf32> {
// CHECK:           [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {layout = "NHWC"} : (tensor<1x3x32x32xf32>) -> tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           [[VAR_2_:%.+]] = "zhigh.AvgPool2D"([[VAR_1_]]) {kernel_shape = [2, 2], padding_type = "VALID_PADDING", strides = [1, 1]} : (tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<*xf32>
// CHECK:           [[VAR_3_:%.+]] = "zhigh.Unstick"([[VAR_2_]]) : (tensor<*xf32>) -> tensor<1x3x31x31xf32>
// CHECK:           return [[VAR_3_]] : tensor<1x3x31x31xf32>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x1x5x5xf32>) -> tensor<1x1x3x3xf32> {
// CHECK:           [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {layout = "NHWC"} : (tensor<1x1x5x5xf32>) -> tensor<1x5x5x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           [[VAR_2_:%.+]] = "zhigh.AvgPool2D"([[VAR_1_]]) {kernel_shape = [3, 3], padding_type = "SAME_PADDING", strides = [2, 2]} : (tensor<1x5x5x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<*xf32>
// CHECK:           [[VAR_3_:%.+]] = "zhigh.Unstick"([[VAR_2_]]) : (tensor<*xf32>) -> tensor<1x1x3x3xf32>
// CHECK:           return [[VAR_3_]] : tensor<1x1x3x3xf32>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x3x32x32xf32>) -> tensor<1x3x32x32xf32> {
// CHECK:           [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {layout = "NHWC"} : (tensor<1x3x32x32xf32>) -> tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           [[VAR_2_:%.+]] = "zhigh.AvgPool2D"([[VAR_1_]]) {kernel_shape = [2, 2], padding_type = "SAME_PADDING", strides = [1, 1]} : (tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<*xf32>
// CHECK:           [[VAR_3_:%.+]] = "zhigh.Unstick"([[VAR_2_]]) : (tensor<*xf32>) -> tensor<1x3x32x32xf32>
// CHECK:           return [[VAR_3_]] : tensor<1x3x32x32xf32>
// CHECK:         }
}
...
// CHECK:           [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {layout = "NHWC"} : (tensor<?x?x?x?xf32>) -> tensor<?x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           [[VAR_2_:%.+]] = "zhigh.MaxPool2D"([[VAR_1_]]) {kernel_shape = [2, 2], padding_type = "VALID_PADDING", strides = [1, 1]} : (tensor<?x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<*xf32>
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<?x?x?x?xf32>) -> tensor<?x?x?x?xf32> {
// CHECK:           [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {layout = "NHWC"} : (tensor<?x?x?x?xf32>) -> tensor<?x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           [[VAR_2_:%.+]] = "zhigh.MaxPool2D"([[VAR_1_]]) {kernel_shape = [2, 2], padding_type = "SAME_PADDING", strides = [1, 1]} : (tensor<?x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<*xf32>
// CHECK:           [[VAR_3_:%.+]] = "zhigh.Unstick"([[VAR_2_]]) : (tensor<*xf32>) -> tensor<?x?x?x?xf32>
// CHECK:           return [[VAR_3_]] : tensor<?x?x?x?xf32>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<?x?x?x?xf32>) -> tensor<?x?x?x?xf32> {
// CHECK:           [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {layout = "NHWC"} : (tensor<?x?x?x?xf32>) -> tensor<?x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           [[VAR_2_:%.+]] = "zhigh.AvgPool2D"([[VAR_1_]]) {kernel_shape = [2, 2], padding_type = "VALID_PADDING", strides = [1, 1]} : (tensor<?x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<*xf32>
// CHECK:           [[VAR_3_:%.+]] = "zhigh.Unstick"([[VAR_2_]]) : (tensor<*xf32>) -> tensor<?x?x?x?xf32>
// CHECK:           return [[VAR_3_]] : tensor<?x?x?x?xf32>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<?x?x?x?xf32>) -> tensor<?x?x?x?xf32> {
// CHECK:           [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {layout = "NHWC"} : (tensor<?x?x?x?xf32>) -> tensor<?x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           [[VAR_2_:%.+]] = "zhigh.AvgPool2D"([[VAR_1_]]) {kernel_shape = [2, 2], padding_type = "SAME_PADDING", strides = [1, 1]} : (tensor<?x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<*xf32>
// CHECK:           [[VAR_3_:%.+]] = "zhigh.Unstick"([[VAR_2_]]) : (tensor<*xf32>) -> tensor<?x?x?x?xf32>
// CHECK:           return [[VAR_3_]] : tensor<?x?x?x?xf32>
// CHECK:         }
}
