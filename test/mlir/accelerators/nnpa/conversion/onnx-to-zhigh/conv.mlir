...
// CHECK-DAG:       [[VAR_1_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {layout = "NHWC"} : (tensor<5x3x32x32xf32>) -> tensor<5x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK-DAG:       [[VAR_2_:%.+]] = "onnx.Transpose"([[PARAM_1_]]) {perm = [2, 3, 1, 0]} : (tensor<2x3x2x2xf32>) -> tensor<2x2x3x2xf32>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_3_:%.+]] = "zhigh.Stick"([[VAR_2_]]) {layout = "HWCK"} : (tensor<2x2x3x2xf32>) -> tensor<2x2x3x2xf32, #zhigh.layout<{dataLayout = "HWCK"}>>
// CHECK-DAG:       [[VAR_4_:%.+]] = "zhigh.Stick"([[PARAM_2_]]) {layout = "1D"} : (tensor<2xf32>) -> tensor<2xf32, #zhigh.layout<{dataLayout = "1D"}>>
// CHECK:           [[VAR_5_:%.+]] = "zhigh.Conv2D"([[VAR_1_]], [[VAR_3_]], [[VAR_4_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "VALID_PADDING", strides = [1, 1]} : (tensor<5x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>, tensor<2x2x3x2xf32, #zhigh.layout<{dataLayout = "HWCK"}>>, tensor<2xf32, #zhigh.layout<{dataLayout = "1D"}>>) -> tensor<*xf32>
...
// CHECK:           [[VAR_5_:%.+]] = "zhigh.Conv2D"([[VAR_1_]], [[VAR_3_]], [[VAR_4_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "VALID_PADDING", strides = [1, 1]} : (tensor<5x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>, tensor<2x2x3x2xf32, #zhigh.layout<{dataLayout = "HWCK"}>>, none) -> tensor<*xf32>
// CHECK:           [[VAR_6_:%.+]] = "zhigh.Unstick"([[VAR_5_]]) : (tensor<*xf32>) -> tensor<5x2x31x31xf32>
// CHECK:           return [[VAR_6_]] : tensor<5x2x31x31xf32>
// CHECK:         }
}
...
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_3_:%.+]] = "zhigh.Stick"([[VAR_2_]]) {layout = "HWCK"} : (tensor<2x2x3x?xf32>) -> tensor<2x2x3x?xf32, #zhigh.layout<{dataLayout = "HWCK"}>>
// CHECK-DAG:       [[VAR_4_:%.+]] = "zhigh.Stick"([[VAR_cst_]]) {layout = "1D"} : (none) -> none
// CHECK:           [[VAR_5_:%.+]] = "zhigh.Conv2D"([[VAR_1_]], [[VAR_3_]], [[VAR_4_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "VALID_PADDING", strides = [1, 1]} : (tensor<5x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>, tensor<2x2x3x?xf32, #zhigh.layout<{dataLayout = "HWCK"}>>, none) -> tensor<*xf32>
...
// CHECK-DAG:       [[VAR_3_:%.+]] = "zhigh.Stick"([[VAR_2_]]) {layout = "HWCK"} : (tensor<2x2x3x2xf32>) -> tensor<2x2x3x2xf32, #zhigh.layout<{dataLayout = "HWCK"}>>
// CHECK-DAG:       [[VAR_4_:%.+]] = "zhigh.Stick"([[PARAM_2_]]) {layout = "1D"} : (tensor<2xf32>) -> tensor<2xf32, #zhigh.layout<{dataLayout = "1D"}>>
// CHECK:           [[VAR_5_:%.+]] = "zhigh.Conv2D"([[VAR_1_]], [[VAR_3_]], [[VAR_4_]]) {act_func = "ACT_RELU", kernel_shape = [2, 2], padding_type = "VALID_PADDING", strides = [1, 1]} : (tensor<5x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>, tensor<2x2x3x2xf32, #zhigh.layout<{dataLayout = "HWCK"}>>, tensor<2xf32, #zhigh.layout<{dataLayout = "1D"}>>) -> tensor<*xf32>
// CHECK:           [[VAR_6_:%.+]] = "zhigh.Unstick"([[VAR_5_]]) : (tensor<*xf32>) -> tensor<5x2x31x31xf32>
// CHECK:           return [[VAR_6_]] : tensor<5x2x31x31xf32>
// CHECK:         }
}
