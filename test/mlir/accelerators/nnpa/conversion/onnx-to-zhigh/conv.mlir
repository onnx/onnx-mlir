...
func @test_onnx_conv2d(%arg0: tensor<5x3x32x32xf32>, %arg1 : tensor<2x3x2x2xf32>, %arg2: tensor<2xf32>) -> tensor<*xf32> {
...
func @test_onnx_conv2d_nobias(%arg0: tensor<5x3x32x32xf32>, %arg1 : tensor<2x3x2x2xf32>) -> tensor<*xf32> {
...
func @test_onnx_conv2d_no_bias_unknown_bias_dims(%arg0: tensor<5x3x32x32xf32>, %arg1 : tensor<?x3x2x2xf32>) -> tensor<*xf32> {
  %bias = "onnx.NoValue"() {value} : () -> none  
...
func @test_onnx_conv2d_kernel_64(%arg0: tensor<5x3x1024x1024xf32>, %arg1 : tensor<2x3x64x64xf32>, %arg2: tensor<2xf32>) -> tensor<*xf32> {
...
func @test_onnx_conv2d_stride_13(%arg0: tensor<5x3x1024x1024xf32>, %arg1 : tensor<2x3x64x64xf32>, %arg2: tensor<2xf32>) -> tensor<*xf32> {
...
func @test_onnx_conv2d_not_lower_unknown_height_weight_dims(%arg0: tensor<5x3x?x?xf32>, %arg1 : tensor<2x3x2x2xf32>, %arg2: tensor<2xf32>) -> tensor<*xf32> {
...
func @test_onnx_conv2d_not_lower_not2D(%arg0: tensor<5x3x32x32x32xf32>, %arg1 : tensor<2x3x2x2x2xf32>, %arg2: tensor<2xf32>) -> tensor<*xf32> {
...
func @test_onnx_conv2d_not_lower_stride_greater_than_13(%arg0: tensor<5x3x32x32xf32>, %arg1 : tensor<2x3x2x2xf32>, %arg2: tensor<2xf32>) -> tensor<*xf32> {
...
func @test_onnx_conv2d_not_lower_kernel_height_greater_than_64_valid_padding(%arg0: tensor<5x3x1024x1024xf32>, %arg1 : tensor<2x3x65x65xf32>, %arg2: tensor<2xf32>) -> tensor<*xf32> {
...
func @test_onnx_conv2d_not_lower_kernel_height_greater_than_64_same_padding(%arg0: tensor<5x3x1024x1024xf32>, %arg1 : tensor<2x3x128x128xf32>, %arg2: tensor<2xf32>) -> tensor<*xf32> {
...
func @test_onnx_conv2d_not_lower_kernel_weight_greater_than_64_valid_padding(%arg0: tensor<5x3x1024x1024xf32>, %arg1 : tensor<2x3x65x65xf32>, %arg2: tensor<2xf32>) -> tensor<*xf32> {
  %0 = "onnx.Conv"(%arg0, %arg1, %arg2) {kernel_shape = [65, 65]} : (tensor<5x3x1024x1024xf32>, tensor<2x3x65x65xf32>, tensor<2xf32>) -> tensor<*xf32>
  return %0 : tensor<*xf32>
...
func @test_onnx_conv2d_not_lower_kernel_weight_greater_than_64_same_padding(%arg0: tensor<5x3x1024x1024xf32>, %arg1 : tensor<2x3x128x128xf32>, %arg2: tensor<2xf32>) -> tensor<*xf32> {
  %0 = "onnx.Conv"(%arg0, %arg1, %arg2) {auto_pad="SAME_UPPER", kernel_shape = [128, 128]} : (tensor<5x3x1024x1024xf32>, tensor<2x3x128x128xf32>, tensor<2xf32>) -> tensor<*xf32>
  return %0 : tensor<*xf32>
...
func @test_onnx_conv2d_not_lower_group(%arg0: tensor<5x3x1024x1024xf32>, %arg1 : tensor<3x1x2x2xf32>, %arg2: tensor<3xf32>) -> tensor<*xf32> {
...
func @test_onnx_conv2d_not_lowered_not_same_padding(%arg0: tensor<5x3x32x32xf32>, %arg1 : tensor<?x3x2x2xf32>) -> tensor<*xf32> {
  %bias = "onnx.NoValue"() {value} : () -> none  
...
func @test_onnx_conv2d_not_lowered_zdnn_do_padding_differently(%arg0: tensor<1x3x224x224xf32>, %arg1 : tensor<64x3x7x7xf32>, %arg2 : tensor<64xf32>) -> tensor<*xf32> {
...
func @test_exceed_limit_conv2d(%arg0: tensor<32769x3x32x32xf32>, %arg1 : tensor<32769x3x2x2xf32>, %arg2: tensor<32769xf32>) -> tensor<*xf32> {
