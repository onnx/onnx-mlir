...
// CHECK:           [[VAR_1_:%.+]] = "zhigh.Sigmoid"([[VAR_0_]]) : (tensor<10x10xf16, #zhigh.layout<{dataLayout = "2D"}>>) -> tensor<10x10xf16, #zhigh.layout<{dataLayout = "2D"}>>
...
func.func @test_sigmoid_not_lowered_diff_shape(%arg0 : tensor<10x10xf32>) -> tensor<*xf32> {
  ...
  // CHECK-LABEL: test_sigmoid_not_lowered_diff_shape
}
...
// CHECK-LABEL:  func @test_exceed_limit_sigmoid
// CHECK:        "onnx.Sigmoid"
}
