// RUN: onnx-mlir-opt --march=z16 --maccel=NNPA --disable-compiler-stick-unstick --nnpa-disable-saturation --shape-inference --convert-onnx-to-krnl --canonicalize %s -split-input-file | FileCheck %s

func.func @should_lower_to_zlow(%arg0: tensor<1x3x5x7xf32>) -> tensor<*xf32> {
  %0 = "zhigh.Stick"(%arg0) {layout = "NHWC", saturation = 0 : si64} : (tensor<1x3x5x7xf32>) -> tensor<*xf16>
...
// CHECK:           "zlow.stick"([[PARAM_0_]], [[RES_]]) {layout = "NCHW", saturation = 0 : si64} : (memref<1x3x5x7xf32>, memref<1x5x7x3xf16, [[MAP_0_]]>) -> ()
...
func.func @should_lower_to_zlow_unknown_dims(%arg0: tensor<1x?x?x7xf32>) -> tensor<*xf32> {
  %0 = "zhigh.Stick"(%arg0) {layout = "NHWC", saturation = 0 : si64} : (tensor<1x?x?x7xf32>) -> tensor<*xf16>
  %1 = "zhigh.Unstick"(%0) : (tensor<*xf16>) -> tensor<*xf32>
  return %1 : tensor<*xf32>
...
// CHECK:           "zlow.stick"([[PARAM_0_]], [[RES_]]) {layout = "NCHW", saturation = 0 : si64} : (memref<1x?x?x7xf32>, memref<1x?x7x?xf16, [[MAP_0_]]>) -> ()
