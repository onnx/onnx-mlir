...
func.func @main_graph(%arg0: tensor<1x64xf32>, %arg1: tensor<64x512xf32>) -> tensor<1x512xf32> {
  %0 = "onnx.NoValue"() {value} : () -> none
  %c1_i64 = arith.constant 1 : i64
  %c0_i64 = arith.constant 0 : i64
  %1 = onnx.Constant dense<256> : tensor<2xi64>
  %2:2 = "onnx.Split"(%arg1, %1) {axis = 1 : si64} : (tensor<64x512xf32>, tensor<2xi64>) -> (tensor<64x256xf32>, tensor<64x256xf32>)
  %3 = "zhigh.Fork"() ({
  ...
  %5 = "onnx.Concat"(%3, %4) {axis = 1 : si64} : (tensor<1x256xf32>, tensor<1x256xf32>) -> tensor<1x512xf32>
...
// CHECK:             "krnl.call"([[CST_0_1_]]) {funcName = "threadAffine", numOfOutput = 1 : si64} : (i64) -> ()
...
// CHECK:             "krnl.call"([[CST_1_1_]]) {funcName = "threadAffine", numOfOutput = 1 : si64} : (i64) -> ()
