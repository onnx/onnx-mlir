...
// CHECK-DAG:       [[RES_1_:%.+]] = memref.alloc([[VAR_dim_0_]]) {{.*}}: memref<1x1x?x9xf16, #map3>
// CHECK-DAG:       [[RES_2_:%.+]] = memref.alloc() {{.*}}: memref<5xi64>
// CHECK:           krnl.store [[VAR_c1_i64_]], [[RES_2_]]{{.}}[[VAR_c0_]]{{.}} : memref<5xi64>
...
// CHECK:           return [[RES_]], [[RES_]]_1 : memref<?x1x?x9xf16, #map3>, memref<1x1x?x9xf16, #map3>
// CHECK:         }
}
...
// CHECK-DAG:       [[VAR_dim_0_:%.+]] = memref.dim [[PARAM_0_]], [[VAR_c1_]] : memref<?x?x7xf16, #map>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[RES_:%.+]] = memref.alloc([[VAR_dim_]], [[VAR_dim_]]_0) {{.*}}: memref<?x2x?x9xf16, #map3>
// CHECK-DAG:       [[RES_1_:%.+]] = memref.alloc([[VAR_dim_0_]]) {{.*}}: memref<1x2x?x9xf16, #map3>
// CHECK-DAG:       [[RES_2_:%.+]] = memref.alloc() {{.*}}: memref<5xi64>
// CHECK:           krnl.store [[VAR_c2_i64_]], [[RES_2_]]{{.}}[[VAR_c0_]]{{.}} : memref<5xi64>
// CHECK:           [[VAR_0_:%.+]] = arith.index_cast [[VAR_dim_]] : index to i64
// CHECK:           krnl.store [[VAR_0_]], [[RES_2_]]{{.}}[[VAR_c1_]]{{.}} : memref<5xi64>
...
// CHECK:           return [[RES_]], [[RES_]]_1 : memref<?x2x?x9xf16, #map3>, memref<1x2x?x9xf16, #map3>
// CHECK:         }
}
...
// CHECK:           krnl.store [[VAR_c7_i64_]], [[RES_2_]]{{.}}[[VAR_c3_]]{{.}} : memref<5xi64>
// CHECK:           krnl.store [[VAR_c9_i64_]], [[RES_2_]]{{.}}[[VAR_c4_]]{{.}} : memref<5xi64>
// CHECK:           [[RES_3_:%.+]] = memref.alloc([[VAR_dim_0_]]) {{.*}}: memref<1x?x9xf16, #map>
// CHECK:           krnl.memset [[RES_3_]], [[VAR_cst_]] {delayed = true} : memref<1x?x9xf16, #map>
// CHECK:           [[RES_4_:%.+]] = memref.alloc([[VAR_dim_0_]]) {{.*}}: memref<1x?x9xf16, #map>
// CHECK:           krnl.memset [[RES_4_]], [[VAR_cst_]] {delayed = true} : memref<1x?x9xf16, #map>
// CHECK-DAG:       [[VAR_dim_5_:%.+]] = memref.dim [[PARAM_0_]], [[VAR_c0_]] : memref<?x?x7xf16, #map>
// CHECK-DAG:       [[VAR_dim_6_:%.+]] = memref.dim [[PARAM_0_]], [[VAR_c1_]] : memref<?x?x7xf16, #map>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_2_:%.+]] = affine.apply #map4(){{.}}[[VAR_dim_5_]]{{.}}
// CHECK-DAG:       [[VAR_3_:%.+]] = affine.apply #map5(){{.}}[[VAR_dim_6_]]{{.}}
// CHECK:           [[VAR_4_:%.+]] = arith.muli [[VAR_2_]], [[VAR_3_]] : index
// CHECK:           [[VAR_5_:%.+]] = arith.muli [[VAR_4_]], [[VAR_c4096_]] : index
...
// CHECK-DAG: #map3 = affine_map<()[s0] -> (s0 * 4 + 6)>
...
// CHECK-DAG:       [[RES_1_:%.+]] = memref.alloc([[VAR_dim_0_]]) {{.*}}: memref<1x1x?x9xf16, #map2>
// CHECK-DAG:       [[RES_2_:%.+]] = memref.alloc() {{.*}}: memref<5xi64>
// CHECK:           krnl.store [[VAR_c1_i64_]], [[RES_2_]]{{.}}[[VAR_c0_]]{{.}} : memref<5xi64>
// CHECK:           [[VAR_0_:%.+]] = arith.index_cast [[VAR_dim_]] : index to i64
// CHECK:           krnl.store [[VAR_0_]], [[RES_2_]]{{.}}[[VAR_c1_]]{{.}} : memref<5xi64>
...
// CHECK-DAG:       [[VAR_dim_4_:%.+]] = memref.dim [[PARAM_0_]], [[VAR_c1_]] : memref<?x?x7xf16, #map>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_4_:%.+]] = affine.apply #map3(){{.}}[[VAR_dim_3_]]{{.}}
// CHECK-DAG:       [[VAR_5_:%.+]] = affine.apply #map4(){{.}}[[VAR_dim_4_]]{{.}}
...
// CHECK:           return [[RES_]], [[RES_]]_1 : memref<?x1x?x9xf16, #map2>, memref<1x1x?x9xf16, #map2>
// CHECK:         }
}
