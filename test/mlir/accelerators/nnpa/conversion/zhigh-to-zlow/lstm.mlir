...
func @lstm_return_single_step(%input : tensor<3x5x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %h0 : tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %c0 : tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %input_weights : tensor<1x7x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %input_bias : tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %hidden_weights : tensor<1x9x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %hidden_bias : tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>) -> (tensor<*xf32>, tensor<*xf32>) {
  ...
  %hn_output, %cf_output = "zhigh.LSTM"(%input, %h0, %c0, %input_weights, %input_bias, %hidden_weights, %hidden_bias) {direction = "forward", hidden_size = 9 : si64, prev_layer = "none", return_all_steps = 0 : si64} : (tensor<3x5x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x7x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, tensor<1x9x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>) -> (tensor<*xf32>, tensor<*xf32>)
...
func @lstm_return_all_steps(%input : tensor<3x5x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %h0 : tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %c0 : tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %input_weights : tensor<1x7x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %input_bias : tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %hidden_weights : tensor<1x9x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %hidden_bias : tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>) -> (tensor<*xf32>, tensor<*xf32>) {
  ...
  %hn_output, %cf_output = "zhigh.LSTM"(%input, %h0, %c0, %input_weights, %input_bias, %hidden_weights, %hidden_bias) {direction = "forward", hidden_size = 9 : si64, prev_layer = "none", return_all_steps = -1 : si64} : (tensor<3x5x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x7x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, tensor<1x9x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>) -> (tensor<*xf32>, tensor<*xf32>)
...
// CHECK:           krnl.store [[VAR_c9_i64_]], [[RES_2_]]{{.}}[[VAR_c4_]]{{.}} : memref<5xi64>
// CHECK:           [[RES_3_:%.+]] = memref.alloc() {{.*}}: memref<73728xi8>
// CHECK:           "zlow.lstm"([[PARAM_0_]], [[PARAM_1_]], [[PARAM_2_]], [[PARAM_3_]], [[PARAM_4_]], [[PARAM_5_]], [[PARAM_6_]], [[RES_3_]], [[RES_2_]], [[RES_]], [[RES_1_]]) {direction = "forward", prev_layer = "none", return_all_steps = -1 : si64} : (memref<3x5x7xf16, #map0>, memref<1x5x9xf16, #map0>, memref<1x5x9xf16, #map0>, memref<1x7x36xf16, #map1>, memref<1x36xf16, #map2>, memref<1x9x36xf16, #map1>, memref<1x36xf16, #map2>, memref<73728xi8>, memref<5xi64>, memref<3x1x5x9xf16, #map3>, memref<1x1x5x9xf16, #map3>) -> ()
...
func @lstm_backward_return_all_steps(%input : tensor<3x5x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %h0 : tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %c0 : tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %input_weights : tensor<1x7x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %input_bias : tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %hidden_weights : tensor<1x9x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %hidden_bias : tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>) -> (tensor<*xf32>, tensor<*xf32>) {

  %hn_output, %cf_output = "zhigh.LSTM"(%input, %h0, %c0, %input_weights, %input_bias, %hidden_weights, %hidden_bias) {direction = "backward", hidden_size = 9 : si64, prev_layer = "none", return_all_steps = -1 : si64} : (tensor<3x5x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x7x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, tensor<1x9x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>) -> (tensor<*xf32>, tensor<*xf32>)
...
func @lstm_bidir_return_all_steps(%input : tensor<3x5x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %h0 : tensor<2x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %c0 : tensor<2x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %input_weights : tensor<2x7x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %input_bias : tensor<2x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %hidden_weights : tensor<2x9x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %hidden_bias : tensor<2x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>) -> (tensor<*xf32>, tensor<*xf32>) {

  %hn_output, %cf_output = "zhigh.LSTM"(%input, %h0, %c0, %input_weights, %input_bias, %hidden_weights, %hidden_bias) {direction = "bidirectional", hidden_size = 9 : si64, prev_layer = "none", return_all_steps = -1 : si64} : (tensor<3x5x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<2x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<2x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<2x7x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, tensor<2x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, tensor<2x9x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, tensor<2x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>) -> (tensor<*xf32>, tensor<*xf32>)
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: memref<3x5x7xf16, #map0>, [[PARAM_1_:%.+]]: memref<2x5x9xf16, #map0>, [[PARAM_2_:%.+]]: memref<2x5x9xf16, #map0>, [[PARAM_3_:%.+]]: memref<2x7x36xf16, #map1>, [[PARAM_4_:%.+]]: memref<2x36xf16, #map2>, [[PARAM_5_:%.+]]: memref<2x9x36xf16, #map1>, [[PARAM_6_:%.+]]: memref<2x36xf16, #map2>) -> (memref<3x2x5x9xf16, #map3>, memref<1x2x5x9xf16, #map3>) {
// CHECK-DAG:       [[VAR_c4_:%.+]] = arith.constant 4 : index
// CHECK-DAG:       [[VAR_c9_i64_:%.+]] = arith.constant 9 : i64
// CHECK-DAG:       [[VAR_c3_:%.+]] = arith.constant 3 : index
// CHECK-DAG:       [[VAR_c7_i64_:%.+]] = arith.constant 7 : i64
...
// CHECK:           "zlow.lstm"([[PARAM_0_]], [[PARAM_1_]], [[PARAM_2_]], [[PARAM_3_]], [[PARAM_4_]], [[PARAM_5_]], [[PARAM_6_]], [[RES_3_]], [[RES_2_]], [[RES_]], [[RES_1_]]) {direction = "forward", prev_layer = "none", return_all_steps = -1 : si64} : (memref<?x?x7xf16, #map0>, memref<1x?x9xf16, #map0>, memref<1x?x9xf16, #map0>, memref<1x7x36xf16, #map1>, memref<1x36xf16, #map2>, memref<1x9x36xf16, #map1>, memref<1x36xf16, #map2>, memref<?xi8>, memref<5xi64>, memref<?x1x?x9xf16, #map3>, memref<1x1x?x9xf16, #map3>) -> ()
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: memref<?x?x7xf16, #map0>, [[PARAM_1_:%.+]]: memref<2x?x9xf16, #map0>, [[PARAM_2_:%.+]]: memref<2x?x9xf16, #map0>, [[PARAM_3_:%.+]]: memref<2x7x36xf16, #map1>, [[PARAM_4_:%.+]]: memref<2x36xf16, #map2>, [[PARAM_5_:%.+]]: memref<2x9x36xf16, #map1>, [[PARAM_6_:%.+]]: memref<2x36xf16, #map2>) -> (memref<?x2x?x9xf16, #map3>, memref<1x2x?x9xf16, #map3>) {
// CHECK-DAG:       [[VAR_c4096_:%.+]] = arith.constant 4096 : index
// CHECK-DAG:       [[VAR_c1_:%.+]] = arith.constant 1 : index
// CHECK-DAG:       [[VAR_c2_:%.+]] = arith.constant 2 : index
// CHECK-DAG:       [[VAR_c0_:%.+]] = arith.constant 0 : index
...
// CHECK:           "zlow.lstm"([[PARAM_0_]], [[PARAM_1_]], [[PARAM_2_]], [[PARAM_3_]], [[PARAM_4_]], [[PARAM_5_]], [[PARAM_6_]], [[RES_3_]], [[RES_2_]], [[RES_]], [[RES_1_]]) {direction = "bidirectional", prev_layer = "none", return_all_steps = -1 : si64} : (memref<?x?x7xf16, #map0>, memref<2x?x9xf16, #map0>, memref<2x?x9xf16, #map0>, memref<2x7x36xf16, #map1>, memref<2x36xf16, #map2>, memref<2x9x36xf16, #map1>, memref<2x36xf16, #map2>, memref<?xi8>, memref<5xi64>, memref<?x2x?x9xf16, #map3>, memref<1x2x?x9xf16, #map3>) -> ()
...
func @lstm_no_intial_h_and_c(%input : tensor<?x?x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %input_weights : tensor<1x7x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %input_bias : tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %hidden_weights : tensor<1x9x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %hidden_bias : tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>) -> (tensor<*xf32>, tensor<*xf32>) {
  ...
  %hn_output, %cf_output = "zhigh.LSTM"(%input, %cst, %cst, %input_weights, %input_bias, %hidden_weights, %hidden_bias) {direction = "forward", hidden_size = 9 : si64, prev_layer = "none", return_all_steps = -1 : si64} : (tensor<?x?x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, none, none, tensor<1x7x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, tensor<1x9x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, tensor<1x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>) -> (tensor<*xf32>, tensor<*xf32>)
...
func @lstm_no_input_and_hidden_biases(%input : tensor<?x?x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %h0 : tensor<1x?x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %c0 : tensor<1x?x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %input_weights : tensor<1x7x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, %hidden_weights : tensor<1x9x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>) -> (tensor<*xf32>, tensor<*xf32>) {
  ...
  %cst = "onnx.NoValue"() {value} : () -> none
  %hn_output, %cf_output = "zhigh.LSTM"(%input, %h0, %c0, %input_weights, %cst, %hidden_weights, %cst) {direction = "forward", hidden_size = 9 : si64,  prev_layer = "none", return_all_steps = -1 : si64} : (tensor<?x?x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x?x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x?x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x7x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, none, tensor<1x9x36xf32, #zhigh.encoding<{dataLayout = "FICO"}>>, none) -> (tensor<*xf32>, tensor<*xf32>)
...
// CHECK:           [[VAR_14_:%.+]] = arith.muli [[VAR_13_]], [[VAR_c4096_]] : index
// CHECK:           [[RES_5_:%.+]] = memref.alloc([[VAR_14_]]) {{.*}}: memref<?xi8>
// CHECK:           "zlow.lstm"([[PARAM_0_]], [[PARAM_1_]], [[PARAM_2_]], [[PARAM_3_]], [[RES_3_]], [[PARAM_4_]], [[RES_4_]], [[RES_5_]], [[RES_2_]], [[RES_]], [[RES_1_]]) {direction = "forward", prev_layer = "none", return_all_steps = -1 : si64} : (memref<?x?x7xf16, #map0>, memref<1x?x9xf16, #map0>, memref<1x?x9xf16, #map0>, memref<1x7x36xf16, #map1>, memref<1x4x1x1x32x64xf16>, memref<1x9x36xf16, #map1>, memref<1x4x1x1x32x64xf16>, memref<?xi8>, memref<5xi64>, memref<?x1x?x9xf16, #map2>, memref<1x1x?x9xf16, #map2>) -> ()
