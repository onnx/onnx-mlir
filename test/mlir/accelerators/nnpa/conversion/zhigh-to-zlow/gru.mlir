...
// CHECK:           krnl.store [[VAR_c9_i64_]], [[RES_1_]]{{.}}[[VAR_c4_]]{{.}} : memref<5xi64>
// CHECK:           [[RES_2_:%.+]] = memref.alloc() {{.*}}: memref<57344xi8>
// CHECK:           "zlow.gru"([[PARAM_0_]], [[PARAM_1_]], [[PARAM_2_]], [[PARAM_3_]], [[PARAM_4_]], [[PARAM_5_]], [[RES_2_]], [[RES_1_]], [[RES_]]) {direction = "forward", prev_layer = "not_set", return_all_steps = -1 : si64} : (memref<3x5x7xf16, #map0>, memref<1x5x9xf16, #map0>, memref<1x7x27xf16, #map1>, memref<1x27xf16, #map2>, memref<1x9x27xf16, #map1>, memref<1x27xf16, #map2>, memref<57344xi8>, memref<5xi64>, memref<3x1x5x9xf16, #map3>) -> ()
...
// CHECK:           "zlow.gru"([[PARAM_0_]], [[PARAM_1_]], [[PARAM_2_]], [[PARAM_3_]], [[PARAM_4_]], [[PARAM_5_]], [[RES_2_]], [[RES_1_]], [[RES_]]) {direction = "forward", prev_layer = "not_set", return_all_steps = -1 : si64} : (memref<?x?x7xf16, #map0>, memref<1x?x9xf16, #map0>, memref<1x7x27xf16, #map1>, memref<1x27xf16, #map2>, memref<1x9x27xf16, #map1>, memref<1x27xf16, #map2>, memref<?xi8>, memref<5xi64>, memref<?x1x?x9xf16, #map3>) -> ()
...
// CHECK:           "zlow.gru"([[PARAM_0_]], [[PARAM_1_]], [[PARAM_2_]], [[RES_2_]], [[PARAM_3_]], [[RES_3_]], [[RES_4_]], [[RES_1_]], [[RES_]]) {direction = "forward", prev_layer = "not_set", return_all_steps = -1 : si64} : (memref<?x?x7xf16, #map0>, memref<1x?x9xf16, #map0>, memref<1x7x27xf16, #map1>, memref<1x3x1x1x32x64xf16>, memref<1x9x27xf16, #map1>, memref<1x3x1x1x32x64xf16>, memref<?xi8>, memref<5xi64>, memref<?x1x?x9xf16, #map2>) -> ()
