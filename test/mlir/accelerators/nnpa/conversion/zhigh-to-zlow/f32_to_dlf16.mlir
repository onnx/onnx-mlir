...
// CHECK-DAG:   [[MAP_0_:#.+]] = affine_map<()[s0] -> (s0 * 30 + 16)>
...
// CHECK:             [[LOAD_VAR_reshape_MEM_1_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_6_]]{{.}} : memref<?xf32>, vector<4xf32>
// CHECK:             [[VAR_9_:%.+]] = "zlow.vec_f32_to_dlf16"([[LOAD_VAR_reshape_MEM_]], [[LOAD_VAR_reshape_MEM_1_]]) : (vector<4xf32>, vector<4xf32>) -> vector<8xf16>
// CHECK:             vector.store [[VAR_9_]], [[VAR_reshape_3_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf16>, vector<8xf16>
// CHECK:           }
