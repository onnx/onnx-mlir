...
// CHECK-DAG:   [[MAP_2_:#.+]] = affine_map<(d0) -> (d0 * 3 + 1)>
// CHECK-DAG:   [[MAP_3_:#.+]] = affine_map<(d0) -> (d0 * 3 + 2)>
...
// CHECK:             [[LOAD_PARAM_0_MEM_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_1_]]#0, [[VAR_2_]], [[VAR_1_]]#1, [[VAR_1_]]#2] : memref<1x3x5x7xf32>
// CHECK:             krnl.store [[LOAD_PARAM_0_MEM_]], [[RES_1_]]{{.}}[[VAR_1_]]#0, [[VAR_1_]]#1, [[VAR_1_]]#2, [[VAR_2_]]{{.}} : memref<1x5x7x3xf32>
// CHECK:             [[VAR_4_:%.+]] = affine.apply [[MAP_2_]]([[VAR_1_]]#3)
// CHECK:             [[LOAD_PARAM_0_MEM_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_1_]]#0, [[VAR_4_]], [[VAR_1_]]#1, [[VAR_1_]]#2] : memref<1x3x5x7xf32>
// CHECK:             krnl.store [[LOAD_PARAM_0_MEM_1_]], [[RES_1_]]{{.}}[[VAR_1_]]#0, [[VAR_1_]]#1, [[VAR_1_]]#2, [[VAR_4_]]{{.}} : memref<1x5x7x3xf32>
// CHECK:             [[VAR_6_:%.+]] = affine.apply [[MAP_3_]]([[VAR_1_]]#3)
// CHECK:             [[LOAD_PARAM_0_MEM_2_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_1_]]#0, [[VAR_6_]], [[VAR_1_]]#1, [[VAR_1_]]#2] : memref<1x3x5x7xf32>
// CHECK:             krnl.store [[LOAD_PARAM_0_MEM_2_]], [[RES_1_]]{{.}}[[VAR_1_]]#0, [[VAR_1_]]#1, [[VAR_1_]]#2, [[VAR_6_]]{{.}} : memref<1x5x7x3xf32>
// CHECK:           }
