...
// CHECK:           [[VAR_0_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {toLayout = "NHWC"} : (tensor<1x3x5x7xf32>) -> tensor<1x3x5x7xf32, #zhigh.encoding<{dataLayout = "NHWC"}>>
...
// CHECK:           [[VAR_0_:%.+]] = "zhigh.Stick"([[PARAM_0_]]) {toLayout = "NHWC"} : (tensor<1x?x?x7xf32>) -> tensor<1x?x?x7xf32, #zhigh.encoding<{dataLayout = "NHWC"}>>
