...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>, [[PARAM_1_:%.+]]: tensor<2x2x3x1xf32, #zhigh.layout<{dataLayout = "HWCK"}>>, [[PARAM_2_:%.+]]: tensor<1xf32, #zhigh.layout<{dataLayout = "1D"}>>) -> tensor<1x31x31x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>> {
// CHECK:           [[VAR_0_:%.+]] = "zhigh.Conv2D"([[PARAM_0_]], [[PARAM_1_]], [[PARAM_2_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "VALID_PADDING", strides = [1, 1]} : (tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>, tensor<2x2x3x1xf32, #zhigh.layout<{dataLayout = "HWCK"}>>, tensor<1xf32, #zhigh.layout<{dataLayout = "1D"}>>) -> tensor<1x31x31x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x31x31x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>, [[PARAM_1_:%.+]]: tensor<2x2x3x1xf32, #zhigh.layout<{dataLayout = "HWCK"}>>, [[PARAM_2_:%.+]]: tensor<1xf32, #zhigh.layout<{dataLayout = "1D"}>>) -> tensor<1x32x32x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>> {
// CHECK:           [[VAR_0_:%.+]] = "zhigh.Conv2D"([[PARAM_0_]], [[PARAM_1_]], [[PARAM_2_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "SAME_PADDING", strides = [1, 1]} : (tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>, tensor<2x2x3x1xf32, #zhigh.layout<{dataLayout = "HWCK"}>>, tensor<1xf32, #zhigh.layout<{dataLayout = "1D"}>>) -> tensor<1x32x32x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x32x32x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>, [[PARAM_1_:%.+]]: tensor<2x2x?x1xf32, #zhigh.layout<{dataLayout = "HWCK"}>>, [[PARAM_2_:%.+]]: tensor<?xf32, #zhigh.layout<{dataLayout = "1D"}>>) -> tensor<1x?x?x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>> {
// CHECK:           [[VAR_0_:%.+]] = "zhigh.Conv2D"([[PARAM_0_]], [[PARAM_1_]], [[PARAM_2_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "VALID_PADDING", strides = [1, 1]} : (tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>, tensor<2x2x?x1xf32, #zhigh.layout<{dataLayout = "HWCK"}>>, tensor<?xf32, #zhigh.layout<{dataLayout = "1D"}>>) -> tensor<1x?x?x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x?x?x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>, [[PARAM_1_:%.+]]: tensor<2x2x?x1xf32, #zhigh.layout<{dataLayout = "HWCK"}>>, [[PARAM_2_:%.+]]: tensor<?xf32, #zhigh.layout<{dataLayout = "1D"}>>) -> tensor<1x?x?x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>> {
// CHECK:           [[VAR_0_:%.+]] = "zhigh.Conv2D"([[PARAM_0_]], [[PARAM_1_]], [[PARAM_2_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "SAME_PADDING", strides = [1, 1]} : (tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>, tensor<2x2x?x1xf32, #zhigh.layout<{dataLayout = "HWCK"}>>, tensor<?xf32, #zhigh.layout<{dataLayout = "1D"}>>) -> tensor<1x?x?x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x?x?x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>, [[PARAM_1_:%.+]]: tensor<2x2x3x1xf32, #zhigh.layout<{dataLayout = "HWCK"}>>) -> tensor<1x32x32x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>> {
// CHECK:           [[VAR_cst_:%.+]] = "onnx.NoValue"() {value} : () -> none
// CHECK:           [[VAR_0_:%.+]] = "zhigh.Conv2D"([[PARAM_0_]], [[PARAM_1_]], [[VAR_cst_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "SAME_PADDING", strides = [1, 1]} : (tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>, tensor<2x2x3x1xf32, #zhigh.layout<{dataLayout = "HWCK"}>>, none) -> tensor<1x32x32x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x32x32x1xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:         }
}
