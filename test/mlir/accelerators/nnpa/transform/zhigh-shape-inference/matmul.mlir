...
func @test_matmul_3d_broadcast(%arg0 : tensor<2x4x8xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %arg1 : tensor<8x16xf32, #zhigh.encoding<{dataLayout = "2D"}>>) -> tensor<*xf32> {
  %cst = "onnx.NoValue"() {value} : () -> none
...
func @test_matmul_3d_stack(%arg0 : tensor<2x4x8xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %arg1 : tensor<2x8x16xf32, #zhigh.encoding<{dataLayout = "3DS"}>>) -> tensor<*xf32> {
  %cst = "onnx.NoValue"() {value} : () -> none
...
func @test_matmul_2d_unknown_dims(%arg0 : tensor<?x?xf32, #zhigh.encoding<{dataLayout = "2D"}>>, %arg1 : tensor<?x16xf32, #zhigh.encoding<{dataLayout = "2D"}>>) -> tensor<*xf32> {
  %cst = "onnx.NoValue"() {value} : () -> none
...
func @test_matmul_3d_broadcast_unknown_dims(%arg0 : tensor<2x?x?xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %arg1 : tensor<?x16xf32, #zhigh.encoding<{dataLayout = "2D"}>>) -> tensor<*xf32> {
  %cst = "onnx.NoValue"() {value} : () -> none
...
func @test_matmul_3d_stack_unknown_dims(%arg0 : tensor<2x?x?xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, %arg1 : tensor<2x?x16xf32, #zhigh.encoding<{dataLayout = "3DS"}>>) -> tensor<*xf32> {
  %cst = "onnx.NoValue"() {value} : () -> none
