// RUN: onnx-mlir-opt --maccel=NNPA --maccel=NNPA --shape-inference %s -split-input-file | FileCheck %s
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<3x5x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, [[PARAM_1_:%.+]]: tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, [[PARAM_2_:%.+]]: tensor<1x7x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, [[PARAM_3_:%.+]]: tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, [[PARAM_4_:%.+]]: tensor<1x9x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, [[PARAM_5_:%.+]]: tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>) -> tensor<1x1x5x9xf32, #zhigh.encoding<{dataLayout = "4DS"}>> {
// CHECK:           [[VAR_0_:%.+]] = "zhigh.GRU"([[PARAM_0_]], [[PARAM_1_]], [[PARAM_2_]], [[PARAM_3_]], [[PARAM_4_]], [[PARAM_5_]]) {direction = "forward", hidden_size = 9 : si64, return_all_steps = 0 : si64} : (tensor<3x5x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x7x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, tensor<1x9x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>) -> tensor<1x1x5x9xf32, #zhigh.encoding<{dataLayout = "4DS"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x1x5x9xf32, #zhigh.encoding<{dataLayout = "4DS"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<3x5x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, [[PARAM_1_:%.+]]: tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, [[PARAM_2_:%.+]]: tensor<1x7x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, [[PARAM_3_:%.+]]: tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, [[PARAM_4_:%.+]]: tensor<1x9x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, [[PARAM_5_:%.+]]: tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>) -> tensor<3x1x5x9xf32, #zhigh.encoding<{dataLayout = "4DS"}>> {
// CHECK:           [[VAR_0_:%.+]] = "zhigh.GRU"([[PARAM_0_]], [[PARAM_1_]], [[PARAM_2_]], [[PARAM_3_]], [[PARAM_4_]], [[PARAM_5_]]) {direction = "forward", hidden_size = 9 : si64, return_all_steps = -1 : si64} : (tensor<3x5x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x5x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x7x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, tensor<1x9x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>) -> tensor<3x1x5x9xf32, #zhigh.encoding<{dataLayout = "4DS"}>>
// CHECK:           return [[VAR_0_]] : tensor<3x1x5x9xf32, #zhigh.encoding<{dataLayout = "4DS"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<?x?x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, [[PARAM_1_:%.+]]: tensor<1x?x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, [[PARAM_2_:%.+]]: tensor<1x7x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, [[PARAM_3_:%.+]]: tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, [[PARAM_4_:%.+]]: tensor<1x9x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, [[PARAM_5_:%.+]]: tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>) -> tensor<?x1x?x9xf32, #zhigh.encoding<{dataLayout = "4DS"}>> {
// CHECK:           [[VAR_0_:%.+]] = "zhigh.GRU"([[PARAM_0_]], [[PARAM_1_]], [[PARAM_2_]], [[PARAM_3_]], [[PARAM_4_]], [[PARAM_5_]]) {direction = "forward", hidden_size = 9 : si64, return_all_steps = -1 : si64} : (tensor<?x?x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x?x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x7x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, tensor<1x9x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>) -> tensor<?x1x?x9xf32, #zhigh.encoding<{dataLayout = "4DS"}>>
// CHECK:           return [[VAR_0_]] : tensor<?x1x?x9xf32, #zhigh.encoding<{dataLayout = "4DS"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<?x?x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, [[PARAM_1_:%.+]]: tensor<1x7x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, [[PARAM_2_:%.+]]: tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, [[PARAM_3_:%.+]]: tensor<1x9x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, [[PARAM_4_:%.+]]: tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>) -> tensor<?x1x?x9xf32, #zhigh.encoding<{dataLayout = "4DS"}>> {
// CHECK:           [[VAR_cst_:%.+]] = "onnx.NoValue"() {value} : () -> none
// CHECK:           [[VAR_0_:%.+]] = "zhigh.GRU"([[PARAM_0_]], [[VAR_cst_]], [[PARAM_1_]], [[PARAM_2_]], [[PARAM_3_]], [[PARAM_4_]]) {direction = "forward", hidden_size = 9 : si64, return_all_steps = -1 : si64} : (tensor<?x?x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, none, tensor<1x7x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, tensor<1x9x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, tensor<1x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>) -> tensor<?x1x?x9xf32, #zhigh.encoding<{dataLayout = "4DS"}>>
// CHECK:           return [[VAR_0_]] : tensor<?x1x?x9xf32, #zhigh.encoding<{dataLayout = "4DS"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<?x?x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, [[PARAM_1_:%.+]]: tensor<1x?x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, [[PARAM_2_:%.+]]: tensor<1x7x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, [[PARAM_3_:%.+]]: tensor<1x9x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>) -> tensor<?x1x?x9xf32, #zhigh.encoding<{dataLayout = "4DS"}>> {
// CHECK:           [[VAR_cst_:%.+]] = "onnx.NoValue"() {value} : () -> none
// CHECK:           [[VAR_0_:%.+]] = "zhigh.GRU"([[PARAM_0_]], [[PARAM_1_]], [[PARAM_2_]], [[VAR_cst_]], [[PARAM_3_]], [[VAR_cst_]]) {direction = "forward", hidden_size = 9 : si64, return_all_steps = -1 : si64} : (tensor<?x?x7xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x?x9xf32, #zhigh.encoding<{dataLayout = "3DS"}>>, tensor<1x7x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, none, tensor<1x9x27xf32, #zhigh.encoding<{dataLayout = "ZRH"}>>, none) -> tensor<?x1x?x9xf32, #zhigh.encoding<{dataLayout = "4DS"}>>
// CHECK:           return [[VAR_0_]] : tensor<?x1x?x9xf32, #zhigh.encoding<{dataLayout = "4DS"}>>
// CHECK:         }
}
