...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x31x31x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>> {
// CHECK:           [[VAR_0_:%.+]] = "zhigh.MaxPool2D"([[PARAM_0_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "VALID_PADDING", strides = [1, 1]} : (tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x31x31x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x31x31x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>> {
// CHECK:           [[VAR_0_:%.+]] = "zhigh.MaxPool2D"([[PARAM_0_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "SAME_PADDING", strides = [1, 1]} : (tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>> {
// CHECK:           [[VAR_0_:%.+]] = "zhigh.MaxPool2D"([[PARAM_0_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "VALID_PADDING", strides = [1, 1]} : (tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>> {
// CHECK:           [[VAR_0_:%.+]] = "zhigh.MaxPool2D"([[PARAM_0_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "SAME_PADDING", strides = [1, 1]} : (tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>> {
// CHECK-DAG:       [[VAR_0_:%.+]] = "zhigh.MaxPool2D"([[PARAM_0_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "SAME_PADDING", strides = [1, 1]} : (tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x31x31x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>> {
// CHECK:           [[VAR_0_:%.+]] = "zhigh.AvgPool2D"([[PARAM_0_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "VALID_PADDING", strides = [1, 1]} : (tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x31x31x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x31x31x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>> {
// CHECK:           [[VAR_0_:%.+]] = "zhigh.AvgPool2D"([[PARAM_0_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "SAME_PADDING", strides = [1, 1]} : (tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>> {
// CHECK:           [[VAR_0_:%.+]] = "zhigh.AvgPool2D"([[PARAM_0_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "VALID_PADDING", strides = [1, 1]} : (tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>> {
// CHECK:           [[VAR_0_:%.+]] = "zhigh.AvgPool2D"([[PARAM_0_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "SAME_PADDING", strides = [1, 1]} : (tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x?x?x?xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:         }
}
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>> {
// CHECK-DAG:       [[VAR_0_:%.+]] = "zhigh.AvgPool2D"([[PARAM_0_]]) {act_func = "ACT_NONE", kernel_shape = [2, 2], padding_type = "SAME_PADDING", strides = [1, 1]} : (tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>) -> tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:           return [[VAR_0_]] : tensor<1x32x32x3xf32, #zhigh.layout<{dataLayout = "NHWC"}>>
// CHECK:         }
}
