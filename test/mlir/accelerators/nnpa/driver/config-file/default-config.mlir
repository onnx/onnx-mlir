// RUN: onnx-mlir --EmitONNXIR --march=z17 --maccel=NNPA --printIR %s | FileCheck %s

// COM: The default config file omconfig.json is used.
func.func @test_load_default_config_file(%arg0: tensor<?x?xf32>) -> tensor<?x?xf32> {
...
// CHECK-LABEL:  func.func @test_load_default_config_file
