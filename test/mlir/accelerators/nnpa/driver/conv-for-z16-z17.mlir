...
func.func @conv_3x3_dyn_same(%arg0: tensor<?x?x?x?xf32>, %arg1: tensor<64x3x3x3xf32>) -> tensor<?x?x?x?xf32> {
  %0 = "onnx.NoValue"() <{value}> : () -> none
  %1 = "onnx.Conv"(%arg0, %arg1, %0) <{auto_pad = "SAME_PADDING", dilations = [1, 1], group = 1 : si64, kernel_shape = [3, 3], strides = [1, 1]}> : (tensor<?x?x?x?xf32>, tensor<64x3x3x3xf32>, none) -> tensor<?x?x?x?xf32>
  return %1 : tensor<?x?x?x?xf32>
