// RUN: onnx-mlir --march=z16 --maccel=NNPA --disable-zhigh-decompose-stick-unstick --disable-compiler-stick-unstick --nnpa-disable-saturation --nnpa-placement-heuristic=QualifyingOps --EmitMLIR --printIR %s | FileCheck %s
