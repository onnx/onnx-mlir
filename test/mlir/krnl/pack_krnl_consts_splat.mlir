...
// CHECK-LABEL:  func @test_krnl_const_packing_file_splat
// CHECK-DAG:       [[VAR_1_:%.+]] = "krnl.global"() {name = "constant_0", offset = 0 : i64, shape = [1, 4], value = dense<0.000000e+00> : tensor<1x4xf32>} : () -> memref<1x4xf32>
// CHECK-DAG:       [[VAR_2_:%.+]] = "krnl.global"() {name = "constant_1", offset = 0 : i64, shape = [1, 4], value = dense<0.000000e+00> : tensor<1x4xf32>} : () -> memref<1x4xf32>
