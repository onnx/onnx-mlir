...
// CHECK:         ^bb1:
// CHECK:           %[[VAL_4:.*]] = llvm.mlir.addressof @"__om_Wrong number of input tensors: expect 2, but got {{\%}}lld\0A" : !llvm.ptr<array<54 x i8>>
...
// CHECK:         ^bb3:
// CHECK-DAG:       %[[VAL_15:.*]] = llvm.mlir.addressof @"__om_Wrong data type for the input 0: expect f32\0A" : !llvm.ptr<array<44 x i8>>
...
// CHECK:         ^bb5:
// CHECK-DAG:       %[[VAL_24:.*]] = llvm.mlir.addressof @"__om_Wrong rank for the input 0: expect 3, but got {{\%}}lld\0A" : !llvm.ptr<array<51 x i8>>
...
// CHECK:         ^bb7:
// CHECK-DAG:       %[[VAL_34:.*]] = llvm.mlir.addressof @"__om_Wrong size for the dimension 0 of the input 0: expect 3, but got {{\%}}lld\0A" : !llvm.ptr<array<70 x i8>>
...
// CHECK:         ^bb9:
// CHECK-DAG:       %[[VAL_45:.*]] = llvm.mlir.addressof @"__om_Wrong size for the dimension 1 of the input 0: expect 4, but got {{\%}}lld\0A" : !llvm.ptr<array<70 x i8>>
...
// CHECK:         ^bb11:
// CHECK-DAG:       %[[VAL_56:.*]] = llvm.mlir.addressof @"__om_Wrong size for the dimension 2 of the input 0: expect 5, but got {{\%}}lld\0A" : !llvm.ptr<array<70 x i8>>
...
// CHECK:         ^bb13:
// CHECK-DAG:       %[[VAL_68:.*]] = llvm.mlir.addressof @"__om_Wrong data type for the input 1: expect f32\0A" : !llvm.ptr<array<44 x i8>>
...
// CHECK:         ^bb15:
// CHECK-DAG:       %[[VAL_77:.*]] = llvm.mlir.addressof @"__om_Wrong rank for the input 1: expect 3, but got {{\%}}lld\0A" : !llvm.ptr<array<51 x i8>>
...
// CHECK:         ^bb17:
// CHECK-DAG:       %[[VAL_87:.*]] = llvm.mlir.addressof @"__om_Wrong size for the dimension 0 of the input 1: expect a non-negative value\0A" : !llvm.ptr<array<75 x i8>>
...
// CHECK:         ^bb19:
// CHECK-DAG:       %[[VAL_98:.*]] = llvm.mlir.addressof @"__om_Wrong size for the dimension 1 of the input 1: expect 4, but got {{\%}}lld\0A" : !llvm.ptr<array<70 x i8>>
...
// CHECK:         ^bb21:
// CHECK-DAG:       %[[VAL_109:.*]] = llvm.mlir.addressof @"__om_Wrong size for the dimension 2 of the input 1: expect 5, but got {{\%}}lld\0A" : !llvm.ptr<array<70 x i8>>
