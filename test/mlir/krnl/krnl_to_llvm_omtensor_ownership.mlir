...
// Check that output OMTensor does not own the data pointer because data is a constant.
  ...
  "krnl.entry_point"() {func = @return_constant, numInputs = 0 : i32, numOutputs = 1 : i32, signature = "[ \0A]\00@[   { \22type\22 : \22f32\22 , \22dims\22 : [8] , \22name\22 : \22output_0\22 }\0A\0A]\00"} : () -> ()
...
module {
 // Check that output OMTensor does not own the data pointer because data is a constant via a view op.
  ...
  "krnl.entry_point"() {func = @return_view_of_constant, numInputs = 0 : i32, numOutputs = 1 : i32, signature = "[ \0A]\00@[   { \22type\22 : \22f32\22 , \22dims\22 : [2 , 4] , \22name\22 : \22output_0\22 }\0A\0A]\00"} : () -> ()
...
module {
  ...
  "krnl.entry_point"() {func = @return_view_of_argument, numInputs = 0 : i32, numOutputs = 1 : i32, signature = "[ \0A]\00@[   { \22type\22 : \22f32\22 , \22dims\22 : [2 , 4] , \22name\22 : \22output_0\22 }\0A\0A]\00"} : () -> ()
...
module {
  ...
  "krnl.entry_point"() {func = @return_argument, numInputs = 1 : i32, numOutputs = 1 : i32, signature = "[ \0A]\00@[   { \22type\22 : \22f32\22 , \22dims\22 : [2 , 4] , \22name\22 : \22output_0\22 }\0A\0A]\00"} : () -> ()
