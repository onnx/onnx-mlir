...
// CHECK-DAG:    [[VAR_1_:%.+]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
}
...
// CHECK-DAG:    [[VAR_0_:%.+]] = mhlo.constant dense<1.000000e+00> : tensor<1xf32>
// CHECK-DAG:    [[VAR_1_:%.+]] = mhlo.constant dense<2.000000e+00> : tensor<1xf32>
}
...
// CHECK-DAG:    [[VAR_0_:%.+]] = mhlo.constant dense<1.000000e+00> : tensor<3xf32>
// CHECK-DAG:    [[VAR_1_:%.+]] = mhlo.constant dense<2.000000e+00> : tensor<3xf32>
}
...
// CHECK-DAG:    [[VAR_0_:%.+]] = mhlo.constant dense<1.000000e+00> : tensor<3xf32>
// CHECK-DAG:    [[VAR_1_:%.+]] = mhlo.constant dense<[0.000000e+00, 1.000000e+00, 2.000000e+00]> : tensor<3xf32>
}
