...
func @test_abs(%arg0 : tensor<10x10xf32>) -> tensor<10x10xf32> {
...
func @test_dyn_abs(%arg0 : tensor<?x10xf32>) -> tensor<?x10xf32> {
...
func @test_and(%arg0 : tensor<10x10xi1>, %arg1 : tensor<10x10xi1>) -> tensor<10x10xi1> {
...
func @test_dyn_and(%arg0 : tensor<?x10xi1>, %arg1 : tensor<?x10xi1>) -> tensor<?x10xi1> {
...
func @cast_float(%arg0: tensor<2xf64>) -> tensor<2xf32> {
...
func @cast_int(%arg0: tensor<2xf32>) -> tensor<2xi32> {
...
func @cast_dyn(%arg0: tensor<?x2xf64>) -> tensor<?x2xf32> {
...
func @test_ceil(%arg0 : tensor<?x10xf32>) -> tensor<?x10xf32> {
...
func @test_cos(%arg0 : tensor<?x10xf32>) -> tensor<?x10xf32> {
...
func @test_less_unknown_dims_2(%arg0: tensor<?x?x5xf32>, %arg1: tensor<?x4x5xf32>) -> tensor<?x4x5xi1> {
