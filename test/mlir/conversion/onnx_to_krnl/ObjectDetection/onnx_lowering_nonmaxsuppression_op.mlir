...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: memref<1x6x4xf32>, [[PARAM_1_:%.+]]: memref<1x1x6xf32>, [[PARAM_2_:%.+]]: memref<1xi64>, [[PARAM_3_:%.+]]: memref<1xf32>, [[PARAM_4_:%.+]]: memref<1xf32>) -> memref<?x3xi64> attributes {input_names = ["boxes", "scores", "max_output_boxes_per_class", "iou_threshold", "score_threshold"], output_names = ["selected_indices"]} {
// CHECK-DAG:       [[CST_9_dot_99999993_:%.+]] = arith.constant 9.99999993E-9 : f32
// CHECK-DAG:       [[CST_0_dot_000000_:%.+]] = arith.constant 0.000000e+00 : f32
// CHECK-DAG:       [[CST_minus_1_:%.+]] = arith.constant -1 : index
// CHECK-DAG:       [[CST_0_:%.+]] = arith.constant 0 : i64
...
// CHECK-DAG:       [[CST_0_1_:%.+]] = arith.constant 0 : index
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[LOAD_PARAM_2_MEM_:%.+]] = krnl.load [[PARAM_2_]]{{.}}[[CST_0_1_]]{{.}} : memref<1xi64>
// CHECK-DAG:       [[LOAD_PARAM_4_MEM_:%.+]] = krnl.load [[PARAM_4_]]{{.}}[[CST_0_1_]]{{.}} : memref<1xf32>
// CHECK-DAG:       [[LOAD_PARAM_3_MEM_:%.+]] = krnl.load [[PARAM_3_]]{{.}}[[CST_0_1_]]{{.}} : memref<1xf32>
// CHECK-DAG:       [[RES_:%.+]] = memref.alloca() : memref<index>
...
// CHECK:           krnl.store [[CST_0_1_]], [[RES_2_]][] : memref<index>
// CHECK:           [[LOOP_0_:%.+]]:2 = krnl.define_loops 2
// CHECK:           krnl.iterate([[LOOP_0_]]#0, [[LOOP_0_]]#1) with ([[LOOP_0_]]#0 -> [[I_0_:%.+]] = [[CST_0_1_]] to [[CST_1_]], [[LOOP_0_]]#1 -> [[I_1_:%.+]] = [[CST_0_1_]] to [[CST_1_]]){
...
// CHECK:               [[LOAD_PARAM_1_MEM_:%.+]] = krnl.load [[PARAM_1_]]{{.}}[[VAR_15_]]#0, [[VAR_15_]]#1, [[VAR_20_]]{{.}} : memref<1x1x6xf32>
// CHECK-DAG:           [[VAR_22_:%.+]] = arith.cmpf ogt, [[LOAD_PARAM_1_MEM_]], [[LOAD_PARAM_4_MEM_]] : f32
// CHECK-DAG:           [[LOAD_RES_1_MEM_:%.+]] = krnl.load [[RES_1_]][] : memref<index>
// CHECK:               [[VAR_24_:%.+]] = arith.addi [[LOAD_RES_1_MEM_]], [[CST_1_]] : index
...
// CHECK:           }
// CHECK:           "krnl.call"([[RES_3_]], [[PARAM_1_]], [[CST_2_]], [[CST_0_]]) <{funcName = "omTensorSort", numOfOutput = 1 : si64}> : (memref<1x1x6xindex>, memref<1x1x6xf32>, i64, i64) -> ()
...
// CHECK-DAG:         [[LOOP_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_15_2_]]#0, [[VAR_15_2_]]#1, [[CST_0_1_]]{{.}} : memref<1x6x4xf32>
// CHECK-DAG:         [[LOAD_RES_1_MEM_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_15_2_]]#0, [[VAR_15_2_]]#1, [[CST_1_]]{{.}} : memref<1x6x4xf32>
// CHECK-DAG:         [[LOAD_RES_2_MEM_2_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_15_2_]]#0, [[VAR_15_2_]]#1, [[CST_2_1_]]{{.}} : memref<1x6x4xf32>
// CHECK-DAG:         [[VAR_19_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_15_2_]]#0, [[VAR_15_2_]]#1, [[CST_3_]]{{.}} : memref<1x6x4xf32>
// CHECK:             [[VAR_20_1_:%.+]] = arith.cmpf ogt, [[LOAD_RES_1_MEM_1_]], [[VAR_19_1_]] : f32
// CHECK-DAG:         [[LOAD_PARAM_1_MEM_1_:%.+]] = arith.select [[VAR_20_1_]], [[VAR_19_1_]], [[LOAD_RES_1_MEM_1_]] : f32
...
// CHECK:             krnl.store [[LOAD_PARAM_1_MEM_1_]], [[RES_4_]]{{.}}[[VAR_15_2_]]#0, [[VAR_15_2_]]#1, [[CST_1_]]{{.}} : memref<1x6x4xf32>
...
// CHECK:           krnl.iterate([[LOOP_4_]]#0, [[LOOP_4_]]#1) with ([[LOOP_4_]]#0 -> [[I_8_:%.+]] = [[CST_0_1_]] to [[CST_1_]], [[LOOP_4_]]#1 -> [[I_9_:%.+]] = [[CST_0_1_]] to [[CST_1_]]){
...
// CHECK:               [[LOAD_PARAM_1_MEM_2_:%.+]] = krnl.load [[PARAM_1_]]{{.}}[[VAR_15_3_]]#0, [[VAR_15_3_]]#1, [[LOAD_RES_2_MEM_2_]]{{.}} : memref<1x1x6xf32>
// CHECK-DAG:           [[VAR_20_2_:%.+]] = arith.cmpf ogt, [[LOAD_PARAM_1_MEM_2_]], [[LOAD_PARAM_4_MEM_]] : f32
// CHECK-DAG:           [[LOAD_PARAM_1_MEM_1_:%.+]] = krnl.load [[RES_7_]][] : memref<index>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_22_2_:%.+]] = arith.cmpi slt, [[LOAD_PARAM_1_MEM_1_]], [[LOAD_RES_MEM_1_]] : index
...
// CHECK-DAG:             [[LOAD_RES_4_MEM_1_:%.+]] = krnl.load [[RES_4_]]{{.}}[[VAR_15_3_]]#0, [[LOAD_RES_2_MEM_2_]], [[CST_1_]]{{.}} : memref<1x6x4xf32>
...
// CHECK:                 krnl.store [[VAR_15_3_]]#1, [[RES_5_]]{{.}}[[LOAD_RES_6_MEM_]], [[CST_1_]]{{.}} : memref<?x3xindex>
// CHECK:                 krnl.store [[LOAD_RES_2_MEM_2_]], [[RES_5_]]{{.}}[[LOAD_RES_6_MEM_]], [[CST_2_1_]]{{.}} : memref<?x3xindex>
// CHECK:                 [[VAR_32_:%.+]] = arith.addi [[LOAD_PARAM_1_MEM_1_]], [[CST_1_]] : index
// CHECK:                 krnl.store [[VAR_32_]], [[RES_7_]][] : memref<index>
// CHECK:                 [[VAR_33_:%.+]] = arith.addi [[LOAD_RES_6_MEM_]], [[CST_1_]] : index
...
// CHECK-DAG:                 [[LOAD_RES_4_MEM_5_:%.+]] = krnl.load [[RES_4_]]{{.}}[[VAR_15_3_]]#0, [[VAR_35_]], [[CST_1_]]{{.}} : memref<1x6x4xf32>
...
// CHECK-DAG:                 [[VAR_42_:%.+]] = arith.subf [[LOAD_RES_4_MEM_3_]], [[LOAD_RES_4_MEM_1_]] : f32
// CHECK-DAG:                 [[VAR_43_:%.+]] = arith.subf [[LOAD_RES_4_MEM_2_]], [[LOAD_RES_4_MEM_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_44_:%.+]] = arith.mulf [[VAR_43_]], [[VAR_42_]] : f32
// CHECK-DAG:                 [[VAR_45_:%.+]] = arith.subf [[LOAD_RES_4_MEM_7_]], [[LOAD_RES_4_MEM_5_]] : f32
...
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_54_:%.+]] = arith.maxf [[VAR_53_]], [[CST_0_dot_000000_]] : f32
// CHECK-DAG:                 [[VAR_55_:%.+]] = arith.maxf [[VAR_52_]], [[CST_0_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_56_:%.+]] = arith.mulf [[VAR_55_]], [[VAR_54_]] : f32
...
// CHECK:                     [[VAR_61_:%.+]] = arith.cmpf oge, [[VAR_60_]], [[LOAD_PARAM_3_MEM_]] : f32
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: memref<1x10x4xf32>, [[PARAM_1_:%.+]]: memref<1x1x10xf32>, [[PARAM_2_:%.+]]: memref<1xi64>, [[PARAM_3_:%.+]]: memref<1xf32>, [[PARAM_4_:%.+]]: memref<1xf32>) -> memref<?x3xi64> attributes {input_names = ["boxes", "scores", "max_output_boxes_per_class", "iou_threshold", "score_threshold"], output_names = ["selected_indices"]} {
// CHECK-DAG:       [[CST_9_dot_99999993_:%.+]] = arith.constant 9.99999993E-9 : f32
// CHECK-DAG:       [[CST_0_dot_000000_:%.+]] = arith.constant 0.000000e+00 : f32
// CHECK-DAG:       [[CST_minus_1_:%.+]] = arith.constant -1 : index
// CHECK-DAG:       [[CST_0_:%.+]] = arith.constant 0 : i64
...
// CHECK:               [[VAR_20_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_PARAM_1_MEM_:%.+]] = krnl.load [[PARAM_1_]]{{.}}[[VAR_15_]]#0, [[VAR_15_]]#1, [[VAR_20_]]{{.}} : memref<1x1x10xf32>
// CHECK-DAG:           [[VAR_22_:%.+]] = arith.cmpf ogt, [[LOAD_PARAM_1_MEM_]], [[LOAD_PARAM_4_MEM_]] : f32
// CHECK-DAG:           [[LOAD_RES_1_MEM_:%.+]] = krnl.load [[RES_1_]][] : memref<index>
// CHECK:               [[VAR_24_:%.+]] = arith.addi [[LOAD_RES_1_MEM_]], [[CST_1_]] : index
// CHECK:               [[VAR_25_:%.+]] = arith.select [[VAR_22_]], [[VAR_24_]], [[LOAD_RES_1_MEM_]] : index
...
// CHECK:           }
// CHECK:           "krnl.call"([[RES_3_]], [[PARAM_1_]], [[CST_2_]], [[CST_0_]]) <{funcName = "omTensorSort", numOfOutput = 1 : si64}> : (memref<1x1x10xindex>, memref<1x1x10xf32>, i64, i64) -> ()
...
// CHECK:             [[VAR_15_2_:%.+]]:2 = krnl.get_induction_var_value([[LOOP_3_]]#0, [[LOOP_3_]]#1) : (!krnl.loop, !krnl.loop) -> (index, index)
// CHECK-DAG:         [[LOOP_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_15_2_]]#0, [[VAR_15_2_]]#1, [[CST_0_1_]]{{.}} : memref<1x10x4xf32>
// CHECK-DAG:         [[LOAD_RES_1_MEM_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_15_2_]]#0, [[VAR_15_2_]]#1, [[CST_1_]]{{.}} : memref<1x10x4xf32>
// CHECK-DAG:         [[LOAD_RES_2_MEM_2_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_15_2_]]#0, [[VAR_15_2_]]#1, [[CST_2_1_]]{{.}} : memref<1x10x4xf32>
// CHECK-DAG:         [[VAR_19_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_15_2_]]#0, [[VAR_15_2_]]#1, [[CST_3_]]{{.}} : memref<1x10x4xf32>
// CHECK:             [[VAR_20_1_:%.+]] = arith.cmpf ogt, [[LOAD_RES_1_MEM_1_]], [[VAR_19_1_]] : f32
// CHECK-DAG:         [[LOAD_PARAM_1_MEM_1_:%.+]] = arith.select [[VAR_20_1_]], [[VAR_19_1_]], [[LOAD_RES_1_MEM_1_]] : f32
// CHECK-DAG:         [[VAR_22_1_:%.+]] = arith.select [[VAR_20_1_]], [[LOAD_RES_1_MEM_1_]], [[VAR_19_1_]] : f32
// CHECK-DAG:         [[LOAD_RES_1_MEM_2_:%.+]] = arith.cmpf ogt, [[LOOP_1_]], [[LOAD_RES_2_MEM_2_]] : f32
...
// CHECK:             krnl.store [[LOAD_PARAM_1_MEM_1_]], [[RES_4_]]{{.}}[[VAR_15_2_]]#0, [[VAR_15_2_]]#1, [[CST_1_]]{{.}} : memref<1x10x4xf32>
...
// CHECK:               [[LOAD_PARAM_1_MEM_2_:%.+]] = krnl.load [[PARAM_1_]]{{.}}[[VAR_15_3_]]#0, [[VAR_15_3_]]#1, [[LOAD_RES_2_MEM_2_]]{{.}} : memref<1x1x10xf32>
// CHECK-DAG:           [[VAR_20_2_:%.+]] = arith.cmpf ogt, [[LOAD_PARAM_1_MEM_2_]], [[LOAD_PARAM_4_MEM_]] : f32
// CHECK-DAG:           [[LOAD_PARAM_1_MEM_1_:%.+]] = krnl.load [[RES_7_]][] : memref<index>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_22_2_:%.+]] = arith.cmpi slt, [[LOAD_PARAM_1_MEM_1_]], [[LOAD_RES_MEM_1_]] : index
...
// CHECK-DAG:             [[LOAD_RES_4_MEM_1_:%.+]] = krnl.load [[RES_4_]]{{.}}[[VAR_15_3_]]#0, [[LOAD_RES_2_MEM_2_]], [[CST_1_]]{{.}} : memref<1x10x4xf32>
...
// CHECK-DAG:                 [[LOAD_RES_4_MEM_5_:%.+]] = krnl.load [[RES_4_]]{{.}}[[VAR_15_3_]]#0, [[VAR_35_]], [[CST_1_]]{{.}} : memref<1x10x4xf32>
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: memref<1x1x4xf32>, [[PARAM_1_:%.+]]: memref<1x1x1xf32>, [[PARAM_2_:%.+]]: memref<1xi64>, [[PARAM_3_:%.+]]: memref<1xf32>, [[PARAM_4_:%.+]]: memref<1xf32>) -> memref<?x3xi64> attributes {input_names = ["boxes", "scores", "max_output_boxes_per_class", "iou_threshold", "score_threshold"], output_names = ["selected_indices"]} {
// CHECK-DAG:       [[CST_9_dot_99999993_:%.+]] = arith.constant 9.99999993E-9 : f32
// CHECK-DAG:       [[CST_0_dot_000000_:%.+]] = arith.constant 0.000000e+00 : f32
// CHECK-DAG:       [[CST_minus_1_:%.+]] = arith.constant -1 : index
// CHECK-DAG:       [[CST_0_:%.+]] = arith.constant 0 : i64
...
// CHECK-DAG:       [[RES_:%.+]] = memref.alloca() : memref<index>
// CHECK:           [[VAR_3_:%.+]] = arith.index_cast [[LOAD_PARAM_2_MEM_]] : i64 to index
// CHECK:           [[VAR_4_:%.+]] = arith.minsi [[VAR_3_]], [[CST_1_]] : index
// CHECK:           krnl.store [[VAR_4_]], [[RES_]][] : memref<index>
// CHECK-DAG:       [[RES_1_:%.+]] = memref.alloca() : memref<index>
// CHECK-DAG:       [[RES_2_:%.+]] = memref.alloca() : memref<index>
// CHECK:           krnl.store [[CST_0_1_]], [[RES_2_]][] : memref<index>
...
// CHECK:             krnl.store [[CST_0_1_]], [[RES_1_]][] : memref<index>
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_2_:%.+]] = [[CST_0_1_]] to [[CST_1_]]){
// CHECK:               [[VAR_20_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_PARAM_1_MEM_:%.+]] = krnl.load [[PARAM_1_]]{{.}}[[VAR_15_]]#0, [[VAR_15_]]#1, [[VAR_20_]]{{.}} : memref<1x1x1xf32>
// CHECK-DAG:           [[VAR_22_:%.+]] = arith.cmpf ogt, [[LOAD_PARAM_1_MEM_]], [[LOAD_PARAM_4_MEM_]] : f32
// CHECK-DAG:           [[LOAD_RES_1_MEM_:%.+]] = krnl.load [[RES_1_]][] : memref<index>
// CHECK:               [[VAR_24_:%.+]] = arith.addi [[LOAD_RES_1_MEM_]], [[CST_1_]] : index
// CHECK:               [[VAR_25_:%.+]] = arith.select [[VAR_22_]], [[VAR_24_]], [[LOAD_RES_1_MEM_]] : index
...
// CHECK:           }
// CHECK:           "krnl.call"([[RES_3_]], [[PARAM_1_]], [[CST_2_]], [[CST_0_]]) <{funcName = "omTensorSort", numOfOutput = 1 : si64}> : (memref<1x1x1xindex>, memref<1x1x1xf32>, i64, i64) -> ()
...
// CHECK:             [[VAR_15_2_:%.+]]:2 = krnl.get_induction_var_value([[LOOP_3_]]#0, [[LOOP_3_]]#1) : (!krnl.loop, !krnl.loop) -> (index, index)
// CHECK-DAG:         [[LOOP_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_15_2_]]#0, [[VAR_15_2_]]#1, [[CST_0_1_]]{{.}} : memref<1x1x4xf32>
// CHECK-DAG:         [[LOAD_RES_1_MEM_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_15_2_]]#0, [[VAR_15_2_]]#1, [[CST_1_]]{{.}} : memref<1x1x4xf32>
// CHECK-DAG:         [[LOAD_RES_2_MEM_2_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_15_2_]]#0, [[VAR_15_2_]]#1, [[CST_2_1_]]{{.}} : memref<1x1x4xf32>
// CHECK-DAG:         [[VAR_19_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_15_2_]]#0, [[VAR_15_2_]]#1, [[CST_3_]]{{.}} : memref<1x1x4xf32>
// CHECK:             [[VAR_20_1_:%.+]] = arith.cmpf ogt, [[LOAD_RES_1_MEM_1_]], [[VAR_19_1_]] : f32
// CHECK-DAG:         [[LOAD_PARAM_1_MEM_1_:%.+]] = arith.select [[VAR_20_1_]], [[VAR_19_1_]], [[LOAD_RES_1_MEM_1_]] : f32
// CHECK-DAG:         [[VAR_22_1_:%.+]] = arith.select [[VAR_20_1_]], [[LOAD_RES_1_MEM_1_]], [[VAR_19_1_]] : f32
// CHECK-DAG:         [[LOAD_RES_1_MEM_2_:%.+]] = arith.cmpf ogt, [[LOOP_1_]], [[LOAD_RES_2_MEM_2_]] : f32
...
// CHECK:             krnl.store [[LOAD_PARAM_1_MEM_1_]], [[RES_4_]]{{.}}[[VAR_15_2_]]#0, [[VAR_15_2_]]#1, [[CST_1_]]{{.}} : memref<1x1x4xf32>
...
// CHECK:             [[LOOP_5_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_5_]]) with ([[LOOP_5_]] -> [[I_10_:%.+]] = [[CST_0_1_]] to [[CST_1_]]){
// CHECK:               [[LOAD_RES_1_MEM_1_1_:%.+]] = krnl.get_induction_var_value([[LOOP_5_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_RES_2_MEM_2_:%.+]] = krnl.load [[RES_3_]]{{.}}[[VAR_15_3_]]#0, [[VAR_15_3_]]#1, [[LOAD_RES_1_MEM_1_1_]]{{.}} : memref<1x1x1xindex>
// CHECK:               [[LOAD_PARAM_1_MEM_2_:%.+]] = krnl.load [[PARAM_1_]]{{.}}[[VAR_15_3_]]#0, [[VAR_15_3_]]#1, [[LOAD_RES_2_MEM_2_]]{{.}} : memref<1x1x1xf32>
// CHECK-DAG:           [[VAR_20_2_:%.+]] = arith.cmpf ogt, [[LOAD_PARAM_1_MEM_2_]], [[LOAD_PARAM_4_MEM_]] : f32
// CHECK-DAG:           [[LOAD_PARAM_1_MEM_1_:%.+]] = krnl.load [[RES_7_]][] : memref<index>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_22_2_:%.+]] = arith.cmpi slt, [[LOAD_PARAM_1_MEM_1_]], [[LOAD_RES_MEM_1_]] : index
...
// CHECK-DAG:             [[LOAD_RES_4_MEM_1_:%.+]] = krnl.load [[RES_4_]]{{.}}[[VAR_15_3_]]#0, [[LOAD_RES_2_MEM_2_]], [[CST_1_]]{{.}} : memref<1x1x4xf32>
...
// CHECK:                 krnl.store [[VAR_33_]], [[RES_6_]][] : memref<index>
// CHECK:                 [[LOOP_6_:%.+]] = krnl.define_loops 1
// CHECK:                 krnl.iterate([[LOOP_6_]]) with ([[LOOP_6_]] -> [[I_11_:%.+]] = [[CST_0_1_]] to [[CST_1_]]){
// CHECK:                   [[VAR_35_:%.+]] = krnl.get_induction_var_value([[LOOP_6_]]) : (!krnl.loop) -> index
...
// CHECK-DAG:                 [[LOAD_RES_4_MEM_5_:%.+]] = krnl.load [[RES_4_]]{{.}}[[VAR_15_3_]]#0, [[VAR_35_]], [[CST_1_]]{{.}} : memref<1x1x4xf32>
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: memref<2x6x4xf32>, [[PARAM_1_:%.+]]: memref<2x1x6xf32>, [[PARAM_2_:%.+]]: memref<1xi64>, [[PARAM_3_:%.+]]: memref<1xf32>, [[PARAM_4_:%.+]]: memref<1xf32>) -> memref<?x3xi64> attributes {input_names = ["boxes", "scores", "max_output_boxes_per_class", "iou_threshold", "score_threshold"], output_names = ["selected_indices"]} {
// CHECK-DAG:       [[CST_9_dot_99999993_:%.+]] = arith.constant 9.99999993E-9 : f32
// CHECK-DAG:       [[CST_0_dot_000000_:%.+]] = arith.constant 0.000000e+00 : f32
// CHECK-DAG:       [[CST_minus_1_:%.+]] = arith.constant -1 : index
// CHECK-DAG:       [[CST_0_:%.+]] = arith.constant 0 : i64
...
// CHECK:           krnl.store [[CST_0_1_]], [[RES_2_]][] : memref<index>
// CHECK:           [[LOOP_0_:%.+]]:2 = krnl.define_loops 2
// CHECK:           krnl.iterate([[LOOP_0_]]#0, [[LOOP_0_]]#1) with ([[LOOP_0_]]#0 -> [[I_0_:%.+]] = [[CST_0_1_]] to [[CST_2_1_]], [[LOOP_0_]]#1 -> [[I_1_:%.+]] = [[CST_0_1_]] to [[CST_1_]]){
...
// CHECK:               [[LOAD_PARAM_1_MEM_:%.+]] = krnl.load [[PARAM_1_]]{{.}}[[VAR_16_]]#0, [[VAR_16_]]#1, [[VAR_21_]]{{.}} : memref<2x1x6xf32>
// CHECK-DAG:           [[VAR_23_:%.+]] = arith.cmpf ogt, [[LOAD_PARAM_1_MEM_]], [[LOAD_PARAM_4_MEM_]] : f32
// CHECK-DAG:           [[LOAD_RES_1_MEM_:%.+]] = krnl.load [[RES_1_]][] : memref<index>
...
// CHECK:           }
// CHECK:           "krnl.call"([[RES_3_]], [[PARAM_1_]], [[CST_2_]], [[CST_0_]]) <{funcName = "omTensorSort", numOfOutput = 1 : si64}> : (memref<2x1x6xindex>, memref<2x1x6xf32>, i64, i64) -> ()
...
// CHECK-DAG:         [[LOOP_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[VAR_16_2_]]#1, [[CST_0_1_]]{{.}} : memref<2x6x4xf32>
// CHECK-DAG:         [[LOAD_RES_1_MEM_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[VAR_16_2_]]#1, [[CST_1_]]{{.}} : memref<2x6x4xf32>
// CHECK-DAG:         [[LOAD_RES_2_MEM_2_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[VAR_16_2_]]#1, [[CST_2_1_]]{{.}} : memref<2x6x4xf32>
// CHECK-DAG:         [[VAR_20_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[VAR_16_2_]]#1, [[CST_3_]]{{.}} : memref<2x6x4xf32>
// CHECK:             [[VAR_21_1_:%.+]] = arith.cmpf ogt, [[LOAD_RES_1_MEM_1_]], [[VAR_20_1_]] : f32
// CHECK-DAG:         [[LOAD_PARAM_1_MEM_1_:%.+]] = arith.select [[VAR_21_1_]], [[VAR_20_1_]], [[LOAD_RES_1_MEM_1_]] : f32
...
// CHECK:             krnl.store [[LOAD_PARAM_1_MEM_1_]], [[RES_4_]]{{.}}[[VAR_16_2_]]#0, [[VAR_16_2_]]#1, [[CST_1_]]{{.}} : memref<2x6x4xf32>
...
// CHECK-DAG:       [[RES_7_:%.+]] = memref.alloca() : memref<index>
// CHECK-DAG:       [[LOOP_4_:%.+]]:2 = krnl.define_loops 2
// CHECK:           krnl.iterate([[LOOP_4_]]#0, [[LOOP_4_]]#1) with ([[LOOP_4_]]#0 -> [[I_8_:%.+]] = [[CST_0_1_]] to [[CST_2_1_]], [[LOOP_4_]]#1 -> [[I_9_:%.+]] = [[CST_0_1_]] to [[CST_1_]]){
...
// CHECK:               [[LOAD_PARAM_1_MEM_2_:%.+]] = krnl.load [[PARAM_1_]]{{.}}[[VAR_16_3_]]#0, [[VAR_16_3_]]#1, [[LOAD_RES_2_MEM_2_]]{{.}} : memref<2x1x6xf32>
// CHECK-DAG:           [[VAR_21_2_:%.+]] = arith.cmpf ogt, [[LOAD_PARAM_1_MEM_2_]], [[LOAD_PARAM_4_MEM_]] : f32
// CHECK-DAG:           [[LOAD_PARAM_1_MEM_1_:%.+]] = krnl.load [[RES_7_]][] : memref<index>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_23_2_:%.+]] = arith.cmpi slt, [[LOAD_PARAM_1_MEM_1_]], [[LOAD_RES_MEM_1_]] : index
// CHECK-DAG:           [[LOAD_RES_1_MEM_2_:%.+]] = krnl.load [[RES_8_]]{{.}}[[LOAD_RES_2_MEM_2_]]{{.}} : memref<6xi1>
// CHECK-NOT: separator of consecutive DAGs
...
// CHECK-DAG:             [[LOAD_RES_4_MEM_1_:%.+]] = krnl.load [[RES_4_]]{{.}}[[VAR_16_3_]]#0, [[LOAD_RES_2_MEM_2_]], [[CST_1_]]{{.}} : memref<2x6x4xf32>
...
// CHECK:                 krnl.store [[VAR_16_3_]]#1, [[RES_5_]]{{.}}[[LOAD_RES_6_MEM_]], [[CST_1_]]{{.}} : memref<?x3xindex>
// CHECK:                 krnl.store [[LOAD_RES_2_MEM_2_]], [[RES_5_]]{{.}}[[LOAD_RES_6_MEM_]], [[CST_2_1_]]{{.}} : memref<?x3xindex>
// CHECK:                 [[VAR_33_:%.+]] = arith.addi [[LOAD_PARAM_1_MEM_1_]], [[CST_1_]] : index
// CHECK:                 krnl.store [[VAR_33_]], [[RES_7_]][] : memref<index>
// CHECK:                 [[VAR_34_:%.+]] = arith.addi [[LOAD_RES_6_MEM_]], [[CST_1_]] : index
...
// CHECK-DAG:                 [[LOAD_RES_4_MEM_5_:%.+]] = krnl.load [[RES_4_]]{{.}}[[VAR_16_3_]]#0, [[VAR_36_]], [[CST_1_]]{{.}} : memref<2x6x4xf32>
...
// CHECK-DAG:                 [[VAR_44_:%.+]] = arith.subf [[LOAD_RES_4_MEM_2_]], [[LOAD_RES_4_MEM_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_45_:%.+]] = arith.mulf [[VAR_44_]], [[VAR_43_]] : f32
// CHECK-DAG:                 [[VAR_46_:%.+]] = arith.subf [[LOAD_RES_4_MEM_7_]], [[LOAD_RES_4_MEM_5_]] : f32
// CHECK-DAG:                 [[VAR_47_:%.+]] = arith.subf [[LOAD_RES_4_MEM_6_]], [[LOAD_RES_4_MEM_4_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_48_:%.+]] = arith.mulf [[VAR_47_]], [[VAR_46_]] : f32
...
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_55_:%.+]] = arith.maxf [[VAR_54_]], [[CST_0_dot_000000_]] : f32
// CHECK-DAG:                 [[VAR_56_:%.+]] = arith.maxf [[VAR_53_]], [[CST_0_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_57_:%.+]] = arith.mulf [[VAR_56_]], [[VAR_55_]] : f32
...
// CHECK:                     [[VAR_62_:%.+]] = arith.cmpf oge, [[VAR_61_]], [[LOAD_PARAM_3_MEM_]] : f32
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: memref<1x6x4xf32>, [[PARAM_1_:%.+]]: memref<1x2x6xf32>, [[PARAM_2_:%.+]]: memref<1xi64>, [[PARAM_3_:%.+]]: memref<1xf32>, [[PARAM_4_:%.+]]: memref<1xf32>) -> memref<?x3xi64> attributes {input_names = ["boxes", "scores", "max_output_boxes_per_class", "iou_threshold", "score_threshold"], output_names = ["selected_indices"]} {
// CHECK-DAG:       [[CST_9_dot_99999993_:%.+]] = arith.constant 9.99999993E-9 : f32
// CHECK-DAG:       [[CST_0_dot_000000_:%.+]] = arith.constant 0.000000e+00 : f32
// CHECK-DAG:       [[CST_minus_1_:%.+]] = arith.constant -1 : index
// CHECK-DAG:       [[CST_0_:%.+]] = arith.constant 0 : i64
...
// CHECK:           krnl.store [[CST_0_1_]], [[RES_2_]][] : memref<index>
// CHECK:           [[LOOP_0_:%.+]]:2 = krnl.define_loops 2
// CHECK:           krnl.iterate([[LOOP_0_]]#0, [[LOOP_0_]]#1) with ([[LOOP_0_]]#0 -> [[I_0_:%.+]] = [[CST_0_1_]] to [[CST_1_]], [[LOOP_0_]]#1 -> [[I_1_:%.+]] = [[CST_0_1_]] to [[CST_2_1_]]){
// CHECK:             [[VAR_16_:%.+]]:2 = krnl.get_induction_var_value([[LOOP_0_]]#0, [[LOOP_0_]]#1) : (!krnl.loop, !krnl.loop) -> (index, index)
// CHECK:             krnl.store [[CST_0_1_]], [[RES_1_]][] : memref<index>
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_2_:%.+]] = [[CST_0_1_]] to [[CST_6_]]){
// CHECK:               [[VAR_21_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_PARAM_1_MEM_:%.+]] = krnl.load [[PARAM_1_]]{{.}}[[VAR_16_]]#0, [[VAR_16_]]#1, [[VAR_21_]]{{.}} : memref<1x2x6xf32>
// CHECK-DAG:           [[VAR_23_:%.+]] = arith.cmpf ogt, [[LOAD_PARAM_1_MEM_]], [[LOAD_PARAM_4_MEM_]] : f32
// CHECK-DAG:           [[LOAD_RES_1_MEM_:%.+]] = krnl.load [[RES_1_]][] : memref<index>
// CHECK:               [[VAR_25_:%.+]] = arith.addi [[LOAD_RES_1_MEM_]], [[CST_1_]] : index
// CHECK:               [[VAR_26_:%.+]] = arith.select [[VAR_23_]], [[VAR_25_]], [[LOAD_RES_1_MEM_]] : index
...
// CHECK:           }
// CHECK:           "krnl.call"([[RES_3_]], [[PARAM_1_]], [[CST_2_]], [[CST_0_]]) <{funcName = "omTensorSort", numOfOutput = 1 : si64}> : (memref<1x2x6xindex>, memref<1x2x6xf32>, i64, i64) -> ()
// CHECK-DAG:       [[RES_4_:%.+]] = memref.alloc() {{.*}}: memref<1x6x4xf32>
// CHECK-DAG:       [[LOOP_3_:%.+]]:2 = krnl.define_loops 2
// CHECK:           krnl.iterate([[LOOP_3_]]#0, [[LOOP_3_]]#1) with ([[LOOP_3_]]#0 -> [[I_6_:%.+]] = 0 to 1, [[LOOP_3_]]#1 -> [[I_7_:%.+]] = 0 to 6){
// CHECK:             [[VAR_16_2_:%.+]]:2 = krnl.get_induction_var_value([[LOOP_3_]]#0, [[LOOP_3_]]#1) : (!krnl.loop, !krnl.loop) -> (index, index)
// CHECK-DAG:         [[LOOP_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[VAR_16_2_]]#1, [[CST_0_1_]]{{.}} : memref<1x6x4xf32>
// CHECK-DAG:         [[LOAD_RES_1_MEM_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[VAR_16_2_]]#1, [[CST_1_]]{{.}} : memref<1x6x4xf32>
// CHECK-DAG:         [[LOAD_RES_2_MEM_2_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[VAR_16_2_]]#1, [[CST_2_1_]]{{.}} : memref<1x6x4xf32>
// CHECK-DAG:         [[VAR_20_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[VAR_16_2_]]#1, [[CST_3_]]{{.}} : memref<1x6x4xf32>
// CHECK:             [[VAR_21_1_:%.+]] = arith.cmpf ogt, [[LOAD_RES_1_MEM_1_]], [[VAR_20_1_]] : f32
// CHECK-DAG:         [[LOAD_PARAM_1_MEM_1_:%.+]] = arith.select [[VAR_21_1_]], [[VAR_20_1_]], [[LOAD_RES_1_MEM_1_]] : f32
// CHECK-DAG:         [[VAR_23_1_:%.+]] = arith.select [[VAR_21_1_]], [[LOAD_RES_1_MEM_1_]], [[VAR_20_1_]] : f32
// CHECK-DAG:         [[LOAD_RES_1_MEM_2_:%.+]] = arith.cmpf ogt, [[LOOP_1_]], [[LOAD_RES_2_MEM_2_]] : f32
...
// CHECK:             krnl.store [[LOAD_PARAM_1_MEM_1_]], [[RES_4_]]{{.}}[[VAR_16_2_]]#0, [[VAR_16_2_]]#1, [[CST_1_]]{{.}} : memref<1x6x4xf32>
...
// CHECK-DAG:       [[RES_7_:%.+]] = memref.alloca() : memref<index>
// CHECK-DAG:       [[LOOP_4_:%.+]]:2 = krnl.define_loops 2
// CHECK:           krnl.iterate([[LOOP_4_]]#0, [[LOOP_4_]]#1) with ([[LOOP_4_]]#0 -> [[I_8_:%.+]] = [[CST_0_1_]] to [[CST_1_]], [[LOOP_4_]]#1 -> [[I_9_:%.+]] = [[CST_0_1_]] to [[CST_2_1_]]){
// CHECK:             [[VAR_16_3_:%.+]]:2 = krnl.get_induction_var_value([[LOOP_4_]]#0, [[LOOP_4_]]#1) : (!krnl.loop, !krnl.loop) -> (index, index)
// CHECK:             krnl.store [[CST_0_1_]], [[RES_7_]][] : memref<index>
// CHECK:             [[RES_8_:%.+]] = memref.alloc() {{.*}}: memref<6xi1>
// CHECK:             krnl.memset [[RES_8_]], [[VAR_false_]] : memref<6xi1>
...
// CHECK:               [[LOAD_PARAM_1_MEM_2_:%.+]] = krnl.load [[PARAM_1_]]{{.}}[[VAR_16_3_]]#0, [[VAR_16_3_]]#1, [[LOAD_RES_2_MEM_2_]]{{.}} : memref<1x2x6xf32>
// CHECK-DAG:           [[VAR_21_2_:%.+]] = arith.cmpf ogt, [[LOAD_PARAM_1_MEM_2_]], [[LOAD_PARAM_4_MEM_]] : f32
// CHECK-DAG:           [[LOAD_PARAM_1_MEM_1_:%.+]] = krnl.load [[RES_7_]][] : memref<index>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_23_2_:%.+]] = arith.cmpi slt, [[LOAD_PARAM_1_MEM_1_]], [[LOAD_RES_MEM_1_]] : index
...
// CHECK-DAG:             [[LOAD_RES_4_MEM_1_:%.+]] = krnl.load [[RES_4_]]{{.}}[[VAR_16_3_]]#0, [[LOAD_RES_2_MEM_2_]], [[CST_1_]]{{.}} : memref<1x6x4xf32>
...
// CHECK-DAG:                 [[LOAD_RES_4_MEM_5_:%.+]] = krnl.load [[RES_4_]]{{.}}[[VAR_16_3_]]#0, [[VAR_36_]], [[CST_1_]]{{.}} : memref<1x6x4xf32>
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: memref<?x?x?xf32>, [[PARAM_1_:%.+]]: memref<?x?x?xf32>, [[PARAM_2_:%.+]]: memref<1xi64>, [[PARAM_3_:%.+]]: memref<1xf32>, [[PARAM_4_:%.+]]: memref<1xf32>) -> memref<?x3xi64> {
// CHECK-DAG:       [[CST_9_dot_99999993_:%.+]] = arith.constant 9.99999993E-9 : f32
// CHECK-DAG:       [[CST_0_dot_000000_:%.+]] = arith.constant 0.000000e+00 : f32
// CHECK-DAG:       [[CST_2_dot_000000_:%.+]] = arith.constant 2.000000e+00 : f32
// CHECK-DAG:       [[CST_minus_1_:%.+]] = arith.constant -1 : index
...
// CHECK-DAG:       [[LOAD_PARAM_4_MEM_:%.+]] = krnl.load [[PARAM_4_]]{{.}}[[CST_0_1_]]{{.}} : memref<1xf32>
// CHECK-DAG:       [[LOAD_PARAM_3_MEM_:%.+]] = krnl.load [[PARAM_3_]]{{.}}[[CST_0_1_]]{{.}} : memref<1xf32>
// CHECK-DAG:       [[VAR_dim_:%.+]] = memref.dim [[PARAM_1_]], [[CST_0_1_]] : memref<?x?x?xf32>
// CHECK-DAG:       [[VAR_dim_2_:%.+]] = memref.dim [[PARAM_1_]], [[CST_1_]] : memref<?x?x?xf32>
// CHECK-DAG:       [[VAR_dim_3_:%.+]] = memref.dim [[PARAM_1_]], [[CST_2_1_]] : memref<?x?x?xf32>
// CHECK-DAG:       [[RES_:%.+]] = memref.alloca() : memref<index>
// CHECK:           [[VAR_3_:%.+]] = arith.index_cast [[LOAD_PARAM_2_MEM_]] : i64 to index
// CHECK:           [[VAR_4_:%.+]] = arith.minsi [[VAR_3_]], [[VAR_dim_3_]] : index
// CHECK:           krnl.store [[VAR_4_]], [[RES_]][] : memref<index>
// CHECK-DAG:       [[VAR_dim_4_:%.+]] = memref.dim [[PARAM_1_]], [[CST_0_1_]] : memref<?x?x?xf32>
// CHECK-DAG:       [[VAR_dim_5_:%.+]] = memref.dim [[PARAM_1_]], [[CST_1_]] : memref<?x?x?xf32>
// CHECK-DAG:       [[VAR_dim_6_:%.+]] = memref.dim [[PARAM_1_]], [[CST_2_1_]] : memref<?x?x?xf32>
// CHECK-DAG:       [[RES_1_:%.+]] = memref.alloca() : memref<index>
// CHECK-DAG:       [[RES_2_:%.+]] = memref.alloca() : memref<index>
// CHECK:           krnl.store [[CST_0_1_]], [[RES_2_]][] : memref<index>
// CHECK:           [[LOOP_0_:%.+]]:2 = krnl.define_loops 2
...
// CHECK:               [[VAR_21_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_PARAM_1_MEM_:%.+]] = krnl.load [[PARAM_1_]]{{.}}[[VAR_16_]]#0, [[VAR_16_]]#1, [[VAR_21_]]{{.}} : memref<?x?x?xf32>
// CHECK-DAG:           [[VAR_23_:%.+]] = arith.cmpf ogt, [[LOAD_PARAM_1_MEM_]], [[LOAD_PARAM_4_MEM_]] : f32
// CHECK-DAG:           [[LOAD_RES_1_MEM_:%.+]] = krnl.load [[RES_1_]][] : memref<index>
// CHECK:               [[VAR_25_:%.+]] = arith.addi [[LOAD_RES_1_MEM_]], [[CST_1_]] : index
// CHECK:               [[VAR_26_:%.+]] = arith.select [[VAR_23_]], [[VAR_25_]], [[LOAD_RES_1_MEM_]] : index
...
// CHECK:           krnl.store [[VAR_8_]], [[RES_]][] : memref<index>
// CHECK-DAG:       [[LOAD_RES_MEM_1_:%.+]] = krnl.load [[RES_]][] : memref<index>
// CHECK-DAG:       [[VAR_dim_9_:%.+]] = memref.dim [[PARAM_1_]], [[CST_0_1_]] : memref<?x?x?xf32>
// CHECK-DAG:       [[VAR_dim_10_:%.+]] = memref.dim [[PARAM_1_]], [[CST_1_]] : memref<?x?x?xf32>
// CHECK-DAG:       [[VAR_dim_11_:%.+]] = memref.dim [[PARAM_1_]], [[CST_2_1_]] : memref<?x?x?xf32>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[RES_3_:%.+]] = memref.alloc([[VAR_dim_9_]], [[VAR_dim_10_]], [[VAR_dim_11_]]) {{.*}}: memref<?x?x?xindex>
// CHECK-DAG:       [[LOOP_2_:%.+]]:3 = krnl.define_loops 3
// CHECK:           krnl.iterate([[LOOP_2_]]#0, [[LOOP_2_]]#1, [[LOOP_2_]]#2) with ([[LOOP_2_]]#0 -> [[I_3_:%.+]] = 0 to [[MAP_0_]]([[VAR_dim_9_]]), [[LOOP_2_]]#1 -> [[I_4_:%.+]] = 0 to [[MAP_1_]]([[VAR_dim_9_]], [[VAR_dim_10_]]), [[LOOP_2_]]#2 -> [[I_5_:%.+]] = 0 to [[MAP_2_]]([[VAR_dim_9_]], [[VAR_dim_10_]], [[VAR_dim_11_]])){
// CHECK:             [[VAR_16_1_:%.+]]:3 = krnl.get_induction_var_value([[LOOP_2_]]#0, [[LOOP_2_]]#1, [[LOOP_2_]]#2) : (!krnl.loop, !krnl.loop, !krnl.loop) -> (index, index, index)
// CHECK:             krnl.store [[VAR_16_1_]]#2, [[RES_3_]]{{.}}[[VAR_16_1_]]#0, [[VAR_16_1_]]#1, [[VAR_16_1_]]#2] : memref<?x?x?xindex>
// CHECK:           }
// CHECK:           "krnl.call"([[RES_3_]], [[PARAM_1_]], [[CST_2_]], [[CST_0_]]) <{funcName = "omTensorSort", numOfOutput = 1 : si64}> : (memref<?x?x?xindex>, memref<?x?x?xf32>, i64, i64) -> ()
...
// CHECK:               [[LOAD_PARAM_1_MEM_1_:%.+]] = krnl.load [[PARAM_1_]]{{.}}[[VAR_16_2_]]#0, [[VAR_16_2_]]#1, [[LOAD_RES_2_MEM_2_]]{{.}} : memref<?x?x?xf32>
// CHECK-DAG:           [[VAR_21_1_:%.+]] = arith.cmpf ogt, [[LOAD_PARAM_1_MEM_1_]], [[LOAD_PARAM_4_MEM_]] : f32
// CHECK-DAG:           [[LOAD_PARAM_1_MEM_2_:%.+]] = krnl.load [[RES_6_]][] : memref<index>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_23_1_:%.+]] = arith.cmpi slt, [[LOAD_PARAM_1_MEM_2_]], [[LOAD_RES_MEM_1_]] : index
...
// CHECK:               scf.if [[VAR_27_]] {
// CHECK-DAG:             [[LOAD_PARAM_0_MEM_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[LOAD_RES_2_MEM_2_]], [[CST_0_1_]]{{.}} : memref<?x?x?xf32>
// CHECK-DAG:             [[LOAD_PARAM_0_MEM_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[LOAD_RES_2_MEM_2_]], [[CST_1_]]{{.}} : memref<?x?x?xf32>
// CHECK-DAG:             [[LOAD_PARAM_0_MEM_2_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[LOAD_RES_2_MEM_2_]], [[CST_2_1_]]{{.}} : memref<?x?x?xf32>
// CHECK-DAG:             [[LOAD_PARAM_0_MEM_3_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[LOAD_RES_2_MEM_2_]], [[CST_3_]]{{.}} : memref<?x?x?xf32>
// CHECK-DAG:             [[LOAD_RES_5_MEM_:%.+]] = krnl.load [[RES_5_]][] : memref<index>
...
// CHECK:                 krnl.store [[LOAD_RES_2_MEM_2_]], [[RES_4_]]{{.}}[[LOAD_RES_5_MEM_]], [[CST_2_1_]]{{.}} : memref<?x3xindex>
// CHECK:                 [[VAR_33_:%.+]] = arith.addi [[LOAD_PARAM_1_MEM_2_]], [[CST_1_]] : index
// CHECK:                 krnl.store [[VAR_33_]], [[RES_6_]][] : memref<index>
...
// CHECK:                   scf.if [[VAR_38_]] {
// CHECK-DAG:                 [[LOAD_PARAM_0_MEM_4_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[VAR_36_]], [[CST_0_1_]]{{.}} : memref<?x?x?xf32>
// CHECK-DAG:                 [[LOAD_PARAM_0_MEM_5_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[VAR_36_]], [[CST_1_]]{{.}} : memref<?x?x?xf32>
// CHECK-DAG:                 [[LOAD_PARAM_0_MEM_6_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[VAR_36_]], [[CST_2_1_]]{{.}} : memref<?x?x?xf32>
// CHECK-DAG:                 [[LOAD_PARAM_0_MEM_7_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_16_2_]]#0, [[VAR_36_]], [[CST_3_]]{{.}} : memref<?x?x?xf32>
// CHECK-DAG:                 [[VAR_43_:%.+]] = arith.divf [[LOAD_PARAM_0_MEM_2_]], [[CST_2_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_44_:%.+]] = arith.subf [[LOAD_PARAM_0_MEM_]], [[VAR_43_]] : f32
// CHECK-DAG:                 [[VAR_45_:%.+]] = arith.divf [[LOAD_PARAM_0_MEM_2_]], [[CST_2_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_46_:%.+]] = arith.addf [[LOAD_PARAM_0_MEM_]], [[VAR_45_]] : f32
// CHECK-DAG:                 [[VAR_47_:%.+]] = arith.divf [[LOAD_PARAM_0_MEM_3_]], [[CST_2_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_48_:%.+]] = arith.subf [[LOAD_PARAM_0_MEM_1_]], [[VAR_47_]] : f32
// CHECK-DAG:                 [[VAR_49_:%.+]] = arith.divf [[LOAD_PARAM_0_MEM_3_]], [[CST_2_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_50_:%.+]] = arith.addf [[LOAD_PARAM_0_MEM_1_]], [[VAR_49_]] : f32
// CHECK-DAG:                 [[VAR_51_:%.+]] = arith.divf [[LOAD_PARAM_0_MEM_7_]], [[CST_2_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_52_:%.+]] = arith.subf [[LOAD_PARAM_0_MEM_5_]], [[VAR_51_]] : f32
// CHECK-DAG:                 [[VAR_53_:%.+]] = arith.divf [[LOAD_PARAM_0_MEM_7_]], [[CST_2_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_54_:%.+]] = arith.addf [[LOAD_PARAM_0_MEM_5_]], [[VAR_53_]] : f32
// CHECK-DAG:                 [[VAR_55_:%.+]] = arith.divf [[LOAD_PARAM_0_MEM_6_]], [[CST_2_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_56_:%.+]] = arith.subf [[LOAD_PARAM_0_MEM_4_]], [[VAR_55_]] : f32
// CHECK-DAG:                 [[VAR_57_:%.+]] = arith.divf [[LOAD_PARAM_0_MEM_6_]], [[CST_2_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_58_:%.+]] = arith.addf [[LOAD_PARAM_0_MEM_4_]], [[VAR_57_]] : f32
// CHECK-DAG:                 [[VAR_59_:%.+]] = arith.mulf [[LOAD_PARAM_0_MEM_3_]], [[LOAD_PARAM_0_MEM_2_]] : f32
// CHECK-DAG:                 [[VAR_60_:%.+]] = arith.mulf [[LOAD_PARAM_0_MEM_7_]], [[LOAD_PARAM_0_MEM_6_]] : f32
...
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_67_:%.+]] = arith.maxf [[VAR_66_]], [[CST_0_dot_000000_]] : f32
// CHECK-DAG:                 [[VAR_68_:%.+]] = arith.maxf [[VAR_65_]], [[CST_0_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                 [[VAR_69_:%.+]] = arith.mulf [[VAR_68_]], [[VAR_67_]] : f32
...
// CHECK:                     [[VAR_74_:%.+]] = arith.cmpf oge, [[VAR_73_]], [[LOAD_PARAM_3_MEM_]] : f32
