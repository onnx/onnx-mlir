...
// CHECK:           [[VAR_view_:%.+]] = memref.view [[RES_]]{{.}}[[CST_0_]]{{.}}[] : memref<256xi8> to memref<60xf32>
...
// CHECK:             krnl.iterate([[BLOCK_TILE__0_]]) with ([[LOOP_0_]] -> [[I_0_:%.+]] = 0 to 29){
// CHECK:               [[VAR_2_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK-DAG:           [[LOAD_A_MEM_:%.+]] = vector.load [[A_]]{{.}}[[VAR_2_]]{{.}} : memref<60xf32>, vector<32xf32>
// CHECK-DAG:           [[LOAD_B_MEM_:%.+]] = vector.load [[B_]]{{.}}[[VAR_2_]]{{.}} : memref<60xf32>, vector<32xf32>
// CHECK:               [[VAR_5_:%.+]] = arith.remf [[LOAD_A_MEM_]], [[LOAD_B_MEM_]] : vector<32xf32>
// CHECK:               [[VAR_6_:%.+]] = math.copysign [[VAR_5_]], [[LOAD_A_MEM_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_6_]], [[VAR_view_]]{{.}}[[VAR_2_]]{{.}} : memref<60xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = 32 to 60){
// CHECK:               [[VAR_2_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK-DAG:           [[LOAD_A_MEM_1_:%.+]] = krnl.load [[A_]]{{.}}[[VAR_2_1_]]{{.}} : memref<60xf32>
// CHECK-DAG:           [[LOAD_B_MEM_1_:%.+]] = krnl.load [[B_]]{{.}}[[VAR_2_1_]]{{.}} : memref<60xf32>
// CHECK:               [[VAR_5_1_:%.+]] = arith.remf [[LOAD_A_MEM_1_]], [[LOAD_B_MEM_1_]] : f32
// CHECK:               [[VAR_6_1_:%.+]] = math.copysign [[VAR_5_1_]], [[LOAD_A_MEM_1_]] : f32
// CHECK:               krnl.store [[VAR_6_1_]], [[VAR_view_]]{{.}}[[VAR_2_1_]]{{.}} : memref<60xf32>
// CHECK:             }
// CHECK:           }
...
// CHECK-DAG:       [[VAR_cst_:%.+]] = arith.constant dense<3.000000e+00> : vector<28xf32>
// CHECK-DAG:       [[CST_3_dot_000000_:%.+]] = arith.constant 3.000000e+00 : f32
// CHECK-DAG:       [[CST_0_:%.+]] = arith.constant 0 : index
// CHECK-DAG:       [[RES_:%.+]] = memref.alloc() {{.*}}: memref<224xi8>
// CHECK:           [[VAR_view_:%.+]] = memref.view [[RES_]]{{.}}[[CST_0_]]{{.}}[] : memref<224xi8> to memref<30xf32>
// CHECK:           krnl.iterate() with (){
// CHECK:             [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK:             [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 28 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
// CHECK:             krnl.iterate([[BLOCK_TILE__0_]]) with ([[LOOP_0_]] -> [[I_0_:%.+]] = 0 to 3){
// CHECK:               [[VAR_2_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK-DAG:           [[LOAD_A_MEM_:%.+]] = vector.load [[A_]]{{.}}[[VAR_2_]]{{.}} : memref<30xf32>, vector<28xf32>
// CHECK-DAG:           [[LOAD_B_MEM_:%.+]] = vector.load [[B_]]{{.}}[[VAR_2_]]{{.}} : memref<30xf32>, vector<28xf32>
// CHECK-DAG:           [[LOAD_C_MEM_:%.+]] = vector.load [[C_]]{{.}}[[VAR_2_]]{{.}} : memref<30xf32>, vector<28xf32>
// CHECK:               [[VAR_6_:%.+]] = arith.addf [[LOAD_A_MEM_]], [[LOAD_B_MEM_]] : vector<28xf32>
// CHECK:               [[VAR_7_:%.+]] = arith.addf [[VAR_6_]], [[LOAD_C_MEM_]] : vector<28xf32>
// CHECK:               [[VAR_8_:%.+]] = arith.divf [[VAR_7_]], [[VAR_cst_]] : vector<28xf32>
// CHECK:               vector.store [[VAR_8_]], [[VAR_view_]]{{.}}[[VAR_2_]]{{.}} : memref<30xf32>, vector<28xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = 28 to 30){
// CHECK:               [[VAR_2_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK-DAG:           [[LOAD_A_MEM_1_:%.+]] = krnl.load [[A_]]{{.}}[[VAR_2_1_]]{{.}} : memref<30xf32>
// CHECK-DAG:           [[LOAD_B_MEM_1_:%.+]] = krnl.load [[B_]]{{.}}[[VAR_2_1_]]{{.}} : memref<30xf32>
// CHECK-DAG:           [[LOAD_C_MEM_1_:%.+]] = krnl.load [[C_]]{{.}}[[VAR_2_1_]]{{.}} : memref<30xf32>
// CHECK:               [[VAR_6_1_:%.+]] = arith.addf [[LOAD_A_MEM_1_]], [[LOAD_B_MEM_1_]] : f32
// CHECK:               [[VAR_7_1_:%.+]] = arith.addf [[VAR_6_1_]], [[LOAD_C_MEM_1_]] : f32
// CHECK:               [[VAR_8_1_:%.+]] = arith.divf [[VAR_7_1_]], [[CST_3_dot_000000_]] : f32
// CHECK:               krnl.store [[VAR_8_1_]], [[VAR_view_]]{{.}}[[VAR_2_1_]]{{.}} : memref<30xf32>
// CHECK:             }
// CHECK:           }
...
// CHECK-DAG:       [[CST_0_:%.+]] = arith.constant 0 : index
// CHECK-DAG:       [[RES_:%.+]] = memref.alloc() {{.*}}: memref<96xi8>
// CHECK:           [[VAR_view_:%.+]] = memref.view [[RES_]]{{.}}[[CST_0_]]{{.}}[] : memref<96xi8> to memref<15xf32>
// CHECK:           krnl.iterate() with (){
// CHECK:             [[LOOP_0_:%.+]] = krnl.define_loops 1
...
// CHECK:               [[VAR_2_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_PARAM_0_MEM_1_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[VAR_2_1_]]{{.}} : memref<15xf32>
// CHECK:               [[VAR_4_1_:%.+]] = "krnl.round_even"([[LOAD_PARAM_0_MEM_1_]]) : (f32) -> f32
// CHECK:               krnl.store [[VAR_4_1_]], [[VAR_view_]]{{.}}[[VAR_2_1_]]{{.}} : memref<15xf32>
// CHECK:             }
// CHECK:           }
...
// multiple of 32 due to unrolling

func.func private @test_round_multiple16(%arg0 : tensor<?x32xf32>) -> tensor<*xf32> {
  %0 = "onnx.Round"(%arg0) : (tensor<?x32xf32>) -> tensor<*xf32>
  "func.return"(%0) : (tensor<*xf32>) -> ()

// mlir2FileCheck.py
// CHECK-DAG:   [[MAP_0_:#.+]] = affine_map<()[s0] -> (s0 * 32)>
// CHECK-DAG:   [[MAP_1_:#.+]] = affine_map<()[s0, s1, s2] -> (s2)>
// CHECK-LABEL:  func.func private @test_round_multiple16
// CHECK-SAME:   ([[PARAM_0_:%.+]]: memref<?x32xf32>) -> memref<?x32xf32> {
// CHECK:           [[CST_0_:%.+]] = arith.constant 0 : index
// CHECK:           [[VAR_dim_:%.+]] = memref.dim [[PARAM_0_]], [[CST_0_]] : memref<?x32xf32>
// CHECK-DAG:       [[RES_:%.+]] = memref.alloc([[VAR_dim_]]) {{.*}}: memref<?x32xf32>
// CHECK-DAG:       [[VAR_dim_0_:%.+]] = memref.dim [[PARAM_0_]], [[CST_0_]] : memref<?x32xf32>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_0_:%.+]] = affine.apply [[MAP_0_]](){{.}}[[VAR_dim_0_]]{{.}}
// CHECK-DAG:       [[RES_1_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK:           affine.store [[VAR_0_]], [[RES_1_]][0] : memref<1xindex>
// CHECK-DAG:       [[VAR_reshape_:%.+]] = memref.reshape [[PARAM_0_]]([[RES_1_]]) : (memref<?x32xf32>, memref<1xindex>) -> memref<?xf32>
// CHECK-DAG:       [[VAR_1_:%.+]] = affine.apply [[MAP_0_]](){{.}}[[VAR_dim_]]{{.}}
// CHECK-DAG:       [[RES_2_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK:           affine.store [[VAR_1_]], [[RES_2_]][0] : memref<1xindex>
// CHECK:           [[VAR_reshape_3_:%.+]] = memref.reshape [[RES_]]([[RES_]]_2) : (memref<?x32xf32>, memref<1xindex>) -> memref<?xf32>
// CHECK:           krnl.iterate() with (){
// CHECK:             [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK:             [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 32 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
// CHECK:             krnl.iterate([[BLOCK_TILE__0_]]) with ([[LOOP_0_]] -> [[I_0_:%.+]] = 0 to [[MAP_1_]](){{.}}[[VAR_dim_0_]], [[VAR_dim_]], [[VAR_1_]]{{.}}){
...
// CHECK:           [[VAR_reshape_2_:%.+]] = memref.reshape [[RES_]]([[RES_]]_1) : (memref<4x8x16xf32>, memref<1xindex>) -> memref<512xf32>
// CHECK:           krnl.iterate() with (){
// CHECK:             [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK:             [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 32 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
...
// CHECK:               [[VAR_4_:%.+]] = vector.broadcast [[LOAD_PARAM_1_MEM_]] : f32 to vector<32xf32>
...
// CHECK:           [[VAR_reshape_5_:%.+]] = memref.reshape [[RES_]]([[RES_]]_4) : (memref<?x?x64xf32>, memref<1xindex>) -> memref<?xf32>
// CHECK:           krnl.iterate() with (){
// CHECK:             [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK:             [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 32 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
...
// CHECK-DAG:           [[LOAD_PARAM_1_MEM_:%.+]] = krnl.load [[PARAM_1_]][] : memref<f32>
// CHECK:               [[VAR_8_:%.+]] = vector.broadcast [[LOAD_PARAM_1_MEM_]] : f32 to vector<32xf32>
...
// CHECK-DAG:       [[RES_2_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK:           affine.store [[VAR_3_]], [[RES_2_]][0] : memref<1xindex>
// CHECK:           [[VAR_reshape_5_:%.+]] = memref.reshape [[RES_]]([[RES_]]_4) : (memref<?x?x768xf32>, memref<1xindex>) -> memref<?xf32>
// CHECK:           krnl.iterate() with (){
// CHECK:             [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK:             [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 32 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
// CHECK:             krnl.iterate([[BLOCK_TILE__0_]]) with ([[LOOP_0_]] -> [[I_0_:%.+]] = 0 to [[VAR_3_]]){
...
// CHECK:           [[VAR_reshape_4_:%.+]] = memref.reshape [[VAR_view_]]([[RES_3_]]) : (memref<10x10xf32>, memref<1xindex>) -> memref<100xf32>
// CHECK:           krnl.iterate() with (){
// CHECK:             [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK:             [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 32 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
// CHECK:             krnl.iterate([[BLOCK_TILE__0_]]) with ([[LOOP_0_]] -> [[I_0_:%.+]] = 0 to 69){
// CHECK:               [[VAR_2_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK-DAG:           [[LOAD_VAR_reshape_2_MEM_:%.+]] = vector.load [[VAR_reshape_2_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK:               [[VAR_5_:%.+]] = arith.addf [[LOAD_VAR_reshape_MEM_]], [[LOAD_VAR_reshape_2_MEM_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_5_]], [[VAR_reshape_4_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = 96 to 100){
// CHECK:               [[VAR_2_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK-DAG:           [[LOAD_VAR_reshape_2_MEM_1_:%.+]] = krnl.load [[VAR_reshape_2_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK:               [[VAR_5_1_:%.+]] = arith.addf [[LOAD_VAR_reshape_MEM_1_]], [[LOAD_VAR_reshape_2_MEM_1_]] : f32
// CHECK:               krnl.store [[VAR_5_1_]], [[VAR_reshape_4_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK:             }
// CHECK:           }
...
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK-DAG:           [[LOAD_VAR_reshape_2_MEM_:%.+]] = vector.load [[VAR_reshape_2_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK:               [[VAR_5_:%.+]] = arith.mulf [[LOAD_VAR_reshape_MEM_]], [[LOAD_VAR_reshape_2_MEM_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_5_]], [[VAR_reshape_4_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = 96 to 100){
...
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK-DAG:           [[LOAD_VAR_reshape_2_MEM_1_:%.+]] = krnl.load [[VAR_reshape_2_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK:               [[VAR_5_1_:%.+]] = arith.mulf [[LOAD_VAR_reshape_MEM_1_]], [[LOAD_VAR_reshape_2_MEM_1_]] : f32
// CHECK:               krnl.store [[VAR_5_1_]], [[VAR_reshape_4_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<10x10xf32>
...
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK-DAG:           [[LOAD_VAR_reshape_2_MEM_:%.+]] = vector.load [[VAR_reshape_2_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK:               [[VAR_5_:%.+]] = arith.divf [[LOAD_VAR_reshape_MEM_]], [[LOAD_VAR_reshape_2_MEM_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_5_]], [[VAR_reshape_4_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = 96 to 100){
...
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK-DAG:           [[LOAD_VAR_reshape_2_MEM_1_:%.+]] = krnl.load [[VAR_reshape_2_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK:               [[VAR_5_1_:%.+]] = arith.divf [[LOAD_VAR_reshape_MEM_1_]], [[LOAD_VAR_reshape_2_MEM_1_]] : f32
// CHECK:               krnl.store [[VAR_5_1_]], [[VAR_reshape_4_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<10x10xf32>
...
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK-DAG:           [[LOAD_VAR_reshape_2_MEM_:%.+]] = vector.load [[VAR_reshape_2_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK:               [[VAR_5_:%.+]] = arith.subf [[LOAD_VAR_reshape_MEM_]], [[LOAD_VAR_reshape_2_MEM_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_5_]], [[VAR_reshape_4_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = 96 to 100){
...
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK-DAG:           [[LOAD_VAR_reshape_2_MEM_1_:%.+]] = krnl.load [[VAR_reshape_2_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK:               [[VAR_5_1_:%.+]] = arith.subf [[LOAD_VAR_reshape_MEM_1_]], [[LOAD_VAR_reshape_2_MEM_1_]] : f32
// CHECK:               krnl.store [[VAR_5_1_]], [[VAR_reshape_4_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<10x10xf32>
...
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK-DAG:           [[LOAD_VAR_reshape_2_MEM_:%.+]] = vector.load [[VAR_reshape_2_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK:               [[VAR_5_:%.+]] = arith.maxnumf [[LOAD_VAR_reshape_MEM_]], [[LOAD_VAR_reshape_2_MEM_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_5_]], [[VAR_reshape_4_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = 96 to 100){
...
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK-DAG:           [[LOAD_VAR_reshape_2_MEM_1_:%.+]] = krnl.load [[VAR_reshape_2_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK:               [[VAR_5_1_:%.+]] = arith.maxnumf [[LOAD_VAR_reshape_MEM_1_]], [[LOAD_VAR_reshape_2_MEM_1_]] : f32
// CHECK:               krnl.store [[VAR_5_1_]], [[VAR_reshape_4_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<10x10xf32>
...
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK-DAG:           [[LOAD_VAR_reshape_2_MEM_:%.+]] = vector.load [[VAR_reshape_2_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK:               [[VAR_5_:%.+]] = arith.minnumf [[LOAD_VAR_reshape_MEM_]], [[LOAD_VAR_reshape_2_MEM_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_5_]], [[VAR_reshape_4_]]{{.}}[[VAR_2_]]{{.}} : memref<100xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = 96 to 100){
...
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK-DAG:           [[LOAD_VAR_reshape_2_MEM_1_:%.+]] = krnl.load [[VAR_reshape_2_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK:               [[VAR_5_1_:%.+]] = arith.minnumf [[LOAD_VAR_reshape_MEM_1_]], [[LOAD_VAR_reshape_2_MEM_1_]] : f32
// CHECK:               krnl.store [[VAR_5_1_]], [[VAR_reshape_4_]]{{.}}[[VAR_2_1_]]{{.}} : memref<100xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<10x10xf32>
...
// CHECK-DAG:       [[VAR_reshape_3_:%.+]] = memref.reshape [[PARAM_1_]]([[RES_2_]]) : (memref<3x4x5xf32>, memref<1xindex>) -> memref<60xf32>
// CHECK-DAG:       [[RES_3_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK:           affine.store [[CST_60_]], [[RES_3_]][0] : memref<1xindex>
// CHECK:           [[VAR_reshape_5_:%.+]] = memref.reshape [[VAR_view_]]([[RES_3_]]) : (memref<3x4x5xf32>, memref<1xindex>) -> memref<60xf32>
// CHECK:           krnl.iterate() with (){
// CHECK:             [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK:             [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 32 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
// CHECK:             krnl.iterate([[BLOCK_TILE__0_]]) with ([[LOOP_0_]] -> [[I_0_:%.+]] = 0 to 29){
// CHECK:               [[VAR_2_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_2_]]{{.}} : memref<60xf32>, vector<32xf32>
// CHECK-DAG:           [[LOAD_VAR_reshape_3_MEM_:%.+]] = vector.load [[VAR_reshape_3_]]{{.}}[[VAR_2_]]{{.}} : memref<60xf32>, vector<32xf32>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_5_:%.+]] = arith.cmpf olt, [[LOAD_VAR_reshape_MEM_]], [[VAR_cst_]] : vector<32xf32>
// CHECK-DAG:           [[VAR_6_:%.+]] = arith.mulf [[LOAD_VAR_reshape_3_MEM_]], [[LOAD_VAR_reshape_MEM_]] : vector<32xf32>
// CHECK:               [[VAR_7_:%.+]] = arith.select [[VAR_5_]], [[VAR_6_]], [[LOAD_VAR_reshape_MEM_]] : vector<32xi1>, vector<32xf32>
// CHECK:               vector.store [[VAR_7_]], [[VAR_reshape_5_]]{{.}}[[VAR_2_]]{{.}} : memref<60xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = 32 to 60){
// CHECK:               [[VAR_2_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_2_1_]]{{.}} : memref<60xf32>
// CHECK-DAG:           [[LOAD_VAR_reshape_3_MEM_1_:%.+]] = krnl.load [[VAR_reshape_3_]]{{.}}[[VAR_2_1_]]{{.}} : memref<60xf32>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_5_1_:%.+]] = arith.cmpf olt, [[LOAD_VAR_reshape_MEM_1_]], [[CST_0_dot_000000_]] : f32
// CHECK-DAG:           [[VAR_6_1_:%.+]] = arith.mulf [[LOAD_VAR_reshape_3_MEM_1_]], [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK:               [[VAR_7_1_:%.+]] = arith.select [[VAR_5_1_]], [[VAR_6_1_]], [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK:               krnl.store [[VAR_7_1_]], [[VAR_reshape_5_]]{{.}}[[VAR_2_1_]]{{.}} : memref<60xf32>
// CHECK:             }
// CHECK:           }
...
// CHECK-DAG:       [[RES_:%.+]] = memref.alloc() {{.*}}: memref<256xi8>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_view_:%.+]] = memref.view [[RES_]]{{.}}[[CST_0_1_]]{{.}}[] : memref<256xi8> to memref<3x4x5xi32>
// CHECK-DAG:       [[RES_1_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK:           affine.store [[CST_60_]], [[RES_1_]][0] : memref<1xindex>
...
// CHECK-DAG:       [[RES_3_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK:           affine.store [[CST_60_]], [[RES_3_]][0] : memref<1xindex>
// CHECK:           [[VAR_reshape_4_:%.+]] = memref.reshape [[VAR_view_]]([[RES_3_]]) : (memref<3x4x5xi32>, memref<1xindex>) -> memref<60xi32>
// CHECK:           krnl.iterate() with (){
// CHECK:             [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK:             [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 32 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
// CHECK:             krnl.iterate([[BLOCK_TILE__0_]]) with ([[LOOP_0_]] -> [[I_0_:%.+]] = 0 to 29){
// CHECK:               [[VAR_2_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_2_]]{{.}} : memref<60xi32>, vector<32xi32>
// CHECK-DAG:           [[LOAD_VAR_reshape_2_MEM_:%.+]] = vector.load [[VAR_reshape_2_]]{{.}}[[VAR_2_]]{{.}} : memref<60xi32>, vector<32xi32>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_5_:%.+]] = arith.cmpi slt, [[LOAD_VAR_reshape_MEM_]], [[VAR_cst_]] : vector<32xi32>
// CHECK-DAG:           [[VAR_6_:%.+]] = arith.muli [[LOAD_VAR_reshape_2_MEM_]], [[LOAD_VAR_reshape_MEM_]] : vector<32xi32>
// CHECK:               [[VAR_7_:%.+]] = arith.select [[VAR_5_]], [[VAR_6_]], [[LOAD_VAR_reshape_MEM_]] : vector<32xi1>, vector<32xi32>
// CHECK:               vector.store [[VAR_7_]], [[VAR_reshape_4_]]{{.}}[[VAR_2_]]{{.}} : memref<60xi32>, vector<32xi32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = 32 to 60){
// CHECK:               [[VAR_2_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK-DAG:           [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_2_1_]]{{.}} : memref<60xi32>
// CHECK-DAG:           [[LOAD_VAR_reshape_2_MEM_1_:%.+]] = krnl.load [[VAR_reshape_2_]]{{.}}[[VAR_2_1_]]{{.}} : memref<60xi32>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_5_1_:%.+]] = arith.cmpi slt, [[LOAD_VAR_reshape_MEM_1_]], [[CST_0_]] : i32
// CHECK-DAG:           [[VAR_6_1_:%.+]] = arith.muli [[LOAD_VAR_reshape_2_MEM_1_]], [[LOAD_VAR_reshape_MEM_1_]] : i32
// CHECK:               [[VAR_7_1_:%.+]] = arith.select [[VAR_5_1_]], [[VAR_6_1_]], [[LOAD_VAR_reshape_MEM_1_]] : i32
// CHECK:               krnl.store [[VAR_7_1_]], [[VAR_reshape_4_]]{{.}}[[VAR_2_1_]]{{.}} : memref<60xi32>
// CHECK:             }
// CHECK:           }
...
// CHECK:               [[VAR_6_:%.+]] = vector.broadcast [[LOAD_VAR_reshape_2_MEM_]] : f32 to vector<20xf32>
...
// CHECK:               [[VAR_7_:%.+]] = math.erf [[LOAD_VAR_reshape_MEM_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_7_]], [[VAR_reshape_3_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = [[MAP_3_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_0, [[VAR_2_]]{{.}} to [[MAP_4_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_0, [[VAR_2_]]{{.}}){
...
// CHECK:               [[VAR_7_1_:%.+]] = math.erf [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK:               krnl.store [[VAR_7_1_]], [[VAR_reshape_3_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
...
// CHECK:           [[RES_:%.+]] = memref.alloc([[VAR_0_]]) {{.*}}: memref<?xi8>
// CHECK-DAG:       [[VAR_view_:%.+]] = memref.view [[RES_]]{{.}}[[CST_0_]]{{.}}{{.}}[[VAR_dim_]]{{.}} : memref<?xi8> to memref<?x10xf32>
// CHECK-DAG:       [[VAR_dim_3_:%.+]] = memref.dim [[PARAM_0_]], [[CST_0_]] : memref<?x10xf32>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_1_:%.+]] = affine.apply [[MAP_1_]](){{.}}[[VAR_dim_3_]]{{.}}
// CHECK-DAG:       [[RES_1_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK:           affine.store [[VAR_1_]], [[RES_1_]][0] : memref<1xindex>
// CHECK-DAG:       [[VAR_reshape_:%.+]] = memref.reshape [[PARAM_0_]]([[RES_1_]]) : (memref<?x10xf32>, memref<1xindex>) -> memref<?xf32>
// CHECK-DAG:       [[VAR_2_:%.+]] = affine.apply [[MAP_1_]](){{.}}[[VAR_dim_]]{{.}}
// CHECK-DAG:       [[RES_2_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK:           affine.store [[VAR_2_]], [[RES_2_]][0] : memref<1xindex>
// CHECK:           [[VAR_reshape_6_:%.+]] = memref.reshape [[VAR_view_]]([[RES_2_]]) : (memref<?x10xf32>, memref<1xindex>) -> memref<?xf32>
// CHECK:           krnl.iterate() with (){
// CHECK:             [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK:             [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 32 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
...
// CHECK:               [[VAR_5_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK-DAG:           [[VAR_7_:%.+]] = arith.subf [[VAR_cst_0_]], [[LOAD_VAR_reshape_MEM_]] : vector<32xf32>
// CHECK-DAG:           [[VAR_8_:%.+]] = math.exp [[LOAD_VAR_reshape_MEM_]] : vector<32xf32>
// CHECK:               [[VAR_9_:%.+]] = math.exp [[VAR_7_]] : vector<32xf32>
// CHECK:               [[VAR_10_:%.+]] = arith.subf [[VAR_8_]], [[VAR_9_]] : vector<32xf32>
// CHECK:               [[VAR_11_:%.+]] = arith.divf [[VAR_10_]], [[VAR_cst_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_11_]], [[VAR_reshape_6_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = [[MAP_3_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_3, [[VAR_2_]]{{.}} to [[MAP_4_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_3, [[VAR_2_]]{{.}}){
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK-DAG:           [[VAR_7_1_:%.+]] = arith.subf [[CST_0_dot_000000_]], [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK-DAG:           [[VAR_8_1_:%.+]] = math.exp [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK:               [[VAR_9_1_:%.+]] = math.exp [[VAR_7_1_]] : f32
// CHECK:               [[VAR_10_1_:%.+]] = arith.subf [[VAR_8_1_]], [[VAR_9_1_]] : f32
// CHECK:               [[VAR_11_1_:%.+]] = arith.divf [[VAR_10_1_]], [[CST_2_dot_000000_]] : f32
// CHECK:               krnl.store [[VAR_11_1_]], [[VAR_reshape_6_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
// CHECK:         }
...
// CHECK-DAG:           [[VAR_8_:%.+]] = math.exp [[LOAD_VAR_reshape_MEM_]] : vector<32xf32>
// CHECK:               [[VAR_9_:%.+]] = math.exp [[VAR_7_]] : vector<32xf32>
// CHECK:               [[VAR_10_:%.+]] = arith.addf [[VAR_8_]], [[VAR_9_]] : vector<32xf32>
// CHECK:               [[VAR_11_:%.+]] = arith.divf [[VAR_10_]], [[VAR_cst_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_11_]], [[VAR_reshape_6_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
...
// CHECK-DAG:           [[VAR_8_1_:%.+]] = math.exp [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK:               [[VAR_9_1_:%.+]] = math.exp [[VAR_7_1_]] : f32
// CHECK:               [[VAR_10_1_:%.+]] = arith.addf [[VAR_8_1_]], [[VAR_9_1_]] : f32
// CHECK:               [[VAR_11_1_:%.+]] = arith.divf [[VAR_10_1_]], [[CST_2_dot_000000_]] : f32
// CHECK:               krnl.store [[VAR_11_1_]], [[VAR_reshape_6_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
...
// CHECK:               [[VAR_5_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:               [[VAR_7_:%.+]] = arith.subf [[VAR_cst_0_]], [[LOAD_VAR_reshape_MEM_]] : vector<32xf32>
// CHECK:               [[VAR_8_:%.+]] = math.exp [[VAR_7_]] : vector<32xf32>
// CHECK:               [[VAR_9_:%.+]] = arith.addf [[VAR_8_]], [[VAR_cst_]] : vector<32xf32>
// CHECK:               [[VAR_10_:%.+]] = arith.divf [[VAR_cst_]], [[VAR_9_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_10_]], [[VAR_reshape_6_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = [[MAP_3_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_3, [[VAR_2_]]{{.}} to [[MAP_4_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_3, [[VAR_2_]]{{.}}){
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:               [[VAR_7_1_:%.+]] = arith.subf [[CST_0_dot_000000_]], [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK:               [[VAR_8_1_:%.+]] = math.exp [[VAR_7_1_]] : f32
// CHECK:               [[VAR_9_1_:%.+]] = arith.addf [[VAR_8_1_]], [[CST_1_dot_000000_]] : f32
// CHECK:               [[VAR_10_1_:%.+]] = arith.divf [[CST_1_dot_000000_]], [[VAR_9_1_]] : f32
// CHECK:               krnl.store [[VAR_10_1_]], [[VAR_reshape_6_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
// CHECK:         }
...
// CHECK:           [[RES_:%.+]] = memref.alloc([[VAR_0_]]) {{.*}}: memref<?xi8>
// CHECK-DAG:       [[VAR_view_:%.+]] = memref.view [[RES_]]{{.}}[[CST_0_]]{{.}}{{.}}[[VAR_dim_]]{{.}} : memref<?xi8> to memref<?x10xf32>
// CHECK-DAG:       [[VAR_dim_5_:%.+]] = memref.dim [[PARAM_0_]], [[CST_0_]] : memref<?x10xf32>
// CHECK-NOT: separator of consecutive DAGs
...
// CHECK-DAG:       [[RES_2_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK:           affine.store [[VAR_2_]], [[RES_2_]][0] : memref<1xindex>
// CHECK:           [[VAR_reshape_8_:%.+]] = memref.reshape [[VAR_view_]]([[RES_2_]]) : (memref<?x10xf32>, memref<1xindex>) -> memref<?xf32>
// CHECK:           krnl.iterate() with (){
// CHECK:             [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK:             [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 32 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
// CHECK:             krnl.iterate([[BLOCK_TILE__0_]]) with ([[LOOP_0_]] -> [[I_0_:%.+]] = 0 to [[MAP_2_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_5, [[VAR_2_]]{{.}}){
// CHECK:               [[VAR_5_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK-DAG:           [[VAR_7_:%.+]] = math.exp [[LOAD_VAR_reshape_MEM_]] : vector<32xf32>
// CHECK-DAG:           [[VAR_8_:%.+]] = arith.cmpf olt, [[LOAD_VAR_reshape_MEM_]], [[VAR_cst_1_]] : vector<32xf32>
// CHECK:               [[VAR_9_:%.+]] = arith.subf [[VAR_7_]], [[VAR_cst_0_]] : vector<32xf32>
// CHECK:               [[VAR_10_:%.+]] = arith.mulf [[VAR_9_]], [[VAR_cst_]] : vector<32xf32>
// CHECK:               [[VAR_11_:%.+]] = arith.select [[VAR_8_]], [[VAR_10_]], [[LOAD_VAR_reshape_MEM_]] : vector<32xi1>, vector<32xf32>
// CHECK:               vector.store [[VAR_11_]], [[VAR_reshape_8_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = [[MAP_3_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_5, [[VAR_2_]]{{.}} to [[MAP_4_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_5, [[VAR_2_]]{{.}}){
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK-DAG:           [[VAR_7_1_:%.+]] = math.exp [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK-DAG:           [[VAR_8_1_:%.+]] = arith.cmpf olt, [[LOAD_VAR_reshape_MEM_1_]], [[CST_0_dot_000000_]] : f32
// CHECK:               [[VAR_9_1_:%.+]] = arith.subf [[VAR_7_1_]], [[CST_1_dot_000000_]] : f32
// CHECK:               [[VAR_10_1_:%.+]] = arith.mulf [[VAR_9_1_]], [[CST_2_dot_000000_]] : f32
// CHECK:               [[VAR_11_1_:%.+]] = arith.select [[VAR_8_1_]], [[VAR_10_1_]], [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK:               krnl.store [[VAR_11_1_]], [[VAR_reshape_8_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
// CHECK:         }
...
// CHECK:               [[VAR_5_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:               vector.store [[LOAD_VAR_reshape_MEM_]], [[VAR_reshape_3_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = [[MAP_3_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_0, [[VAR_2_]]{{.}} to [[MAP_4_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_0, [[VAR_2_]]{{.}}){
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:               krnl.store [[LOAD_VAR_reshape_MEM_1_]], [[VAR_reshape_3_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
// CHECK:         }
...
// CHECK:               [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK-DAG:           [[VAR_7_:%.+]] = math.exp [[LOAD_VAR_reshape_MEM_]] : vector<32xf32>
// CHECK-DAG:           [[VAR_8_:%.+]] = arith.cmpf ogt, [[LOAD_VAR_reshape_MEM_]], [[VAR_cst_1_]] : vector<32xf32>
// CHECK:               [[VAR_9_:%.+]] = arith.subf [[VAR_7_]], [[VAR_cst_0_]] : vector<32xf32>
// CHECK:               [[VAR_10_:%.+]] = arith.select [[VAR_8_]], [[LOAD_VAR_reshape_MEM_]], [[VAR_9_]] : vector<32xi1>, vector<32xf32>
// CHECK:               [[VAR_11_:%.+]] = arith.mulf [[VAR_10_]], [[VAR_cst_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_11_]], [[VAR_reshape_8_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = [[MAP_3_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_5, [[VAR_2_]]{{.}} to [[MAP_4_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_5, [[VAR_2_]]{{.}}){
...
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK-DAG:           [[VAR_7_1_:%.+]] = math.exp [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK-DAG:           [[VAR_8_1_:%.+]] = arith.cmpf ogt, [[LOAD_VAR_reshape_MEM_1_]], [[CST_0_dot_000000_]] : f32
// CHECK:               [[VAR_9_1_:%.+]] = arith.subf [[VAR_7_1_]], [[CST_1_dot_000000_]] : f32
// CHECK:               [[VAR_10_1_:%.+]] = arith.select [[VAR_8_1_]], [[LOAD_VAR_reshape_MEM_1_]], [[VAR_9_1_]] : f32
// CHECK:               [[VAR_11_1_:%.+]] = arith.mulf [[VAR_10_1_]], [[CST_2_dot_000000_]] : f32
// CHECK:               krnl.store [[VAR_11_1_]], [[VAR_reshape_8_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
...
// CHECK:               [[VAR_5_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:               [[VAR_7_:%.+]] = arith.cmpf ogt, [[LOAD_VAR_reshape_MEM_]], [[VAR_cst_]] : vector<32xf32>
// CHECK:               [[VAR_8_:%.+]] = arith.select [[VAR_7_]], [[LOAD_VAR_reshape_MEM_]], [[VAR_cst_0_]] : vector<32xi1>, vector<32xf32>
// CHECK:               vector.store [[VAR_8_]], [[VAR_reshape_6_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = [[MAP_3_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_3, [[VAR_2_]]{{.}} to [[MAP_4_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_3, [[VAR_2_]]{{.}}){
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:               [[VAR_7_1_:%.+]] = arith.cmpf ogt, [[LOAD_VAR_reshape_MEM_1_]], [[CST_1_dot_000000_]] : f32
// CHECK:               [[VAR_8_1_:%.+]] = arith.select [[VAR_7_1_]], [[LOAD_VAR_reshape_MEM_1_]], [[CST_0_dot_000000_]] : f32
// CHECK:               krnl.store [[VAR_8_1_]], [[VAR_reshape_6_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
// CHECK:         }
...
// CHECK:               [[VAR_5_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:               [[VAR_7_:%.+]] = arith.addf [[LOAD_VAR_reshape_MEM_]], [[VAR_cst_]] : vector<32xf32>
// CHECK:               [[VAR_8_:%.+]] = arith.maxnumf [[VAR_7_]], [[VAR_cst_1_]] : vector<32xf32>
// CHECK:               [[VAR_9_:%.+]] = arith.minnumf [[VAR_8_]], [[VAR_cst_0_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_9_]], [[VAR_reshape_8_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = [[MAP_3_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_5, [[VAR_2_]]{{.}} to [[MAP_4_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_5, [[VAR_2_]]{{.}}){
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:               [[VAR_7_1_:%.+]] = arith.addf [[LOAD_VAR_reshape_MEM_1_]], [[CST_2_dot_000000_]] : f32
// CHECK:               [[VAR_8_1_:%.+]] = arith.maxnumf [[VAR_7_1_]], [[CST_0_dot_000000_]] : f32
// CHECK:               [[VAR_9_1_:%.+]] = arith.minnumf [[VAR_8_1_]], [[CST_1_dot_000000_]] : f32
// CHECK:               krnl.store [[VAR_9_1_]], [[VAR_reshape_8_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
// CHECK:         }
...
// CHECK-DAG:       [[CST_0_dot_166666672_:%.+]] = arith.constant 0.166666672 : f32
// CHECK-DAG:       [[CST_1_dot_000000_:%.+]] = arith.constant 1.000000e+00 : f32
// CHECK-DAG:       [[CST_0_dot_000000_:%.+]] = arith.constant 0.000000e+00 : f32
// CHECK-DAG:       [[CST_0_:%.+]] = arith.constant 0 : index
// CHECK:           [[VAR_dim_:%.+]] = memref.dim [[PARAM_0_]], [[CST_0_]] : memref<?x10xf32>
...
// CHECK:           [[RES_:%.+]] = memref.alloc([[VAR_0_]]) {{.*}}: memref<?xi8>
// CHECK-DAG:       [[VAR_view_:%.+]] = memref.view [[RES_]]{{.}}[[CST_0_]]{{.}}{{.}}[[VAR_dim_]]{{.}} : memref<?xi8> to memref<?x10xf32>
// CHECK-DAG:       [[VAR_dim_7_:%.+]] = memref.dim [[PARAM_0_]], [[CST_0_]] : memref<?x10xf32>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_1_:%.+]] = affine.apply [[MAP_1_]](){{.}}[[VAR_dim_7_]]{{.}}
// CHECK-DAG:       [[RES_1_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK:           affine.store [[VAR_1_]], [[RES_1_]][0] : memref<1xindex>
// CHECK-DAG:       [[VAR_reshape_:%.+]] = memref.reshape [[PARAM_0_]]([[RES_1_]]) : (memref<?x10xf32>, memref<1xindex>) -> memref<?xf32>
// CHECK-DAG:       [[VAR_2_:%.+]] = affine.apply [[MAP_1_]](){{.}}[[VAR_dim_]]{{.}}
// CHECK-DAG:       [[RES_2_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK:           affine.store [[VAR_2_]], [[RES_2_]][0] : memref<1xindex>
// CHECK:           [[VAR_reshape_10_:%.+]] = memref.reshape [[VAR_view_]]([[RES_2_]]) : (memref<?x10xf32>, memref<1xindex>) -> memref<?xf32>
// CHECK:           krnl.iterate() with (){
// CHECK:             [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK:             [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 32 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
// CHECK:             krnl.iterate([[BLOCK_TILE__0_]]) with ([[LOOP_0_]] -> [[I_0_:%.+]] = 0 to [[MAP_2_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_7, [[VAR_2_]]{{.}}){
// CHECK:               [[VAR_5_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:               [[VAR_7_:%.+]] = arith.mulf [[LOAD_VAR_reshape_MEM_]], [[VAR_cst_0_]] : vector<32xf32>
// CHECK:               [[VAR_8_:%.+]] = arith.addf [[VAR_7_]], [[VAR_cst_]] : vector<32xf32>
// CHECK:               [[VAR_9_:%.+]] = arith.minnumf [[VAR_8_]], [[VAR_cst_1_]] : vector<32xf32>
// CHECK:               [[VAR_10_:%.+]] = arith.maxnumf [[VAR_9_]], [[VAR_cst_2_]] : vector<32xf32>
// CHECK:               [[VAR_11_:%.+]] = arith.mulf [[LOAD_VAR_reshape_MEM_]], [[VAR_10_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_11_]], [[VAR_reshape_10_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = [[MAP_3_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_7, [[VAR_2_]]{{.}} to [[MAP_4_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_7, [[VAR_2_]]{{.}}){
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:               [[VAR_7_1_:%.+]] = arith.mulf [[LOAD_VAR_reshape_MEM_1_]], [[CST_0_dot_166666672_]] : f32
// CHECK:               [[VAR_8_1_:%.+]] = arith.addf [[VAR_7_1_]], [[CST_5_dot_000000_]] : f32
// CHECK:               [[VAR_9_1_:%.+]] = arith.minnumf [[VAR_8_1_]], [[CST_1_dot_000000_]] : f32
// CHECK:               [[VAR_10_1_:%.+]] = arith.maxnumf [[VAR_9_1_]], [[CST_0_dot_000000_]] : f32
// CHECK:               [[VAR_11_1_:%.+]] = arith.mulf [[LOAD_VAR_reshape_MEM_1_]], [[VAR_10_1_]] : f32
// CHECK:               krnl.store [[VAR_11_1_]], [[VAR_reshape_10_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
// CHECK:         }
...
// CHECK:               [[VAR_5_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:               [[VAR_7_:%.+]] = arith.divf [[VAR_cst_]], [[LOAD_VAR_reshape_MEM_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_7_]], [[VAR_reshape_4_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = [[MAP_3_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_1, [[VAR_2_]]{{.}} to [[MAP_4_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_1, [[VAR_2_]]{{.}}){
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:               [[VAR_7_1_:%.+]] = arith.divf [[CST_1_dot_000000_]], [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK:               krnl.store [[VAR_7_1_]], [[VAR_reshape_4_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
...
// CHECK:               [[VAR_5_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:               [[VAR_7_:%.+]] = math.exp [[LOAD_VAR_reshape_MEM_]] : vector<32xf32>
// CHECK:               [[VAR_8_:%.+]] = arith.addf [[VAR_7_]], [[VAR_cst_]] : vector<32xf32>
// CHECK:               [[VAR_9_:%.+]] = math.log [[VAR_8_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_9_]], [[VAR_reshape_4_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = [[MAP_3_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_1, [[VAR_2_]]{{.}} to [[MAP_4_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_1, [[VAR_2_]]{{.}}){
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:               [[VAR_7_1_:%.+]] = math.exp [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK:               [[VAR_8_1_:%.+]] = arith.addf [[VAR_7_1_]], [[CST_1_dot_000000_]] : f32
// CHECK:               [[VAR_9_1_:%.+]] = math.log [[VAR_8_1_]] : f32
// CHECK:               krnl.store [[VAR_9_1_]], [[VAR_reshape_4_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
// CHECK:         }
...
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:               [[VAR_7_1_:%.+]] = math.sqrt [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK:               krnl.store [[VAR_7_1_]], [[VAR_reshape_3_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
...
// CHECK:               [[VAR_5_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:               [[VAR_7_:%.+]] = arith.cmpf ogt, [[LOAD_VAR_reshape_MEM_]], [[VAR_cst_1_]] : vector<32xf32>
// CHECK-DAG:           [[VAR_8_:%.+]] = arith.select [[VAR_7_]], [[VAR_cst_0_]], [[VAR_cst_]] : vector<32xi1>, vector<32xf32>
// CHECK-DAG:           [[VAR_9_:%.+]] = arith.cmpf oeq, [[LOAD_VAR_reshape_MEM_]], [[VAR_cst_1_]] : vector<32xf32>
// CHECK:               [[VAR_10_:%.+]] = arith.select [[VAR_9_]], [[VAR_cst_1_]], [[VAR_8_]] : vector<32xi1>, vector<32xf32>
// CHECK:               vector.store [[VAR_10_]], [[VAR_reshape_8_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<32xf32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = [[MAP_3_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_5, [[VAR_2_]]{{.}} to [[MAP_4_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_5, [[VAR_2_]]{{.}}){
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:               [[VAR_7_1_:%.+]] = arith.cmpf ogt, [[LOAD_VAR_reshape_MEM_1_]], [[CST_0_dot_000000_]] : f32
// CHECK-DAG:           [[VAR_8_1_:%.+]] = arith.select [[VAR_7_1_]], [[CST_1_dot_000000_]], [[CST_minus_1_dot_000000_]] : f32
// CHECK-DAG:           [[VAR_9_1_:%.+]] = arith.cmpf oeq, [[LOAD_VAR_reshape_MEM_1_]], [[CST_0_dot_000000_]] : f32
// CHECK:               [[VAR_10_1_:%.+]] = arith.select [[VAR_9_1_]], [[CST_0_dot_000000_]], [[VAR_8_1_]] : f32
// CHECK:               krnl.store [[VAR_10_1_]], [[VAR_reshape_8_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
// CHECK:         }
...
// CHECK-DAG:       [[VAR_dim_2_:%.+]] = memref.dim [[PARAM_0_]], [[CST_0_1_]] : memref<?x10xi32>
// CHECK-NOT: separator of consecutive DAGs
...
// CHECK:               [[VAR_7_:%.+]] = arith.cmpi sgt, [[LOAD_VAR_reshape_MEM_]], [[VAR_cst_1_]] : vector<32xi32>
// CHECK-DAG:           [[VAR_8_:%.+]] = arith.select [[VAR_7_]], [[VAR_cst_0_]], [[VAR_cst_]] : vector<32xi1>, vector<32xi32>
// CHECK-DAG:           [[VAR_9_:%.+]] = arith.cmpi eq, [[LOAD_VAR_reshape_MEM_]], [[VAR_cst_1_]] : vector<32xi32>
// CHECK:               [[VAR_10_:%.+]] = arith.select [[VAR_9_]], [[VAR_cst_1_]], [[VAR_8_]] : vector<32xi1>, vector<32xi32>
// CHECK:               vector.store [[VAR_10_]], [[VAR_reshape_5_]]{{.}}[[VAR_5_]]{{.}} : memref<?xi32>, vector<32xi32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = [[MAP_3_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_2, [[VAR_2_]]{{.}} to [[MAP_4_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_2, [[VAR_2_]]{{.}}){
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xi32>
// CHECK:               [[VAR_7_1_:%.+]] = arith.cmpi sgt, [[LOAD_VAR_reshape_MEM_1_]], [[CST_0_]] : i32
// CHECK-DAG:           [[VAR_8_1_:%.+]] = arith.select [[VAR_7_1_]], [[CST_1_]], [[CST_minus_1_]] : i32
// CHECK-DAG:           [[VAR_9_1_:%.+]] = arith.cmpi eq, [[LOAD_VAR_reshape_MEM_1_]], [[CST_0_]] : i32
// CHECK:               [[VAR_10_1_:%.+]] = arith.select [[VAR_9_1_]], [[CST_0_]], [[VAR_8_1_]] : i32
// CHECK:               krnl.store [[VAR_10_1_]], [[VAR_reshape_5_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xi32>
// CHECK:             }
// CHECK:           }
...
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:               [[VAR_7_1_:%.+]] = math.absf [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK:               krnl.store [[VAR_7_1_]], [[VAR_reshape_3_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
...
// CHECK:               vector.store [[VAR_7_]], [[VAR_reshape_3_]]{{.}}[[VAR_5_]]{{.}} : memref<?xi32>, vector<32xi32>
// CHECK:             }
// CHECK:             [[LOOP_1_:%.+]] = krnl.define_loops 1
// CHECK:             krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_1_:%.+]] = [[MAP_3_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_0, [[VAR_2_]]{{.}} to [[MAP_4_]](){{.}}[[VAR_dim_]], [[VAR_dim_]]_0, [[VAR_2_]]{{.}}){
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xi32>
// CHECK:               [[VAR_7_1_:%.+]] = math.absi [[LOAD_VAR_reshape_MEM_1_]] : i32
// CHECK:               krnl.store [[VAR_7_1_]], [[VAR_reshape_3_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xi32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xi32>
// CHECK:         }
...
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:               [[VAR_7_1_:%.+]] = math.floor [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK:               krnl.store [[VAR_7_1_]], [[VAR_reshape_3_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
...
// CHECK:               [[VAR_5_1_:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = krnl.load [[VAR_reshape_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:               [[VAR_7_1_:%.+]] = math.ceil [[LOAD_VAR_reshape_MEM_1_]] : f32
// CHECK:               krnl.store [[VAR_7_1_]], [[VAR_reshape_3_]]{{.}}[[VAR_5_1_]]{{.}} : memref<?xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
...
// CHECK:               [[VAR_5_:%.+]] = vector.broadcast [[LOAD_PARAM_1_MEM_]] : f32 to vector<32xf32>
// CHECK-DAG:           [[VAR_6_:%.+]] = arith.maxnumf [[VAR_5_]], [[LOAD_PARAM_0_MEM_]] : vector<32xf32>
// CHECK-DAG:           [[VAR_7_:%.+]] = vector.broadcast [[LOAD_PARAM_2_MEM_]] : f32 to vector<32xf32>
// CHECK:               [[VAR_8_:%.+]] = arith.minnumf [[VAR_7_]], [[VAR_6_]] : vector<32xf32>
...
// CHECK-DAG:           [[LOAD_PARAM_0_MEM_:%.+]] = vector.load [[PARAM_0_]]{{.}}[[VAR_1_]]{{.}} : memref<128xf32>, vector<32xf32>
// CHECK-DAG:           [[LOAD_PARAM_2_MEM_:%.+]] = krnl.load [[PARAM_2_]][] : memref<f32>
// CHECK:               [[VAR_4_:%.+]] = vector.broadcast [[LOAD_PARAM_2_MEM_]] : f32 to vector<32xf32>
...
// CHECK:           [[RES_:%.+]] = memref.alloc() {{.*}}: memref<128xi32>
// CHECK:           krnl.iterate() with (){
// CHECK:             [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK:             [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 32 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
// CHECK:             krnl.iterate([[BLOCK_TILE__0_]]) with ([[LOOP_0_]] -> [[I_0_:%.+]] = 0 to 128){
...
// CHECK:               [[VAR_4_:%.+]] = vector.broadcast [[LOAD_PARAM_2_MEM_]] : i32 to vector<32xi32>
...
// CHECK-DAG:       [[VAR_cst_:%.+]] = arith.constant dense<-2.000000e+00> : vector<32xf32>
// CHECK-DAG:       [[VAR_cst_0_:%.+]] = arith.constant dense<2.000000e+00> : vector<32xf32>
// CHECK-DAG:       [[VAR_cst_1_:%.+]] = arith.constant dense<1.000000e+00> : vector<32xf32>
// CHECK-DAG:       [[VAR_cst_2_:%.+]] = arith.constant dense<0.000000e+00> : vector<32xf32>
...
// CHECK:             krnl.iterate([[BLOCK_TILE__0_]]) with ([[LOOP_0_]] -> [[I_0_:%.+]] = 0 to 512){
// CHECK:               [[VAR_1_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_PARAM_0_MEM_:%.+]] = vector.load [[PARAM_0_]]{{.}}[[VAR_1_]]{{.}} : memref<512xf32>, vector<32xf32>
// CHECK-DAG:           [[VAR_3_:%.+]] = arith.cmpf olt, [[LOAD_PARAM_0_MEM_]], [[VAR_cst_]] : vector<32xf32>
// CHECK-DAG:           [[VAR_4_:%.+]] = arith.cmpf ogt, [[LOAD_PARAM_0_MEM_]], [[VAR_cst_0_]] : vector<32xf32>
// CHECK-DAG:           [[VAR_5_:%.+]] = arith.subf [[LOAD_PARAM_0_MEM_]], [[VAR_cst_1_]] : vector<32xf32>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_6_:%.+]] = arith.select [[VAR_4_]], [[VAR_5_]], [[VAR_cst_2_]] : vector<32xi1>, vector<32xf32>
// CHECK-DAG:           [[VAR_7_:%.+]] = arith.addf [[LOAD_PARAM_0_MEM_]], [[VAR_cst_1_]] : vector<32xf32>
// CHECK:               [[VAR_8_:%.+]] = arith.select [[VAR_3_]], [[VAR_7_]], [[VAR_6_]] : vector<32xi1>, vector<32xf32>
// CHECK:               vector.store [[VAR_8_]], [[RES_]]{{.}}[[VAR_1_]]{{.}} : memref<512xf32>, vector<32xf32>
// CHECK:             }
// CHECK:           }
...
// CHECK-DAG:       [[VAR_cst_:%.+]] = arith.constant dense<1.000000e+00> : vector<32xf32>
// CHECK-DAG:       [[CST_8192_:%.+]] = arith.constant 8192 : index
// CHECK-DAG:       [[RES_:%.+]] = memref.alloc() {{.*}}: memref<64x128xf32>
// CHECK-DAG:       [[RES_1_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK:           affine.store [[CST_8192_]], [[RES_1_]][0] : memref<1xindex>
// CHECK-DAG:       [[VAR_reshape_:%.+]] = memref.reshape [[PARAM_0_]]([[RES_1_]]) : (memref<64x128xf32>, memref<1xindex>) -> memref<8192xf32>
// CHECK-DAG:       [[RES_2_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK:           affine.store [[CST_8192_]], [[RES_2_]][0] : memref<1xindex>
// CHECK:           [[VAR_reshape_2_:%.+]] = memref.reshape [[RES_]]([[RES_]]_1) : (memref<64x128xf32>, memref<1xindex>) -> memref<8192xf32>
// CHECK:           krnl.iterate() with (){
// CHECK:             [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK:             [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 32 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
// CHECK:             krnl.iterate([[BLOCK_TILE__0_]]) with ([[LOOP_0_]] -> [[I_0_:%.+]] = 0 to 8192){
// CHECK:               [[VAR_1_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK:               [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_1_]]{{.}} : memref<8192xf32>, vector<32xf32>
// CHECK:               [[VAR_3_:%.+]] = math.exp [[LOAD_VAR_reshape_MEM_]] : vector<32xf32>
// CHECK:               [[VAR_4_:%.+]] = arith.addf [[VAR_3_]], [[VAR_cst_]] : vector<32xf32>
// CHECK:               [[VAR_5_:%.+]] = math.log [[VAR_4_]] : vector<32xf32>
// CHECK:               [[VAR_6_:%.+]] = math.tanh [[VAR_5_]] : vector<32xf32>
// CHECK:               [[VAR_7_:%.+]] = arith.mulf [[LOAD_VAR_reshape_MEM_]], [[VAR_6_]] : vector<32xf32>
// CHECK:               vector.store [[VAR_7_]], [[VAR_reshape_2_]]{{.}}[[VAR_1_]]{{.}} : memref<8192xf32>, vector<32xf32>
// CHECK:             }
// CHECK:           }
