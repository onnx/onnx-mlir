...
// CHECK-DAG:       [[RES_1_:%.+]] = memref.alloc() {{.*}}: memref<1x20xf32>
// CHECK:           krnl.memset [[RES_1_]], [[CST_0_dot_000000_]] : memref<1x20xf32>
...
// CHECK-DAG:         [[VAR_3_:%.+]] = arith.mulf [[LOAD_PARAM_0_MEM_]], [[LOAD_PARAM_0_MEM_]] : f32
// CHECK-DAG:         [[LOAD_RES_1_MEM_:%.+]] = krnl.load [[RES_1_]]{{.}}[[CST_0_]], [[VAR_1_]]#1] : memref<1x20xf32>
// CHECK:             [[VAR_5_:%.+]] = arith.addf [[LOAD_RES_1_MEM_]], [[VAR_3_]] : f32
// CHECK:             krnl.store [[VAR_5_]], [[RES_1_]]{{.}}[[CST_0_]], [[VAR_1_]]#1] : memref<1x20xf32>
// CHECK:           }
...
// CHECK-DAG:         [[LOAD_RES_1_MEM_1_:%.+]] = krnl.load [[RES_1_]]{{.}}[[CST_0_]], [[VAR_1_1_]]#1] : memref<1x20xf32>
// CHECK:             [[LOAD_RES_1_MEM_2_:%.+]] = math.sqrt [[LOAD_RES_1_MEM_1_]] : f32
// CHECK:             [[VAR_5_1_:%.+]] = arith.divf [[LOAD_PARAM_0_MEM_1_]], [[LOAD_RES_1_MEM_2_]] : f32
// CHECK:             krnl.store [[VAR_5_1_]], [[RES_]]{{.}}[[VAR_1_1_]]#0, [[VAR_1_1_]]#1] : memref<10x20xf32>
// CHECK:           }
