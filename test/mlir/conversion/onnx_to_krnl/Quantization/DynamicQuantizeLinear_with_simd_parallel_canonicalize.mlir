...
// CHECK-DAG:       [[RES_4_:%.+]] = memref.alloc() alignment = 16 : memref<256xf32>
// CHECK-DAG:       [[RES_5_:%.+]] = memref.alloc() : memref<8xf32>
// CHECK-DAG:       [[RES_6_:%.+]] = memref.alloc() alignment = 16 : memref<256xf32>
...
// CHECK:           [[RES_10_:%.+]] = memref.alloc() alignment = 16 : memref<1xindex>
...
// CHECK-DAG:       [[RES_11_:%.+]] = memref.alloc() alignment = 16 : memref<1xindex>
