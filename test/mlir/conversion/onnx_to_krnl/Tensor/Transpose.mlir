...
// CHECK-DAG:         [[VAR_2_:%.+]]:5 = krnl.get_induction_var_value([[LOOP_0_]]#0, [[LOOP_0_]]#1, [[LOOP_0_]]#2, [[BLOCK_TILE__0_]], [[BLOCK_IN__0_]]) : (!krnl.loop, !krnl.loop, !krnl.loop, !krnl.loop, !krnl.loop) -> (index, index, index, index, index)
...
// CHECK-DAG:         [[VAR_2_1_:%.+]]:5 = krnl.get_induction_var_value([[LOOP_1_]]#0, [[LOOP_1_]]#1, [[LOOP_1_]]#2, [[BLOCK_TILE__1_]], [[BLOCK_IN__1_]]) : (!krnl.loop, !krnl.loop, !krnl.loop, !krnl.loop, !krnl.loop) -> (index, index, index, index, index)
...
// CHECK-DAG:         [[VAR_1_:%.+]]:5 = krnl.get_induction_var_value([[LOOP_0_]]#0, [[LOOP_0_]]#1, [[LOOP_0_]]#2, [[BLOCK_TILE__0_]], [[BLOCK_IN__0_]]) : (!krnl.loop, !krnl.loop, !krnl.loop, !krnl.loop, !krnl.loop) -> (index, index, index, index, index)
