...
// CHECK-DAG:                 [[LOAD_C_MEM_:%.+]] = affine.vector_load [[C_]]{{.}}[[I_3_]], 0{{.}} : memref<4x8xf32>, vector<8xf32>
...
// CHECK-DAG:                   [[LOAD_B_MEM_:%.+]] = affine.vector_load [[B_]]{{.}}[[I_4_]], 0{{.}} : memref<6x8xf32>, vector<8xf32>
...
// CHECK:                     affine.vector_store [[LOAD_RES_MEM_1_]], [[C_]]{{.}}[[I_3_]], 0{{.}} : memref<4x8xf32>, vector<8xf32>
// CHECK:                   }
// CHECK:                 }
// CHECK:               }
// CHECK:             }
...
// CHECK-DAG: #map1 = affine_map<()[s0, s1] -> (s0 - s1, 6)>
...
// CHECK:                   affine.for [[I_3_:%.+]] = 0 to 4 {
// CHECK-DAG:                 [[RES_:%.+]] = memref.alloca() : memref<vector<8xf32>>
// CHECK:                     [[LOAD_C_MEM_:%.+]] = affine.vector_load
// CHECK-SAME:                [[C_]]{{.}}[[I_3_]] + symbol([[PARAM_0_]]), symbol([[PARAM_1_]]){{.}} : memref<4x8xf32>, vector<8xf32>
// CHECK:                     affine.store [[LOAD_C_MEM_]], [[RES_]][] : memref<vector<8xf32>>
// CHECK:                     affine.for [[I_4_:%.+]] = 0 to 6 {
...
// CHECK-DAG:                   [[LOAD_B_MEM_:%.+]] = affine.vector_load
// CHECK-SAME:                  [[B_]]{{.}}[[I_4_]] + symbol([[PARAM_2_]]), symbol([[PARAM_1_]]){{.}} : memref<6x8xf32>, vector<8xf32>
// CHECK-DAG:                   [[LOAD_RES_MEM_:%.+]] = affine.load [[RES_]][] : memref<vector<8xf32>>
...
// CHECK-SAME:                [[LOAD_RES_MEM_1_]], [[C_]]{{.}}[[I_3_]] + symbol([[PARAM_0_]]), symbol([[PARAM_1_]]){{.}} : memref<4x8xf32>, vector<8xf32>
// CHECK:                   }
// CHECK:                 } else {
...
// CHECK:                       [[LOAD_C_MEM_1_:%.+]] = affine.vector_load
// CHECK-SAME:                  [[C_]]{{.}}[[I_5_]] + symbol([[PARAM_0_]]), symbol([[PARAM_1_]]){{.}} : memref<4x8xf32>, vector<8xf32>
...
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:                     [[LOAD_B_MEM_1_:%.+]] = affine.vector_load
// CHECK-SAME:                    [[B_]]{{.}}[[I_6_]] + symbol([[PARAM_2_]]), symbol([[PARAM_1_]]){{.}} : memref<6x8xf32>, vector<8xf32>
...
// CHECK:                       affine.vector_store
// CHECK-SAME:                  [[LOAD_RES_MEM_1_]], [[C_]]{{.}}[[I_5_]] + symbol([[PARAM_0_]]), symbol([[PARAM_1_]]){{.}} : memref<4x8xf32>, vector<8xf32>
// CHECK:                     }
// CHECK:                   } else {
