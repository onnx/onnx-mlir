...
// CHECK:       "tosa.const"() <{values = dense<1.000000e+00> : tensor<3xf32>}> : () -> tensor<3xf32>
}
...
// CHECK:       "tosa.const"() <{values = dense<[0.000000e+00, 1.000000e+00, 2.000000e+00]> : tensor<3xf32>}> : () -> tensor<3xf32>
}
...
// CHECK:      "tosa.const"() <{values = dense<3> : tensor<1xi8>}> : () -> tensor<1xi8>
}
...
// CHECK:       "tosa.const"() <{values = dense<3> : tensor<4xi32>}> : () -> tensor<4xi32>
}
...
// CHECK:       "tosa.const"() <{values = dense<[-1, -2]> : tensor<2xi8>}> : () -> tensor<2xi8>
}
...
// CHECK:      "tosa.const"() <{values = dense<true> : tensor<i1>}> : () -> tensor<i1>
}
...
// CHECK:       "tosa.const"() <{values = dense<false> : tensor<4xi1>}> : () -> tensor<4xi1>
}
...
// CHECK:       "tosa.const"() <{values = dense<[true, false]> : tensor<2xi1>}> : () -> tensor<2xi1>
}
