...
// CHECK:           [[SHAPE:%.+]] = tosa.const_shape {values = dense<[1, 128, 16, 64]> : tensor<4xindex>} : () -> !tosa.shape<4>
...
// CHECK:           [[SHAPE:%.+]] = tosa.const_shape {values = dense<[12, 128, 16, 64]> : tensor<4xindex>} : () -> !tosa.shape<4>
