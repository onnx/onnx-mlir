...
// CHECK:           %[[VAL_1:.*]] = "tosa.reshape"(%[[VAL_0]]) {new_shape = [1, 10, 10, 1]} : (tensor<10x10xf32>) -> tensor<1x10x10x1xf32>
...
// CHECK:           %[[VAL_1:.*]] = "tosa.reshape"(%[[VAL_0]]) {new_shape = [16, 32, 1, 64]} : (tensor<16x32x64xf32>) -> tensor<16x32x1x64xf32>
...
// CHECK:           %[[VAL_1:.*]] = "tosa.reshape"(%[[VAL_0]]) {new_shape = [16, 1, 32, 1, 64]} : (tensor<16x32x64xf32>) -> tensor<16x1x32x1x64xf32>
