...
func.func @test_resize_constant_size_disallowed(%arg0: tensor<1x1x2x4xf32>, %arg1: tensor<4xi64>, %arg2: tensor<4xi64>) -> tensor<1x1x2x8xf32> {
    %0 = "onnx.NoValue"() {value} : () -> none
    %2 = "onnx.Add"(%arg1, %arg2) {onnx_node_name = "/Sub-Initializer_/Add"} : (tensor<4xi64>, tensor<4xi64>) -> tensor<4xi64> 
    %3 = "onnx.Resize"(%arg0, %0, %0, %2) {antialias = 0 : si64, coordinate_transformation_mode = "half_pixel", cubic_coeff_a = -7.500000e-01 : f32, exclude_outside = 0 : si64, extrapolation_value = 0.000000e+00 : f32, keep_aspect_ratio_policy = "stretch", mode = "linear", nearest_mode = "floor",
      onnx_node_name = "/Resize_17"} : (tensor<1x1x2x4xf32>, none, none, tensor<4xi64>) -> tensor<1x1x2x8xf32>
    return %3 : tensor<1x1x2x8xf32>
// CHECK-LABEL:  func.func @test_resize_constant_size_disallowed
// CHECK-LABEL:  onnx.Resize
}
...
func.func @test_resize_constant_size_allowed(%arg0: tensor<1x1x2x4xf32>, %arg1: tensor<4xi64>, %arg2: tensor<4xi64>) -> tensor<1x1x2x8xf32> {
    %0 = "onnx.NoValue"() {value} : () -> none
    %1 = "onnx.Constant"() {value = dense_resource<__elided__> : tensor<4xi64>} : () -> tensor<4xi64>
    %3 = "onnx.Resize"(%arg0, %0, %0, %1 ) {antialias = 0 : si64, coordinate_transformation_mode = "half_pixel", cubic_coeff_a = -7.500000e-01 : f32, exclude_outside = 0 : si64, extrapolation_value = 0.000000e+00 : f32, keep_aspect_ratio_policy = "stretch", mode = "linear", nearest_mode = "floor",
      onnx_node_name = "/Resize_17"} : (tensor<1x1x2x4xf32>, none, none, tensor<4xi64>) -> tensor<1x1x2x8xf32>
    return %3 : tensor<1x1x2x8xf32>
// CHECK-LABEL:  func.func @test_resize_constant_size_allowed
// CHECK-NOT:  onnx.Resize
}
