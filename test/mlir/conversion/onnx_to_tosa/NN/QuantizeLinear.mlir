...
// CHECK-DAG:    %[[MUL:.*]] = tosa.mul %[[ARG_0]], %[[REC]] : (tensor<32x3x224x224xf32>, tensor<1x1x1x1xf32>) -> tensor<32x3x224x224xf32>
...
// CHECK:           %[[MUL:.*]] = tosa.mul %[[VAL_0]], %[[REC]] : (tensor<8x2xf32>, tensor<1x2xf32>) -> tensor<8x2xf32>
