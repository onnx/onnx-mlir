...
// CHECK:           %[[VAL_1:.*]] = "tosa.reduce_min"(%[[VAL_0]]) <{axis = 2 : i64}> : (tensor<2x5x9x11xf32>) -> tensor<2x5x1x11xf32>
// CHECK:           %[[VAL_2:.*]] = "tosa.reduce_min"(%[[VAL_1]]) <{axis = 3 : i64}> : (tensor<2x5x1x11xf32>) -> tensor<2x5x1x1xf32>
...
// CHECK:           %[[VAL_1:.*]] = "tosa.reduce_min"(%[[VAL_0]]) <{axis = 0 : i64}> : (tensor<2x5x9x11xf32>) -> tensor<1x5x9x11xf32>
// CHECK:           %[[VAL_2:.*]] = "tosa.reduce_min"(%[[VAL_1]]) <{axis = 1 : i64}> : (tensor<1x5x9x11xf32>) -> tensor<1x1x9x11xf32>
// CHECK:           %[[VAL_3:.*]] = "tosa.reduce_min"(%[[VAL_2]]) <{axis = 2 : i64}> : (tensor<1x1x9x11xf32>) -> tensor<1x1x1x11xf32>
// CHECK:           %[[VAL_4:.*]] = "tosa.reduce_min"(%[[VAL_3]]) <{axis = 3 : i64}> : (tensor<1x1x1x11xf32>) -> tensor<1x1x1x1xf32>
...
// CHECK:           [[VAR_0_:%.+]] = "tosa.reduce_min"(%arg0) <{axis = 2 : i64}>
// CHECK-DAG:       [[VAR_1_:%.+]] = "tosa.reduce_min"([[VAR_0_]]) <{axis = 3 : i64}>
