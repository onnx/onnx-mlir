...
// CHECK-DAG: %[[VAR0:.*]] = "tosa.exp"(%arg0) : (tensor<13x21x3xf32>) -> tensor<13x21x3xf32>
// CHECK-DAG: %[[VAR1:.*]] = "tosa.reduce_sum"(%[[VAR0]]) {axis = 2 : i64} : (tensor<13x21x3xf32>) -> tensor<13x21x1xf32>
// CHECK-DAG: %[[VAR2:.*]] = "tosa.reciprocal"(%[[VAR1]]) : (tensor<13x21x1xf32>) -> tensor<13x21x1xf32>
...
// CHECK-DAG: %[[VAR0:.*]] = "tosa.exp"(%arg0) : (tensor<13x21x3xf32>) -> tensor<13x21x3xf32>
// CHECK-DAG: %[[VAR1:.*]] = "tosa.reduce_sum"(%[[VAR0]]) {axis = 1 : i64} : (tensor<13x21x3xf32>) -> tensor<13x1x3xf32>
// CHECK-DAG: %[[VAR2:.*]] = "tosa.reciprocal"(%[[VAR1]]) : (tensor<13x1x3xf32>) -> tensor<13x1x3xf32>
