...
func.func @reduce_max_no_axes_attr(%arg0: tensor<2x5x9x11xf32>) -> tensor<1x1x1x1xf32> {
%none = "onnx.NoValue"() {value} : () -> none
%0 = "onnx.ReduceMax"(%arg0, %none) : (tensor<2x5x9x11xf32>, none) -> tensor<1x1x1x1xf32>
...
func.func @reduce_max_keepdims_false(%arg0: tensor<2x5x9x11xf32>) -> tensor<2x5xf32> {
%0 = "onnx.Constant"() {value = dense<[2, 3]> : tensor<2xi64>} : () -> tensor<2xi64>
%1 = "onnx.ReduceMax"(%arg0, %0) {keepdims = 0 : si64} : (tensor<2x5x9x11xf32>, tensor<2xi64>) -> tensor<2x5xf32>
...
func.func @reduce_max_noop_with_emtpy_axes_one(%arg0: tensor<2x5x9x11xf32>) -> tensor<2x5x1x1xf32> {
%0 = "onnx.Constant"() {value = dense<[2, 3]> : tensor<2xi64>} : () -> tensor<2xi64>
%1 = "onnx.ReduceMax"(%arg0, %0) {noop_with_empty_axes = 1 : si64} : (tensor<2x5x9x11xf32>, tensor<2xi64>) -> tensor<2x5x1x1xf32>
return %1 : tensor<2x5x1x1xf32>
...
func.func @reduce_max_noop_with_emtpy_axes_one_none_input(%arg0: tensor<2x5x9x11xf32>) -> tensor<2x5x9x11xf32> {
%none = "onnx.NoValue"() {value} : () -> none
%0 = "onnx.ReduceMax"(%arg0, %none) {noop_with_empty_axes = 1 : si64} : (tensor<2x5x9x11xf32>, none) ->  tensor<2x5x9x11xf32>
...
func.func @test_reducemaxV13(%arg0: tensor<1x32x112x112xf32>) -> tensor<1x32x1x1xf32> {
...
func.func @reduce_max_dynamic_input_static_output(%arg0: tensor<?x5x9x11xf32>) -> tensor<1x5x1x1xf32> {
%0 = "onnx.Constant"() {value = dense<[2, 3]> : tensor<2xi64>} : () -> tensor<2xi64>
%1 = "onnx.ReduceMax"(%arg0, %0) : (tensor<?x5x9x11xf32>, tensor<2xi64>) -> tensor<1x5x1x1xf32>
return %1 : tensor<1x5x1x1xf32>
// CHECK-LABEL:   func.func @reduce_max_dynamic_input_static_output(
// CHECK-SAME:                                                %[[VAL_0:.*]]: tensor<?x5x9x11xf32>) -> tensor<1x5x1x1xf32> {
// CHECK:           %[[VAL_1:.*]] = tosa.reduce_max %[[VAL_0]] {axis = 2 : i32} : (tensor<?x5x9x11xf32>) -> tensor<?x5x1x11xf32>
// CHECK:           %[[VAL_2:.*]] = tosa.reduce_max %[[VAL_1]] {axis = 3 : i32} : (tensor<?x5x1x11xf32>) -> tensor<1x5x1x1xf32>
// CHECK:           return %[[VAL_2]] : tensor<1x5x1x1xf32>
}

// -----

func.func @test_reducemaxV13_keep_dims_0(%arg0: tensor<1x32x112x112xf32>) -> tensor<1x32xf32> {
