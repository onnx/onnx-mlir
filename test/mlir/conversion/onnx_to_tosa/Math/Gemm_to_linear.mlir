...
//CHECK-DAG:    "tosa.fully_connected"(%arg0, %arg1, %arg2)
    return %0 : tensor<1x4xf32>
  }
  
// -----
  
  func.func @gemm_to_linear_broadcast(%arg0: tensor<2x5xf32>, %arg1: tensor<4x5xf32>, %arg2: tensor<1xf32>) -> tensor<2x4xf32> {
  %0 = "onnx.Gemm"(%arg0, %arg1, %arg2) {transB = 1 : si64} : (tensor<2x5xf32>, tensor<4x5xf32>, tensor<1xf32>) -> tensor<2x4xf32>
//CHECK-LABEL:  @gemm_to_linear_broadcast(%arg0: tensor<2x5xf32>, %arg1: tensor<4x5xf32>, %arg2: tensor<1xf32>) -> tensor<2x4xf32>
...
//CHECK-DAG:    %[[RES:.*]] = "tosa.add"(%[[FC_RES]], %arg2) : (tensor<2x4xf32>, tensor<1xf32>) -> tensor<2x4xf32>
