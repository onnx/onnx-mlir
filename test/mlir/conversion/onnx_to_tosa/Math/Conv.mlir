...
// CHECK:           %[[VAL_22:.*]] = "tosa.concat"(%[[VAL_9]], %[[VAL_13]], %[[VAL_17]], %[[VAL_21]]) <{axis = 3 : i64}> : (tensor<5x17x17x3xf32>, tensor<5x17x17x3xf32>, tensor<5x17x17x3xf32>, tensor<5x17x17x3xf32>) -> tensor<5x17x17x12xf32>
