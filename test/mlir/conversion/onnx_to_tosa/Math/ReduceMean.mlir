...
func.func @reduce_mean_dynamic_input_static_output(%arg0: tensor<?x5x9x11xf32>) -> tensor<1x5x1x1xf32> {
%0 = "onnx.Constant"() {value = dense<[2, 3]> : tensor<2xi64>} : () -> tensor<2xi64>
%1 = "onnx.ReduceMean"(%arg0, %0) : (tensor<?x5x9x11xf32>, tensor<2xi64>) -> tensor<1x5x1x1xf32>
return %1 : tensor<1x5x1x1xf32>
// CHECK-LABEL:   func.func @reduce_mean_dynamic_input_static_output(
...
// CHECK:           %[[VAL_2:.*]] = tosa.reduce_sum %[[VAL_1]] {axis = 3 : i32} : (tensor<?x5x1x11xf32>) -> tensor<?x5x1x1xf32>
// CHECK:           %[[VAL_4:.*]] = tosa.mul %[[VAL_2]], {{.*}}, {{.*}} : (tensor<?x5x1x1xf32>, tensor<1x1x1x1xf32>, tensor<1xi8>) -> tensor<1x5x1x1xf32>
// CHECK:           return %[[VAL_4]] : tensor<1x5x1x1xf32>
}
