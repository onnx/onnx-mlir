...
// CHECK:           %[[VAL_4:.*]] = "tosa.mul"(%[[VAL_2]], %[[VAL_3]]) <{shift = 0 : i32}> : (tensor<2x5x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<2x5x1x1xf32>
...
// CHECK:           %[[VAL_6:.*]] = "tosa.mul"(%[[VAL_4]], %[[VAL_5]]) <{shift = 0 : i32}> : (tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
...
// CHECK:           %[[VAL_5:.*]] = "tosa.mul"(%[[VAL_3]], %[[VAL_4]]) <{shift = 0 : i32}> : (tensor<2x5xf32>, tensor<1x1xf32>) -> tensor<2x5xf32>
...
// CHECK:           %[[VAL_3:.*]] = "tosa.mul"(%[[VAL_1]], %[[VAL_2]]) <{shift = 0 : i32}> : (tensor<2x5x9x11xf32>, tensor<1x1x1x1xf32>) -> tensor<2x5x9x11xf32>
...
// CHECK:           [[VAR_3_:%.+]] = "tosa.mul"([[VAR_1_]], [[VAR_2_]]) <{shift = 0 : i32}> : (tensor<1x32x1x1xf32>, tensor<1x1x1x1xf32>)
