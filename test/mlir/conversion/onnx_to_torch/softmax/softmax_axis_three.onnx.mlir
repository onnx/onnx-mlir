...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  func.func @main_graph(%arg0: tensor<1x38x19x19xf32>) -> tensor<1x38x19x19xf32> attributes {input_names = ["input.1"], output_names = ["8"]} {
    ...
    //CHECK: torch.aten._softmax %arg0, %[[DIM]], %[[FALSE]] {layer_name = "Softmax_3"} : !torch.vtensor<[1,38,19,19],f32>, !torch.int, !torch.bool -> !torch.vtensor<[1,38,19,19],f32>
