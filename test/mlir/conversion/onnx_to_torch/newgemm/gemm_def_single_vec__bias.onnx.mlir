...
//CHECK: %[[TRANSB:.*]] = torch.constant.int 1
    %0 = "onnx.Gemm"(%arg0, %arg1, %arg2) : (tensor<3x5xf32>, tensor<5x4xf32>, tensor<1x4xf32>) -> tensor<3x4xf32>
//CHECK: torch.aten.bmm %arg0, %arg1 : !torch.vtensor<[3,5],f32>, !torch.vtensor<[5,4],f32> -> !torch.vtensor<[3,4],f32>
//CHECK: torch.aten.add.Tensor %6, %arg1, %[[TRANSB]] : !torch.vtensor<[3,4],f32>, !torch.vtensor<[5,4],f32>, !torch.int -> !torch.vtensor<[3,4],f32>
