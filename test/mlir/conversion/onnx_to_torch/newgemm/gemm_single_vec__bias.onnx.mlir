...
//CHECK: %[[TRANSB:.*]] = torch.constant.int 1
    %0 = "onnx.Gemm"(%arg0, %arg1, %arg2) : (tensor<2x7xf32>, tensor<7x4xf32>, tensor<1x4xf32>) -> tensor<2x4xf32>
//CHECK: torch.aten.bmm %arg0, %arg1 : !torch.vtensor<[2,7],f32>, !torch.vtensor<[7,4],f32> -> !torch.vtensor<[2,4],f32>
//CHECK: torch.aten.add.Tensor %6, %arg1, %[[TRANSB]] : !torch.vtensor<[2,4],f32>, !torch.vtensor<[7,4],f32>, !torch.int -> !torch.vtensor<[2,4],f32>
