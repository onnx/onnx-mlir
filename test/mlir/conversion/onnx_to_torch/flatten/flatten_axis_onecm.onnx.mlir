...
//CHECK-DAG: torch.aten.conv2d %arg0, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}} : !torch.vtensor<[1,4,15,15],f32>, !torch.vtensor<[6,4,7,7],f32>, !torch.vtensor<[6],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.int -> !torch.vtensor<[1,6,5,5],f32>   
...
//CHECK-DAG: torch.aten.conv2d %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}} : !torch.vtensor<[1,6,5,5],f32>, !torch.vtensor<[5,6,5,5],f32>, !torch.vtensor<[5],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.int -> !torch.vtensor<[1,5,2,2],f32>  
