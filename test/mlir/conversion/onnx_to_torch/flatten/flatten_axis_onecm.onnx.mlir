...
//CHECK-DAG: torch.aten.convolution %arg0, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}} {layer_name = "Conv_0"} : !torch.vtensor<[1,4,15,15],f32>, !torch.vtensor<[6,4,7,7],f32>, !torch.vtensor<[6],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool, !torch.list<int>, !torch.int -> !torch.vtensor<[1,6,5,5],f32>   
...
//CHECK-DAG: torch.aten.convolution %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}} {layer_name = "Conv_1"} : !torch.vtensor<[1,6,5,5],f32>, !torch.vtensor<[5,6,5,5],f32>, !torch.vtensor<[5],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool, !torch.list<int>, !torch.int -> !torch.vtensor<[1,5,2,2],f32>  
...
//CHECK-DAG: torch.aten.max_pool2d %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}} {layer_name = "MaxPool_2"} : !torch.vtensor<[1,5,2,2],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool -> !torch.vtensor<[1,5,1,1],f32> 
...
//CHECK-DAG: torch.aten.flatten.using_ints %{{[^,]*}}, %{{[^,]*}}, %{{[^,]*}} {layer_name = "Flatten_3"} : !torch.vtensor<[1,5,1,1],f32>, !torch.int, !torch.int -> !torch.vtensor<[1,5],f32> 
