...
//CHECK: %[[ENDDIM:.*]] = torch.constant.int 3
//CHECK: %[[DIM:.*]] = torch.constant.int 1
//CHECK: torch.aten.flatten.using_ints %arg0, %[[DIM]], %[[ENDDIM]] : !torch.vtensor<[1,1,160,160],f32>, !torch.int, !torch.int -> !torch.vtensor<[1,25600],f32>
