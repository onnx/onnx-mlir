...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  func @main_graph(%arg0: tensor<2x3x5x7xf32>) -> tensor<6x35xf32> attributes {input_names = ["0"], output_names = ["1"]} {
    //CHECK: %[[FLAT1:.*]] = torch.aten.flatten.using_ints %arg0, %int0, %int1 : !torch.vtensor<[2,3,5,7],f32>, !torch.int, !torch.int -> !torch.vtensor<[6,5,7],f32>
    //CHECK: %[[FLAT2:.*]] = torch.aten.flatten.using_ints %[[FLAT1]], %int1_0, %int-1 : !torch.vtensor<[6,5,7],f32>, !torch.int, !torch.int -> !torch.vtensor<[6,35],f32>
