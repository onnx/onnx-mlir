...
//CHECK: [[FLAT1:%.]] = torch.aten.flatten.using_ints %arg0, %[[DIM]], %[[DIM1]] : !torch.vtensor<[2,3,5,7],f32>, !torch.int, !torch.int -> !torch.vtensor<[6,5,7],f32>
//CHECK: [[FLAT2:%.]] = torch.aten.flatten.using_ints [[FLAT1]], %[[DIM1]], %{{[^,]*}} : !torch.vtensor<[6,5,7],f32>, !torch.int, !torch.int -> !torch.vtensor<[6,35],f32> 
