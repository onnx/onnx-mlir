...
//CHECK: torch.aten.constant_pad_nd %arg0, %{{[^,]*}}, [[ALPHA]] : !torch.vtensor<[1,1,5,5],f32>, !torch.list<int>, !torch.float -> !torch.vtensor<[1,1,9,9],f32>
...
//CHECK: torch.aten.constant_pad_nd  %{{[^,]*}},  %{{[^,]*}}, [[ALPHA]] : !torch.vtensor<[1,1,9,9],f32>, !torch.list<int>, !torch.float -> !torch.vtensor<[1,1,16,12],f32>
