...
module {
  func.func @main_graph(%arg0: tensor<20x16x44x32xf32>) -> tensor<20x16x48x38xf32> attributes {input_names = ["0"], output_names = ["2"]} {
    ...
    %2 = "onnx.Pad"(%arg0, %0, %1) {input0_bitwidth = 8.000000e+00 : f32, input0_narrow = 0 : si64, input0_rounding_mode = "ROUND", input0_scale_factor = 1.250000e-01 : f32, input0_signed = 1 : si64, mode = "constant", onnx_node_name = "Pad_0"} : (tensor<20x16x44x32xf32>, tensor<8xi64>, tensor<1xf32>) -> tensor<20x16x48x38xf32> 
