...
// CHECK: [[PAD_ND_OP:%.]] = torch.aten.constant_pad_nd %arg0, %1, %float-3.402820e38 : !torch.vtensor<[1,5,10,10],f32>, !torch.list<int>, !torch.float -> !torch.vtensor<[1,5,12,14],f32>
// CHECK-DAG: [[PAD_ZERO:%.]] = torch.prim.ListConstruct %int0, %int0 : (!torch.int, !torch.int) -> !torch.list<int>
// CHECK: [[MAXPOOL_OP:%.]] = torch.aten.max_pool2d [[PAD_ND_OP]], [[KERNEL]], [[STRIDE]], [[PAD_ZERO]], [[DILATION]], %false : !torch.vtensor<[1,5,12,14],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool -> !torch.vtensor<[1,5,5,13],f32>
