...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  func @main_graph(%arg0: tensor<3x3xf32>) -> tensor<3x3xf32> attributes {input_names = ["0"], output_names = ["1"]} {
    %0 = "onnx.MatMul"(%arg0, %arg0) {onnx_node_name = "MatMul_0"} : (tensor<3x3xf32>, tensor<3x3xf32>) -> tensor<3x3xf32>
//CHECK: torch.aten.matmul %arg0, %arg0 : !torch.vtensor<[3,3],f32>, !torch.vtensor<[3,3],f32> -> !torch.vtensor<[3,3],f32>  
