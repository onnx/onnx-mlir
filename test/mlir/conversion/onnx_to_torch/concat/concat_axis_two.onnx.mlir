...
//CHECK: [[RES2:%.]] = torch.prim.ListConstruct [[RES1]], [[RES1]] : (!torch.vtensor<[1,17,18,18],f32>, !torch.vtensor<[1,17,18,18],f32>) -> !torch.list<vtensor>
%3 = "onnx.Concat"(%2, %2) {axis = 2 : si64, onnx_node_name = "Concat_1"} : (tensor<1x17x18x18xf32>, tensor<1x17x18x18xf32>) -> tensor<1x17x36x18xf32>
//CHECK: torch.aten.cat [[RES2]], %[[DIM]] : !torch.list<vtensor>, !torch.int -> !torch.vtensor<[1,17,36,18],f32>
