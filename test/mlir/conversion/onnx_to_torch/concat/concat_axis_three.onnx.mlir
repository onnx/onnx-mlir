...
//CHECK: [[RES2:%.]] = torch.prim.ListConstruct [[RES1]], [[RES1]] : (!torch.vtensor<[1,12,12,12],f32>, !torch.vtensor<[1,12,12,12],f32>) -> !torch.list<vtensor<[1,12,12,12],f32>>
    %3 = "onnx.Concat"(%2, %2) {axis = 3 : si64, onnx_node_name = "Concat_1"} : (tensor<1x12x12x12xf32>, tensor<1x12x12x12xf32>) -> tensor<1x12x12x24xf32>
//CHECK: torch.aten.cat [[RES2]], %[[DIM]] : !torch.list<vtensor<[1,12,12,12],f32>>, !torch.int -> !torch.vtensor<[1,12,12,24],f32>
