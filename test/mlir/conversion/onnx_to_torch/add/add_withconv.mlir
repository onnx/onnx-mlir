...
// CHECK-DAG: [[CONST0:%.*]] = torch.constant.int 0
// CHECK-DAG: [[CONST1_0:%.*]] = torch.constant.int 1
...
// CHECK: [[RES:%.]] = torch.aten.convolution %arg0, %{{[^,]*}}, %{{[^,]*}}, [[STRIDE]], [[PAD]], [[STRIDE]], [[FALSE]], [[OUTPAD]], %{{[^,]*}} {layer_name = "Conv_0"} : !torch.vtensor<[2,3,7,5],f32>, !torch.vtensor<[4,3,3,3],f32>, !torch.vtensor<[4],f32>, !torch.list<int>, !torch.list<int>, !torch.list<int>, !torch.bool, !torch.list<int>, !torch.int -> !torch.vtensor<[2,4,5,3],f32>
...
// CHECK: torch.aten.add.Tensor [[RES]], %{{[^,]*}}, [[CONST1]] {layer_name = "Add_2"} : !torch.vtensor<[2,4,5,3],f32>, !torch.vtensor<[],f32>, !torch.int -> !torch.vtensor<[2,4,5,3],f32>
