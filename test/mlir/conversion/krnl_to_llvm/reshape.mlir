// RUN: onnx-mlir-opt -O3 --shape-inference --convert-onnx-to-krnl --convert-krnl-to-affine --convert-krnl-to-llvm="use-opaque-pointers=true" %s -split-input-file | FileCheck %s
