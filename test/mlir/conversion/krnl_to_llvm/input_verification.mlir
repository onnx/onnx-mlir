...
// CHECK:         ^bb1:  // pred: ^bb0
// CHECK:           llvm.call @printf([[VAR_16_1_]], [[VAR_18_1_]]) vararg(!llvm.func<void (ptr, ...)>) : (!llvm.ptr, i64) -> ()
...
// CHECK:         ^bb5:  // pred: ^bb4
// CHECK:           llvm.call @printf([[VAR_11_1_]], [[VAR_31_]]) vararg(!llvm.func<void (ptr, ...)>) : (!llvm.ptr, i64) -> ()
...
// CHECK:         ^bb7:  // pred: ^bb6
// CHECK:           llvm.call @printf([[LOAD_arg2_MEM_1_]], [[LOAD_VAR_32_MEM_]]) vararg(!llvm.func<void (ptr, ...)>) : (!llvm.ptr, i64) -> ()
...
// CHECK:         ^bb9:  // pred: ^bb8
// CHECK:           llvm.call @printf([[VAR_8_2_]], [[LOAD_VAR_36_MEM_]]) vararg(!llvm.func<void (ptr, ...)>) : (!llvm.ptr, i64) -> ()
...
// CHECK:           llvm.call @printf([[VAR_6_2_]], [[LOAD_VAR_40_MEM_]]) vararg(!llvm.func<void (ptr, ...)>) : (!llvm.ptr, i64) -> ()
...
// CHECK:           llvm.call @printf([[VAR_4_2_]], [[VAR_48_]]) vararg(!llvm.func<void (ptr, ...)>) : (!llvm.ptr, i64) -> ()
...
// CHECK:           llvm.call @printf([[VAR_1_2_]], [[LOAD_VAR_55_MEM_]]) vararg(!llvm.func<void (ptr, ...)>) : (!llvm.ptr, i64) -> ()
...
// CHECK:           llvm.call @printf([[VAR_0_2_]], [[LOAD_VAR_54_MEM_]]) vararg(!llvm.func<void (ptr, ...)>) : (!llvm.ptr, i64) -> ()
