...
// CHECK:           [[VAR_1_:%.+]] = "stablehlo.reduce_window"([[PARAM_0_]], [[VAR_0_]]) <{padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 3, 3>, window_strides = array<i64: 1, 1, 1, 1>}> ({
...
// CHECK:           [[VAR_0_:%.+]] = stablehlo.constant dense<0xFF800000> : tensor<f32>
// CHECK:           [[VAR_1_:%.+]] = "stablehlo.reduce_window"([[PARAM_0_]], [[VAR_0_]]) <{padding = dense<{{.}}[0, 0], [0, 0], [1, 1], [1, 1]]> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 3, 3>, window_strides = array<i64: 1, 1, 1, 1>}> ({
// CHECK:           ^bb0(%arg1: tensor<f32>, %arg2: tensor<f32>):
// CHECK:             [[VAR_2_:%.+]] = stablehlo.maximum %arg1, %arg2 : tensor<f32>
// CHECK:             stablehlo.return [[VAR_2_]] : tensor<f32>
...
// CHECK:           [[VAR_0_:%.+]] = stablehlo.constant dense<0xFF800000> : tensor<f32>
// CHECK:           [[VAR_1_:%.+]] = "stablehlo.reduce_window"([[PARAM_0_]], [[VAR_0_]]) <{padding = dense<{{.}}[0, 0], [0, 0], [2, 1], [1, 0]]> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 5, 3>, window_strides = array<i64: 1, 1, 1, 1>}> ({
// CHECK:           ^bb0(%arg1: tensor<f32>, %arg2: tensor<f32>):
// CHECK:             [[VAR_2_:%.+]] = stablehlo.maximum %arg1, %arg2 : tensor<f32>
// CHECK:             stablehlo.return [[VAR_2_]] : tensor<f32>
...
// CHECK:           [[VAR_0_:%.+]] = stablehlo.constant dense<0xFF800000> : tensor<f32>
// CHECK:           [[VAR_1_:%.+]] = "stablehlo.reduce_window"([[PARAM_0_]], [[VAR_0_]]) <{padding = dense<{{.}}[0, 0], [0, 0], [1, 1], [1, 1]]> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 3, 3>, window_strides = array<i64: 1, 1, 2, 2>}> ({
// CHECK:           ^bb0(%arg1: tensor<f32>, %arg2: tensor<f32>):
// CHECK:             [[VAR_2_:%.+]] = stablehlo.maximum %arg1, %arg2 : tensor<f32>
// CHECK:             stablehlo.return [[VAR_2_]] : tensor<f32>
...
// CHECK:           [[VAR_0_:%.+]] = stablehlo.constant dense<0xFF800000> : tensor<f32>
// CHECK:           [[VAR_1_:%.+]] = "stablehlo.reduce_window"([[PARAM_0_]], [[VAR_0_]]) <{padding = dense<{{.}}[0, 0], [0, 0], [1, 0], [0, 0]]> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 2, 2>, window_strides = array<i64: 1, 1, 2, 2>}> ({
// CHECK:           ^bb0(%arg1: tensor<f32>, %arg2: tensor<f32>):
// CHECK:             [[VAR_2_:%.+]] = stablehlo.maximum %arg1, %arg2 : tensor<f32>
// CHECK:             stablehlo.return [[VAR_2_]] : tensor<f32>
...
// CHECK:           [[VAR_0_:%.+]] = stablehlo.constant dense<0xFF800000> : tensor<f32>
// CHECK:           [[VAR_1_:%.+]] = "stablehlo.reduce_window"([[PARAM_0_]], [[VAR_0_]]) <{padding = dense<{{.}}[0, 0], [0, 0], [1, 1], [0, 0]]> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 2, 2>, window_strides = array<i64: 1, 1, 2, 2>}> ({
// CHECK:           ^bb0(%arg1: tensor<f32>, %arg2: tensor<f32>):
// CHECK:             [[VAR_2_:%.+]] = stablehlo.maximum %arg1, %arg2 : tensor<f32>
// CHECK:             stablehlo.return [[VAR_2_]] : tensor<f32>
...
// CHECK:           [[VAR_0_:%.+]] = stablehlo.constant dense<0xFF800000> : tensor<f32>
// CHECK:           [[VAR_1_:%.+]] = "stablehlo.reduce_window"([[PARAM_0_]], [[VAR_0_]]) <{padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 2, 2>, window_dimensions = array<i64: 1, 1, 2, 2>, window_strides = array<i64: 1, 1, 3, 3>}> ({
// CHECK:           ^bb0(%arg1: tensor<f32>, %arg2: tensor<f32>):
// CHECK:             [[VAR_2_:%.+]] = stablehlo.maximum %arg1, %arg2 : tensor<f32>
// CHECK:             stablehlo.return [[VAR_2_]] : tensor<f32>
...
// CHECK:           [[VAR_0_:%.+]] = stablehlo.constant dense<0xFF800000> : tensor<f32>
// CHECK:           [[VAR_1_:%.+]] = "stablehlo.reduce_window"([[PARAM_0_]], [[VAR_0_]]) <{padding = dense<{{.}}[0, 0], [0, 0], [0, 0], [1, 2]]> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 4, 4>, window_strides = array<i64: 1, 1, 4, 4>}> ({
// CHECK:           ^bb0(%arg1: tensor<f32>, %arg2: tensor<f32>):
// CHECK:             [[VAR_2_:%.+]] = stablehlo.maximum %arg1, %arg2 : tensor<f32>
// CHECK:             stablehlo.return [[VAR_2_]] : tensor<f32>
...
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<5x5x16x13xf32>) -> tensor<5x5x4x4xf32> {
// CHECK:           [[VAR_0_:%.+]] = stablehlo.constant dense<0xFF800000> : tensor<f32>
// CHECK:           [[VAR_1_:%.+]] = "stablehlo.reduce_window"([[PARAM_0_]], [[VAR_0_]]) <{padding = dense<{{.}}[0, 0], [0, 0], [0, 0], [2, 1]]> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 4, 4>, window_strides = array<i64: 1, 1, 4, 4>}> ({
// CHECK:           ^bb0(%arg1: tensor<f32>, %arg2: tensor<f32>):
// CHECK:             [[VAR_2_:%.+]] = stablehlo.maximum %arg1, %arg2 : tensor<f32>
// CHECK:             stablehlo.return [[VAR_2_]] : tensor<f32>
// CHECK:           }) : (tensor<5x5x16x13xf32>, tensor<f32>) -> tensor<5x5x4x4xf32>
...
// CHECK:           [[VAR_2_:%.+]] = "stablehlo.reduce_window"([[PARAM_0_]], [[VAR_1_]]) <{padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 3, 3>, window_strides = array<i64: 1, 1, 1, 1>}> ({
// CHECK:           ^bb0(%arg1: tensor<f32>, %arg2: tensor<f32>):
// CHECK:             [[VAR_5_:%.+]] = stablehlo.add %arg1, %arg2 : tensor<f32>
// CHECK:             stablehlo.return [[VAR_5_]] : tensor<f32>
// CHECK:           }) : (tensor<5x5x32x32xf32>, tensor<f32>) -> tensor<5x5x30x30xf32>
// CHECK:           [[VAR_3_:%.+]] = "stablehlo.reduce_window"([[VAR_0_]], [[VAR_1_]]) <{padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 3, 3>, window_strides = array<i64: 1, 1, 1, 1>}> ({
// CHECK:           ^bb0(%arg1: tensor<f32>, %arg2: tensor<f32>):
...
// CHECK-DAG:       [[VAR_0_:%.+]] = stablehlo.constant dense<1.000000e+00> : tensor<5x5x32x32xf32>
// CHECK-DAG:       [[VAR_1_:%.+]] = stablehlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           [[VAR_2_:%.+]] = "stablehlo.reduce_window"([[PARAM_0_]], [[VAR_1_]]) <{padding = dense<{{.}}[0, 0], [0, 0], [1, 1], [1, 1]]> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 3, 3>, window_strides = array<i64: 1, 1, 1, 1>}> ({
// CHECK:           ^bb0(%arg1: tensor<f32>, %arg2: tensor<f32>):
// CHECK:             [[VAR_5_:%.+]] = stablehlo.add %arg1, %arg2 : tensor<f32>
// CHECK:             stablehlo.return [[VAR_5_]] : tensor<f32>
// CHECK:           }) : (tensor<5x5x32x32xf32>, tensor<f32>) -> tensor<5x5x32x32xf32>
// CHECK:           [[VAR_3_:%.+]] = "stablehlo.reduce_window"([[VAR_0_]], [[VAR_1_]]) <{padding = dense<{{.}}[0, 0], [0, 0], [1, 1], [1, 1]]> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 3, 3>, window_strides = array<i64: 1, 1, 1, 1>}> ({
// CHECK:           ^bb0(%arg1: tensor<f32>, %arg2: tensor<f32>):
// CHECK:             [[VAR_5_1_:%.+]] = stablehlo.add %arg1, %arg2 : tensor<f32>
// CHECK:             stablehlo.return [[VAR_5_1_]] : tensor<f32>
// CHECK:           }) : (tensor<5x5x32x32xf32>, tensor<f32>) -> tensor<5x5x32x32xf32>
...
// CHECK:           [[VAR_5_:%.+]] = "stablehlo.reduce_window"([[VAR_4_]], [[VAR_1_]]) <{padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 3, 3>, window_strides = array<i64: 1, 1, 1, 1>}> ({
// CHECK:           ^bb0(%arg1: tensor<f32>, %arg2: tensor<f32>):
