// RUN: onnx-mlir --printIR --EmitMLIR --instrument-stage=afterOnnxToOnnx --instrument-ops=onnx. --InstrumentBeforeOp --InstrumentAfterOp --InstrumentReportTime %s | FileCheck %s
