// RUN: onnx-mlir --printIR --EmitMLIR --instrument-dialects=onnx --instrument-ops=ALL --InstrumentBeforeOp --InstrumentAfterOp --InstrumentReportTime %s | FileCheck %s
...
// CHECK:           "krnl.runtime_instrument"() {dialectID = [[ID_0_:.+]] : i64, nodeName = "model/add1", opID = [[ID_1_:.+]] : i64, opName = "onnx.Add", tag = 5 : i64} : () -> ()
...
// CHECK:             }
// CHECK:           }
// CHECK:           "krnl.runtime_instrument"() {dialectID = [[ID_0_]] : i64, nodeName = "model/add1", opID = [[ID_1_]] : i64, opName = "onnx.Add", tag = 6 : i64} : () -> ()
// CHECK:           return
// CHECK:         }
