// RUN: onnx-mlir --printIR --EmitMLIR --instrument-stage=before-onnx-to-krnl --instrument-ops=onnx. --InstrumentBeforeOp --InstrumentAfterOp --InstrumentReportTime %s | FileCheck %s
