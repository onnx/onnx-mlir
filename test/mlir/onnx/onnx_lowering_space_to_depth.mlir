...
// CHECK-DAG:       [[VAR_6_:%.+]] = builtin.unrealized_conversion_cast [[RES_]] : memref<6xindex> to tensor<6xindex>
// CHECK:           [[VAR_7_:%.+]] = "onnx.Reshape"([[VAR_5_]], [[VAR_6_]]) : (tensor<1x?x8x?xf32>, tensor<6xindex>) -> tensor<?x?x?x?x?x?xf32>
...
// CHECK:           [[VAR_13_:%.+]] = builtin.unrealized_conversion_cast [[RES_1_]] : memref<4xindex> to tensor<4xindex>
// CHECK:           [[VAR_14_:%.+]] = "onnx.Reshape"([[VAR_11_]], [[VAR_13_]]) : (tensor<1x?x4x4x2x?xf32>, tensor<4xindex>) -> tensor<?x?x?x?xf32>
