...
func.func @test_category_mapper_diff_size_attrs (%arg0: tensor<20x1xi32>) -> tensor<*x!onnx.String> {
  // expected-error @+1 {{'onnx.CategoryMapper' op operand #0 must be Tensor or MemRef of string type values or Tensor or MemRef of 64-bit signless integer values, but got 'tensor<20x1xi32>'}}      
