...
// CHECK:             [[LOAD_PARAM_5_MEM_:%.+]] = krnl.load [[PARAM_5_]][[[VAR_c0_]], [[IV]]#0, [[IV]]#1] : memref<1x2x4xf32>
// CHECK:             krnl.store [[LOAD_PARAM_5_MEM_]], [[RES_2_]][[[IV]]#0, [[IV]]#1] : memref<2x4xf32>
// CHECK:           }
...
// CHECK:               [[LOAD_PARAM_0_MEM_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[IV]], [[VAR_18_]]#0, [[VAR_18_]]#1] : memref<7x2x3xf32>
...
// CHECK:             [[LOAD_PARAM_2_MEM_:%.+]] = krnl.load [[PARAM_2_]][[[VAR_c0_]], [[IV]]#0, [[IV]]#1] : memref<1x2x4xf32>
// CHECK:             krnl.store [[LOAD_PARAM_2_MEM_]], [[RES_2_]][[[IV]]#0, [[IV]]#1] : memref<2x4xf32>
// CHECK:           }
...
// CHECK-DAG:           [[LOAD_PARAM_0_MEM_1_:%.+]] = krnl.load [[RES_2_]]{{.}}[[VAR_23_1_]]#0, [[VAR_23_1_]]#1] : memref<2x4xf32>
...
// CHECK:               krnl.store [[VAR_67_]], [[RES_2_]]{{.}}[[VAR_23_1_]]#0, [[VAR_23_1_]]#1] : memref<2x4xf32>
...
// CHECK:             krnl.store [[LOAD_PARAM_4_MEM_]], [[RES_1_]][[[IV]]#0, [[IV]]#1] : memref<2x4xf32>
// CHECK:             [[LOAD_PARAM_5_MEM_:%.+]] = krnl.load [[PARAM_5_]][[[VAR_c0_]], [[IV]]#0, [[IV]]#1] : memref<2x2x4xf32>
// CHECK:             krnl.store [[LOAD_PARAM_5_MEM_]], [[RES_2_]][[[IV]]#0, [[IV]]#1] : memref<2x4xf32>
// CHECK:             [[LOAD_PARAM_4_MEM_1_:%.+]] = krnl.load [[PARAM_4_]][[[VAR_c1_]], [[IV]]#0, [[IV]]#1] : memref<2x2x4xf32>
// CHECK:             krnl.store [[LOAD_PARAM_4_MEM_1_]], [[RES_3_]][[[IV]]#0, [[IV]]#1] : memref<2x4xf32>
// CHECK:             [[LOAD_PARAM_5_MEM_1_:%.+]] = krnl.load [[PARAM_5_]][[[VAR_c1_]], [[IV]]#0, [[IV]]#1] : memref<2x2x4xf32>
// CHECK:             krnl.store [[LOAD_PARAM_5_MEM_1_]], [[RES_4_]][[[IV]]#0, [[IV]]#1] : memref<2x4xf32>
// CHECK:           }
...
// CHECK:               [[LOAD_PARAM_0_MEM_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[IV]], [[VAR_34_]]#0, [[VAR_34_]]#1] : memref<7x2x3xf32>
...
// CHECK:             [[IV:%.+]] = krnl.get_induction_var_value([[LOOP_4_]]) : (!krnl.loop) -> index
// CHECK-DAG:         [[RES_5_:%.+]] = affine.apply #map3([[IV]])
...
// CHECK:             [[IV:%.+]]:2 = krnl.get_induction_var_value([[LOOP_0_]]#0, [[LOOP_0_]]#1) : (!krnl.loop, !krnl.loop) -> (index, index)
// CHECK:             [[LOAD_PARAM_4_MEM_:%.+]] = krnl.load [[PARAM_4_]][[[VAR_c0_]], [[IV]]#0, [[IV]]#1] : memref<1x?x4xf32>
// CHECK:             krnl.store [[LOAD_PARAM_4_MEM_]], [[RES_1_]][[[IV]]#0, [[IV]]#1] : memref<?x4xf32>
// CHECK:             [[LOAD_PARAM_5_MEM_:%.+]] = krnl.load [[PARAM_5_]][[[VAR_c0_]], [[IV]]#0, [[IV]]#1] : memref<1x?x4xf32>
// CHECK:             krnl.store [[LOAD_PARAM_5_MEM_]], [[RES_2_]][[[IV]]#0, [[IV]]#1] : memref<?x4xf32>
// CHECK:           }
...
// CHECK:           krnl.iterate([[LOOP_1_]]) with ([[LOOP_1_]] -> [[I_2_:%.+]] = 0 to #map0([[VAR_16_]])){
// CHECK:             [[IV:%.+]] = krnl.get_induction_var_value([[LOOP_1_]]) : (!krnl.loop) -> index
...
// CHECK:               [[LOAD_PARAM_0_MEM_:%.+]] = krnl.load [[PARAM_0_]]{{.}}[[IV]], [[VAR_26_]]#0, [[VAR_26_]]#1] : memref<?x?x?xf32>
...
// CHECK-DAG:           [[VAR_42_:%.+]] = affine.apply #map1(){{.}}[[VAR_26_1_]]#1]
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[LOAD_VAR_23_MEM_1_:%.+]] = krnl.load [[VAR_23_]]{{.}}[[VAR_26_1_]]#0, [[VAR_42_]]{{.}} : memref<?x16xf32>
// CHECK-DAG:           [[VAR_44_:%.+]] = affine.apply #map1(){{.}}[[VAR_26_1_]]#1]
...
// CHECK-DAG:           [[VAR_58_:%.+]] = affine.apply #map2(){{.}}[[VAR_26_1_]]#1]
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[LOAD_VAR_23_MEM_2_:%.+]] = krnl.load [[VAR_23_]]{{.}}[[VAR_26_1_]]#0, [[VAR_58_]]{{.}} : memref<?x16xf32>
// CHECK-DAG:           [[VAR_60_:%.+]] = affine.apply #map2(){{.}}[[VAR_26_1_]]#1]
...
// CHECK-DAG:           [[VAR_71_:%.+]] = affine.apply #map3(){{.}}[[VAR_26_1_]]#1]
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[LOAD_VAR_23_MEM_3_:%.+]] = krnl.load [[VAR_23_]]{{.}}[[VAR_26_1_]]#0, [[VAR_71_]]{{.}} : memref<?x16xf32>
// CHECK-DAG:           [[VAR_73_:%.+]] = affine.apply #map3(){{.}}[[VAR_26_1_]]#1]
