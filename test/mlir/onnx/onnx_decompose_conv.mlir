// RUN: onnx-mlir-opt --decompose-onnx='enable-conv-to-matmul' %s -split-input-file | FileCheck %s
...
// CHECK: [[MATMUL:%.+]] = "onnx.MatMul"([[RESHAPE_W]], [[IM2COL]])
...
// CHECK: [[RESHAPE_W:%.+]] = "onnx.Reshape"
// CHECK: [[MATMUL:%.+]] = "onnx.MatMul"
// CHECK: [[UNSQUEEZE:%.+]] = "onnx.Unsqueeze"(%arg2
// CHECK: [[ADD:%.+]] = "onnx.Add"([[MATMUL]], [[UNSQUEEZE]])
