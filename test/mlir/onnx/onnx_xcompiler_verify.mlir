...
// Input: [N, H, W, C], Weight IHWO: [M, kH, kW, C]
func.func @test_depthwise_conv_invalid_kernel_shape(%arg0: tensor<1x28x28x64xi8>, %arg1: tensor<1x3x3x64xi8>) -> tensor<1x26x26x64xi8> {
  ...
  %0 = "onnx.XCOMPILERDepthwiseConv"(%arg0, %arg1, %none) {
    kernel_shape = [3, 3, 3],
    auto_pad = "NOTSET"
  } : (tensor<1x28x28x64xi8>, tensor<1x3x3x64xi8>, none) -> tensor<1x26x26x64xi8>
...
func.func @test_depthwise_conv_invalid_strides(%arg0: tensor<1x28x28x64xi8>, %arg1: tensor<1x3x3x64xi8>) -> tensor<1x26x26x64xi8> {
  %none = "onnx.NoValue"() {value} : () -> none
...
func.func @test_depthwise_conv_invalid_dilations(%arg0: tensor<1x28x28x64xi8>, %arg1: tensor<1x3x3x64xi8>) -> tensor<1x26x26x64xi8> {
  %none = "onnx.NoValue"() {value} : () -> none
...
func.func @test_depthwise_conv_invalid_pads(%arg0: tensor<1x28x28x64xi8>, %arg1: tensor<1x3x3x64xi8>) -> tensor<1x28x28x64xi8> {
  %none = "onnx.NoValue"() {value} : () -> none
  ...
  %0 = "onnx.XCOMPILERDepthwiseConv"(%arg0, %arg1, %none) {
    ...
    pads = [1, 1],
    auto_pad = "NOTSET"
  } : (tensor<1x28x28x64xi8>, tensor<1x3x3x64xi8>, none) -> tensor<1x28x28x64xi8>
...
func.func @test_depthwise_conv_invalid_auto_pad(%arg0: tensor<1x28x28x64xi8>, %arg1: tensor<1x3x3x64xi8>) -> tensor<1x26x26x64xi8> {
  %none = "onnx.NoValue"() {value} : () -> none
...
func.func @test_depthwise_conv_invalid_input_rank(%arg0: tensor<28x28x64xi8>, %arg1: tensor<1x3x3x64xi8>) -> tensor<26x26x64xi8> {
  %none = "onnx.NoValue"() {value} : () -> none
  // expected-error @+1 {{input X must be 4D [N, H, W, C] or 5D [N, D, H, W, C], got rank 3}}
  %0 = "onnx.XCOMPILERDepthwiseConv"(%arg0, %arg1, %none) {
    kernel_shape = [3, 3],
    auto_pad = "NOTSET"
  } : (tensor<28x28x64xi8>, tensor<1x3x3x64xi8>, none) -> tensor<26x26x64xi8>
  onnx.Return %0 : tensor<26x26x64xi8>
}

// -----

// Test: 2D weight must be 4D [M, kH, kW, C] in IHWO format
func.func @test_depthwise_conv_invalid_weight_rank(%arg0: tensor<1x28x28x64xi8>, %arg1: tensor<3x3x64xi8>) -> tensor<1x26x26x64xi8> {
  %none = "onnx.NoValue"() {value} : () -> none
  // expected-error @+1 {{weight W must be 4D tensor for 2D convolution, got rank 3}}
  %0 = "onnx.XCOMPILERDepthwiseConv"(%arg0, %arg1, %none) {
    kernel_shape = [3, 3],
    auto_pad = "NOTSET"
  } : (tensor<1x28x28x64xi8>, tensor<3x3x64xi8>, none) -> tensor<1x26x26x64xi8>
  onnx.Return %0 : tensor<1x26x26x64xi8>
}
...
func.func @test_depthwise_conv_invalid_bias_rank(%arg0: tensor<1x28x28x64xi8>, %arg1: tensor<1x3x3x64xi8>, %arg2: tensor<1x64xi8>) -> tensor<1x26x26x64xi8> {
  // expected-error @+1 {{bias B must be 1D tensor [C], got rank 2}}
  %0 = "onnx.XCOMPILERDepthwiseConv"(%arg0, %arg1, %arg2) {
    kernel_shape = [3, 3],
    auto_pad = "NOTSET"
  } : (tensor<1x28x28x64xi8>, tensor<1x3x3x64xi8>, tensor<1x64xi8>) -> tensor<1x26x26x64xi8>
  onnx.Return %0 : tensor<1x26x26x64xi8>
}

// -----

// Test: depthwise conv weight channel multiplier must be 1 (first dim in IHWO)
// Weight IHWO: [M, kH, kW, C] - M should be 1
func.func @test_depthwise_conv_invalid_channel_multiplier(%arg0: tensor<1x28x28x64xi8>, %arg1: tensor<2x3x3x64xi8>) -> tensor<1x26x26x64xi8> {
  %none = "onnx.NoValue"() {value} : () -> none
  // expected-error @+1 {{depthwise conv weight channel multiplier (first dim) should be 1, got 2}}
  %0 = "onnx.XCOMPILERDepthwiseConv"(%arg0, %arg1, %none) {
    kernel_shape = [3, 3],
    auto_pad = "NOTSET"
  } : (tensor<1x28x28x64xi8>, tensor<2x3x3x64xi8>, none) -> tensor<1x26x26x64xi8>
  onnx.Return %0 : tensor<1x26x26x64xi8>
}

// -----

// Test: input channels must match weight channels (last dim in IHWO)
// Input: [N, H, W, C=64], Weight IHWO: [M=1, kH, kW, C=32]
func.func @test_depthwise_conv_channel_mismatch(%arg0: tensor<1x28x28x64xi8>, %arg1: tensor<1x3x3x32xi8>) -> tensor<1x26x26x64xi8> {
  %none = "onnx.NoValue"() {value} : () -> none
  // expected-error @+1 {{input channels (64) must match weight channels (32)}}
  %0 = "onnx.XCOMPILERDepthwiseConv"(%arg0, %arg1, %none) {
    kernel_shape = [3, 3],
    auto_pad = "NOTSET"
  } : (tensor<1x28x28x64xi8>, tensor<1x3x3x32xi8>, none) -> tensor<1x26x26x64xi8>
  onnx.Return %0 : tensor<1x26x26x64xi8>
}

// -----

// Test: Valid 2D depthwise conv (NHWC input, IHWO weight - should pass)
func.func @test_valid_depthwise_conv(%arg0: tensor<1x28x28x64xi8>, %arg1: tensor<1x3x3x64xi8>) -> tensor<1x26x26x64xi8> {
  %none = "onnx.NoValue"() {value} : () -> none
  %0 = "onnx.XCOMPILERDepthwiseConv"(%arg0, %arg1, %none) {
    kernel_shape = [3, 3],
    strides = [1, 1],
...
// Test: Valid 2D depthwise conv with bias (NHWC input, IHWO weight - should pass)
func.func @test_valid_depthwise_conv_with_bias(%arg0: tensor<1x28x28x64xi8>, %arg1: tensor<1x3x3x64xi8>, %arg2: tensor<64xi8>) -> tensor<1x26x26x64xi8> {
  %0 = "onnx.XCOMPILERDepthwiseConv"(%arg0, %arg1, %arg2) {
    kernel_shape = [3, 3],
    auto_pad = "NOTSET"
  } : (tensor<1x28x28x64xi8>, tensor<1x3x3x64xi8>, tensor<64xi8>) -> tensor<1x26x26x64xi8>
  onnx.Return %0 : tensor<1x26x26x64xi8>
}

// -----

// Test: Valid 3D depthwise conv (NDHWC input, IDHWO weight - should pass)
func.func @test_valid_depthwise_conv3d(%arg0: tensor<1x16x28x28x32xi8>, %arg1: tensor<1x3x3x3x32xi8>) -> tensor<1x14x26x26x32xi8> {
  %none = "onnx.NoValue"() {value} : () -> none
  %0 = "onnx.XCOMPILERDepthwiseConv"(%arg0, %arg1, %none) {
    kernel_shape = [3, 3, 3],
    strides = [1, 1, 1],
    ...
    dilations = [1, 1, 1],
    auto_pad = "NOTSET"
  } : (tensor<1x16x28x28x32xi8>, tensor<1x3x3x3x32xi8>, none) -> tensor<1x14x26x26x32xi8>
...
func.func @test_depthwise_conv3d_invalid_kernel_shape(%arg0: tensor<1x16x28x28x32xi8>, %arg1: tensor<1x3x3x3x32xi8>) -> tensor<1x14x26x26x32xi8> {
  %none = "onnx.NoValue"() {value} : () -> none
...
func.func @test_depthwise_conv3d_invalid_pads(%arg0: tensor<1x16x28x28x32xi8>, %arg1: tensor<1x3x3x3x32xi8>) -> tensor<1x16x28x28x32xi8> {
  %none = "onnx.NoValue"() {value} : () -> none
  ...
  %0 = "onnx.XCOMPILERDepthwiseConv"(%arg0, %arg1, %none) {
    ...
    pads = [1, 1, 1, 1],
    auto_pad = "NOTSET"
  } : (tensor<1x16x28x28x32xi8>, tensor<1x3x3x3x32xi8>, none) -> tensor<1x16x28x28x32xi8>
