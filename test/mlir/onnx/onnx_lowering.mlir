...
// CHECK:             [[INDEX_1:%.+]] = arith.index_cast [[LOAD_INDEX_1]] : i64 to index
...
// CHECK-DAG:         krnl.store [[DATA_VAL]], [[RES_BUFFER]][[[RES_BUFFER_INDEX_VAL]]] : memref<2xf32>
// CHECK-DAG:         [[PLUS_ONE:%.+]] = arith.addi [[RES_BUFFER_INDEX_VAL]], [[CST_1_0]] : index
// CHECK-DAG:         krnl.store [[PLUS_ONE]], [[RES_BUFFER_INDEX]][] : memref<index>
// CHECK:           }
