...
func @test_constant_dense_2d_value(%arg0: tensor<1xf32>) -> tensor<*xf32> {
  ...
  // CHECK: [[RES:%.+]] = "krnl.global"() {name = "constant_1", shape = [3, 2], value = dense<{{.*}}[0.000000e+00, 0.000000e+00], [1.000000e+00, 1.100000e+00], [2.000000e+00, 2.100000e+00]{{.*}}> : tensor<3x2xf32>} : () -> memref<3x2xf32>
