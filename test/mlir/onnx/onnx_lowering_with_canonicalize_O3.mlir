...
// CHECK-DAG:       [[VAR_cst_4_:%.+]] = arith.constant dense<1.42141378> : vector<4xf32>
// CHECK-DAG:       [[VAR_cst_5_:%.+]] = arith.constant dense<-0.284496725> : vector<4xf32>
// CHECK-DAG:       [[VAR_cst_6_:%.+]] = arith.constant dense<0.254829586> : vector<4xf32>
// CHECK-DAG:       [[VAR_cst_7_:%.+]] = arith.constant dense<-1.000000e+00> : vector<4xf32>
// CHECK-DAG:       [[VAR_cst_8_:%.+]] = arith.constant dense<1.000000e+00> : vector<4xf32>
// CHECK-DAG:       [[VAR_cst_9_:%.+]] = arith.constant dense<0.000000e+00> : vector<4xf32>
// CHECK-DAG:       [[CST_0_:%.+]] = arith.constant 0 : index
...
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_1_:%.+]] = affine.apply [[MAP_1_]](){{.}}[[VAR_dim_10_]]{{.}}
// CHECK-DAG:       [[RES_1_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK:           affine.store [[VAR_1_]], [[RES_1_]][0] : memref<1xindex>
...
// CHECK:             [[VAR_7_:%.+]] = arith.mulf [[VAR_6_]], [[VAR_cst_1_]] : vector<4xf32>
// CHECK:             [[VAR_8_:%.+]] = arith.addf [[VAR_7_]], [[VAR_cst_8_]] : vector<4xf32>
// CHECK:             [[VAR_9_:%.+]] = arith.divf [[VAR_cst_8_]], [[VAR_8_]] : vector<4xf32>
// CHECK:             [[VAR_10_:%.+]] = arith.mulf [[VAR_9_]], [[VAR_cst_2_]] : vector<4xf32>
// CHECK:             [[VAR_11_:%.+]] = arith.addf [[VAR_10_]], [[VAR_cst_3_]] : vector<4xf32>
// CHECK:             [[VAR_12_:%.+]] = arith.mulf [[VAR_11_]], [[VAR_9_]] : vector<4xf32>
// CHECK:             [[VAR_13_:%.+]] = arith.addf [[VAR_12_]], [[VAR_cst_4_]] : vector<4xf32>
// CHECK:             [[VAR_14_:%.+]] = arith.mulf [[VAR_13_]], [[VAR_9_]] : vector<4xf32>
// CHECK:             [[VAR_15_:%.+]] = arith.addf [[VAR_14_]], [[VAR_cst_5_]] : vector<4xf32>
// CHECK:             [[VAR_16_:%.+]] = arith.mulf [[VAR_15_]], [[VAR_9_]] : vector<4xf32>
// CHECK:             [[VAR_17_:%.+]] = arith.addf [[VAR_16_]], [[VAR_cst_6_]] : vector<4xf32>
// CHECK-DAG:         [[VAR_18_:%.+]] = arith.mulf [[VAR_17_]], [[VAR_9_]] : vector<4xf32>
// CHECK-DAG:         [[VAR_19_:%.+]] = arith.mulf [[VAR_6_]], [[VAR_cst_7_]] : vector<4xf32>
// CHECK-DAG:         [[VAR_20_:%.+]] = arith.mulf [[VAR_19_]], [[VAR_6_]] : vector<4xf32>
// CHECK:             [[VAR_21_:%.+]] = math.exp [[VAR_20_]] : vector<4xf32>
// CHECK:             [[VAR_22_:%.+]] = arith.mulf [[VAR_18_]], [[VAR_21_]] : vector<4xf32>
// CHECK-DAG:         [[VAR_23_:%.+]] = arith.subf [[VAR_cst_8_]], [[VAR_22_]] : vector<4xf32>
// CHECK-DAG:         [[VAR_24_:%.+]] = arith.cmpf ogt, [[LOAD_VAR_reshape_MEM_]], [[VAR_cst_9_]] : vector<4xf32>
// CHECK:             [[VAR_25_:%.+]] = arith.mulf [[VAR_23_]], [[VAR_cst_7_]] : vector<4xf32>
...
// CHECK:             [[VAR_29_:%.+]] = arith.select [[VAR_28_]], [[VAR_27_]], [[VAR_26_]] : vector<4xi1>, vector<4xf32>
