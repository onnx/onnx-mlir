...
// CHECK-DAG:             [[VAR_27_:%.+]] = affine.apply [[MAP_2_]]([[VAR_7_]]#1)
// CHECK:                 scf.for [[I_5_:%.+]] = [[VAR_7_]]#1 to [[VAR_27_]] step [[CST_1_]] {
// CHECK-DAG:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_7_]]#0, [[I_5_]], [[VAR_26_]]{{.}} : memref<?x?x768xf32>, vector<4xf32>
// CHECK-DAG:               [[VAR_29_:%.+]] = arith.subi [[I_5_]], [[VAR_7_]]#1 : index
// CHECK:                   [[LOAD_RES_3_MEM_2_:%.+]] = vector.load [[RES_3_]]{{.}}[[VAR_29_]], [[CST_0_]]{{.}} : memref<4x4xf32>, vector<4xf32>
// CHECK:                   [[VAR_31_:%.+]] = arith.addf [[LOAD_RES_3_MEM_2_]], [[LOAD_VAR_reshape_MEM_1_]] : vector<4xf32>
// CHECK:                   vector.store [[VAR_31_]], [[RES_3_]]{{.}}[[VAR_29_]], [[CST_0_]]{{.}} : memref<4x4xf32>, vector<4xf32>
// CHECK:                 }
// CHECK:               }
...
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:           [[VAR_17_1_:%.+]] = arith.addf [[LOAD_VAR_reshape_MEM_2_]], [[LOAD_RES_3_MEM_7_]] : vector<4xf32>
// CHECK-DAG:           [[VAR_18_:%.+]] = vector.shuffle [[LOAD_RES_3_MEM_5_]], [[LOAD_RES_3_MEM_6_]] [0, 4, 1, 5] : vector<4xf32>, vector<4xf32>
// CHECK-DAG:           [[VAR_19_:%.+]] = vector.shuffle [[LOAD_RES_3_MEM_5_]], [[LOAD_RES_3_MEM_6_]] [2, 6, 3, 7] : vector<4xf32>, vector<4xf32>
// CHECK:               [[VAR_20_:%.+]] = arith.addf [[VAR_18_]], [[VAR_19_]] : vector<4xf32>
// CHECK-DAG:           [[VAR_21_:%.+]] = vector.shuffle [[VAR_17_1_]], [[VAR_20_]] [0, 1, 4, 5] : vector<4xf32>, vector<4xf32>
// CHECK-DAG:           [[VAR_22_:%.+]] = vector.shuffle [[VAR_17_1_]], [[VAR_20_]] [2, 3, 6, 7] : vector<4xf32>, vector<4xf32>
// CHECK-NOT: separator of consecutive DAGs
...
// CHECK-DAG:             [[VAR_27_:%.+]] = affine.apply [[MAP_2_]]([[VAR_7_]]#1)
// CHECK:                 scf.for [[I_5_:%.+]] = [[VAR_7_]]#1 to [[VAR_27_]] step [[CST_1_]] {
// CHECK-DAG:               [[LOAD_VAR_reshape_MEM_1_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_7_]]#0, [[I_5_]], [[VAR_26_]]{{.}} : memref<?x?x776xf32>, vector<4xf32>
// CHECK-DAG:               [[VAR_29_:%.+]] = arith.subi [[I_5_]], [[VAR_7_]]#1 : index
// CHECK:                   [[LOAD_RES_3_MEM_2_:%.+]] = vector.load [[RES_3_]]{{.}}[[VAR_29_]], [[CST_0_]]{{.}} : memref<4x4xf32>, vector<4xf32>
// CHECK:                   [[VAR_31_:%.+]] = arith.addf [[LOAD_RES_3_MEM_2_]], [[LOAD_VAR_reshape_MEM_1_]] : vector<4xf32>
// CHECK:                   vector.store [[VAR_31_]], [[RES_3_]]{{.}}[[VAR_29_]], [[CST_0_]]{{.}} : memref<4x4xf32>, vector<4xf32>
