...
// CHECK-DAG:       [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK-DAG:           [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 4 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
...
// CHECK-DAG:             [[VAR_6_:%.+]] = math.absf [[LOAD_VAR_reshape_MEM_]] : vector<4xf32>
// CHECK-DAG:             [[VAR_7_:%.+]] = arith.mulf [[VAR_6_]], [[VAR_cst_1_]] : vector<4xf32>
// CHECK-DAG:             [[VAR_8_:%.+]] = arith.addf [[VAR_7_]], [[VAR_cst_8_]] : vector<4xf32>
// CHECK-DAG:             [[VAR_9_:%.+]] = arith.divf [[VAR_cst_8_]], [[VAR_8_]] : vector<4xf32>
// CHECK-DAG:             [[VAR_10_:%.+]] = arith.mulf [[VAR_9_]], [[VAR_cst_2_]] : vector<4xf32>
// CHECK-DAG:             [[VAR_11_:%.+]] = arith.addf [[VAR_10_]], [[VAR_cst_3_]] : vector<4xf32>
// CHECK-DAG:             [[VAR_12_:%.+]] = arith.mulf [[VAR_11_]], [[VAR_9_]] : vector<4xf32>
// CHECK-DAG:             [[VAR_13_:%.+]] = arith.addf [[VAR_12_]], [[VAR_cst_4_]] : vector<4xf32>
// CHECK-DAG:             [[VAR_14_:%.+]] = arith.mulf [[VAR_13_]], [[VAR_9_]] : vector<4xf32>
// CHECK-DAG:             [[VAR_15_:%.+]] = arith.addf [[VAR_14_]], [[VAR_cst_5_]] : vector<4xf32>
// CHECK-DAG:             [[VAR_16_:%.+]] = arith.mulf [[VAR_15_]], [[VAR_9_]] : vector<4xf32>
// CHECK-DAG:             [[VAR_17_:%.+]] = arith.addf [[VAR_16_]], [[VAR_cst_6_]] : vector<4xf32>
...
// CHECK-DAG:             [[VAR_21_:%.+]] = math.exp [[VAR_20_]] : vector<4xf32>
// CHECK-DAG:             [[VAR_22_:%.+]] = arith.mulf [[VAR_18_]], [[VAR_21_]] : vector<4xf32>
