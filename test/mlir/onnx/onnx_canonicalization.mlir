...
func.func @test_conv_batchnormtestmode_fusion_nobias(%arg0 : tensor<1x3x224x224xf32>) -> tensor<1x64x112x112xf32> {
    %cst = "onnx.NoValue"() {value} : () -> none
    %0 = "onnx.Constant"() {value = dense<0.0> : tensor<64x3x7x7xf32>} : () -> tensor<64x3x7x7xf32>
    ...
    %2 = "onnx.Constant"() {value = dense<1.0> : tensor<64xf32>} : () -> tensor<64xf32>
    %3 = "onnx.Constant"() {value = dense<2.0> : tensor<64xf32>} : () -> tensor<64xf32>
    %4 = "onnx.Constant"() {value = dense<3.0> : tensor<64xf32>} : () -> tensor<64xf32>
    %5 = "onnx.Constant"() {value = dense<4.0> : tensor<64xf32>} : () -> tensor<64xf32>
    ...
    // CHECK-DAG: [[WEIGHT:%.+]] = "onnx.Constant"() {value = dense<0.000000e+00> : tensor<64x3x7x7xf32>} : () -> tensor<64x3x7x7xf32>
    // CHECK-DAG: [[SCALE:%.+]] = "onnx.Constant"() {value = dense<1.000000e+00> : tensor<64xf32>} : () -> tensor<64xf32>
    // CHECK-DAG: [[B:%.+]] = "onnx.Constant"() {value = dense<2.000000e+00> : tensor<64xf32>} : () -> tensor<64xf32>
    // CHECK-DAG: [[MEAN:%.+]] = "onnx.Constant"() {value = dense<3.000000e+00> : tensor<64xf32>} : () -> tensor<64xf32>
    // CHECK-DAG: [[VARIANCE:%.+]] = "onnx.Constant"() {value = dense<4.000000e+00> : tensor<64xf32>} : () -> tensor<64xf32>
    // CHECK-DAG: [[EPSILON:%.+]] = "onnx.Constant"() {value = dense<1.00000007E-5> : tensor<1xf32>} : () -> tensor<1xf32>
...
// COM: func.func @test_shape1(%arg0 : tensor<2x4x8x16xf32>) -> tensor<*xi64> {
// COM:   %0 = "onnx.Shape"(%arg0) : (tensor<2x4x8x16xf32>) -> tensor<*xi64>
// COM:   return %0 : tensor<*xi64>
// COM:
// COM:  // CHECK-LABEL: @test_shape1
// COM:  // CHECK-NEXT: %0 = "onnx.Constant"() {value = dense<[2, 4, 8, 16]> : tensor<4xi64>} : () -> tensor<*xi64>
// COM:  // CHECK-NEXT: %0 : tensor<*xi64>
// COM: }
...
// COM: func.func @test_size1(%arg0 : tensor<2x4x8x16xf32>) -> tensor<*xi64> {
// COM:   %0 = "onnx.Size"(%arg0) : (tensor<2x4x8x16xf32>) -> tensor<*xi64>
// COM:   return %0 : tensor<*xi64>
// COM:
// COM:  // CHECK-LABEL: @test_size1
// COM:  // CHECK-NEXT: %0 = "onnx.Constant"() {value = dense<1024> : tensor<1xi64>} : () -> tensor<*xi64>
// COM:  // CHECK-NEXT: %0 : tensor<*xi64>
// COM: }
...
func.func @test_constant_1() -> tensor<1xi64> {
  %0 = "onnx.Constant"() {value_int = 1 : si64} : () -> tensor<1xi64>
  return %0 : tensor<1xi64>
// CHECK-LABEL:       func @test_constant_1
// CHECK:           [[VAR_0:%.+]] = "onnx.Constant"() {value = dense<1> : tensor<1xi64>} : () -> tensor<1xi64>
// CHECK:           return [[VAR_0]] : tensor<1xi64>
}

// -----

func.func @test_constant_2() -> tensor<1xf32> {
  %0 = "onnx.Constant"() {value_float = 2.0 : f32 } : () -> tensor<1xf32>
  return %0 : tensor<1xf32>
// CHECK-LABEL:     func @test_constant_2 
// CHECK: [[VAR_0:%.+]] = "onnx.Constant"() {value = dense<2.000000e+00> : tensor<1xf32>} : () -> tensor<1xf32>
// CHECK: return [[VAR_0]] : tensor<1xf32>
}

// -----

// COM: func.func @test_constant_1() -> tensor<?xi64> {
// COM:   %0 = "onnx.Constant"() {value_ints = [1, 2, 3] } : () -> tensor<?xi64>
// COM:   return %0 : tensor<?xi64>
// COM: // CHECK-LABEL:       func @test_constant_1
// COM: // CHECK-SAME:     () -> tensor<?xi64> {
// COM: // CHECK:           [[VAR_0:%.+]] = "onnx.Constant"() {value = dense<[1, 2, 3]> : tensor<3xi64>} : () -> tensor<?xi64>
// COM: // CHECK:           return [[VAR_0]] : tensor<?xi64>
// COM: }
...
func.func @test_rewrite_batchnormtestmode_Nd(%arg0 : tensor<1x64x112x112xf32>) -> tensor<1x64x112x112xf32> {
    ...
    %bias = "onnx.Constant"() {value = dense<2.0> : tensor<64xf32>} : () -> tensor<64xf32>
    %mean = "onnx.Constant"() {value = dense<3.0> : tensor<64xf32>} : () -> tensor<64xf32>
    %var = "onnx.Constant"() {value = dense<4.0> : tensor<64xf32>} : () -> tensor<64xf32>
    ...
    // CHECK-DAG: [[SCALE:%.*]] = "onnx.Constant"() {value = dense<1.000000e+00> : tensor<64xf32>} : () -> tensor<64xf32>
    // CHECK-DAG: [[BIAS:%.*]] = "onnx.Constant"() {value = dense<2.000000e+00> : tensor<64xf32>} : () -> tensor<64xf32>
    // CHECK-DAG: [[MEAN:%.*]] = "onnx.Constant"() {value = dense<3.000000e+00> : tensor<64xf32>} : () -> tensor<64xf32>
    // CHECK-DAG: [[VAR:%.*]] = "onnx.Constant"() {value = dense<4.000000e+00> : tensor<64xf32>} : () -> tensor<64xf32>
    // CHECK-DAG: [[EPSILON:%.*]] = "onnx.Constant"() {value = dense<1.00000007E-5> : tensor<1xf32>} : () -> tensor<1xf32>
...
func.func @test_rewrite_batchnormtestmode_1d(%arg0 : tensor<64xf32>) -> tensor<64xf32> {
    %scale = "onnx.Constant"() {value = dense<1.0> : tensor<1xf32>} : () -> tensor<1xf32>
    %bias = "onnx.Constant"() {value = dense<2.0> : tensor<1xf32>} : () -> tensor<1xf32>
    %mean = "onnx.Constant"() {value = dense<3.0> : tensor<1xf32>} : () -> tensor<1xf32>
    %var = "onnx.Constant"() {value = dense<4.0> : tensor<1xf32>} : () -> tensor<1xf32>
    ...
    // CHECK-DAG: [[SCALE:%.*]] = "onnx.Constant"() {value = dense<1.000000e+00> : tensor<1xf32>} : () -> tensor<1xf32>
    // CHECK-DAG: [[BIAS:%.*]] = "onnx.Constant"() {value = dense<2.000000e+00> : tensor<1xf32>} : () -> tensor<1xf32>
    // CHECK-DAG: [[MEAN:%.*]] = "onnx.Constant"() {value = dense<3.000000e+00> : tensor<1xf32>} : () -> tensor<1xf32>
    // CHECK-DAG: [[VAR:%.*]] = "onnx.Constant"() {value = dense<4.000000e+00> : tensor<1xf32>} : () -> tensor<1xf32>
    // CHECK-DAG: [[EPSILON:%.*]] = "onnx.Constant"() {value = dense<1.00000007E-5> : tensor<1xf32>} : () -> tensor<1xf32>
...
func.func @test_fuse_mul_conv(%arg0: tensor<1x1x28x28xf32>) -> tensor<*xf32> {
    ...
    // CHECK-DAG: [[Y:%.+]] = "onnx.Constant"() {value = dense<{{.*}}[-0.161539719{{.*}}, {{.*}}-0.433835655{{.*}}, {{.*}}0.091641359{{.*}}, {{.*}}-0.0168522168{{.*}}, {{.*}}-0.0650264397{{.*}}, {{.*}}-0.131737873{{.*}}, {{.*}}0.0204175506{{.*}}, {{.*}}-0.121110231{{.*}}> : tensor<8x1x1xf32>} : () -> tensor<8x1x1xf32>
...
// CHECK-DAG:       [[VAR_5_:%.+]] = "onnx.Constant"() {value = dense<4> : tensor<i32>} : () -> tensor<i32>
...
// CHECK-DAG:         [[VAR_15_:%.+]] = "onnx.Add"([[arg4_]], [[VAR_3_]]) : (tensor<i32>, tensor<i32>) -> tensor<i32>
