...
func @test_fuse_mul_conv(%arg0: tensor<1x1x28x28xf32>) -> tensor<1x8x28x28xf32> {
    ...
    %2 = "onnx.Conv"(%arg0, %0, %1) {kernel_shape = [2, 2], strides = [1, 1]} : (tensor<1x1x28x28xf32>, tensor<8x1x2x2xf32>, none) -> tensor<1x8x28x28xf32>
    ...
    %4 = "onnx.Mul"(%2, %3) : (tensor<1x8x28x28xf32>, tensor<8x1x1xf32>) -> tensor<1x8x28x28xf32>
    return %4 : tensor<1x8x28x28xf32>

    // CHECK-LABEL: test_fuse_mul_conv
    // CHECK-SAME:  ([[X:%.+]]: tensor<1x1x28x28xf32>) -> tensor<1x8x28x28xf32> {
    ...
    // CHECK: [[RES:%.+]] = "onnx.Conv"([[X]], [[W]], [[NOBIAS]]) {auto_pad = "NOTSET", group = 1 : si64, kernel_shape = [2, 2], strides = [1, 1]} : (tensor<1x1x28x28xf32>, tensor<8x1x2x2xf32>, none) -> tensor<1x8x28x28xf32>
    // CHECK: return [[RES]] : tensor<1x8x28x28xf32>
}
