...
// Check tensor name of block arg with tile applied to it
func.func @tile_block_arg(%arg0: tensor<1x3xf32> {onnx.name = "input"}) -> tensor<2x6xf32> {
...
// tile ResultNames has the list of reshape+tile transformations imposed to its tensor
func.func @tile_reshape(%arg0: tensor<1x6xf32> {onnx.name = "input"}) -> tensor<4x2x12xf32> {
