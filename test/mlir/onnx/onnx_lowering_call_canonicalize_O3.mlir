// RUN: onnx-mlir-opt -O3 --mtriple=s390x-ibm-loz --mcpu=z16 --shape-inference --convert-onnx-to-krnl='ops-for-call=onnx.Conv' --canonicalize %s -split-input-file | FileCheck %s
