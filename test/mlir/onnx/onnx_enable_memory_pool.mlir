...
#map = affine_map<()[s0] -> (s0, s0)>
  func @test_enable_memory_pool_3(%arg0: memref<?x?xf32>, %arg1: memref<?x10xf32>, %arg2: memref<10x10xf32>) -> memref<?x10xf32> {
    ...
    %2 = memref.alloc(%0) : memref<?x10xf32>
    %3:2 = krnl.define_loops 2
    ...
    %4 = affine.max #map()[%0]
    %5 = memref.alloc(%4) : memref<?x10xf32>
    ...
    %7 = memref.alloc(%0) : memref<?x10xf32>
    ...
    memref.dealloc %2 : memref<?x10xf32>
    memref.dealloc %5 : memref<?x10xf32>
...
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[DIM_0_:%.+]] = memref.dim [[PARAM_0_]], [[CST_0_]] : memref<?x?xf32>
// CHECK-DAG:       [[DIM_1_:%.+]] = memref.dim [[PARAM_0_]], [[CST_1_]] : memref<?x?xf32>
...
// CHECK:           [[RES_2_:%.+]] = memref.alloc([[VAR_9_]]) : memref<?xi8>
...
// CHECK:           }
// CHECK:           memref.dealloc [[RES_2_]] : memref<?xi8>
// CHECK:           memref.dealloc [[RES_]] : memref<?xi8>
