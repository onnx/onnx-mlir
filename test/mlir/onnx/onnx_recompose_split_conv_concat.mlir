//onnx-mlir-opt --recompose-onnx --remove-dead-values --constprop-onnx onnx_recompose_split_conv_concat.mlir  -split-input-file | FileCheck onnx_recompose_split_conv_concat.mlir
