...
func @test_bundle_memory_pool(%arg0: tensor<10x10xf32>, %arg1: tensor<10x20xf32>) -> tensor<10x20xf32> {
  ...
  // CHECK-DAG: [[CONST0:%.+]] = constant 0 : i64
  // CHECK-DAG: [[CONST00:%.+]] = constant 0.000000e+00 : f32
  // CHECK-DAG: [[CONST2400:%.+]] = constant 2400 : i64
  // CHECK-DAG: [[CONST2000:%.+]] = constant 2000 : i64
  // CHECK-DAG: [[CONST1200:%.+]] = constant 1200 : i64
  // CHECK-DAG: [[CONST400:%.+]] = constant 400 : i64
  // CHECK-DAG: [[RES:%.+]] = memref.alloc() : memref<10x20xf32>
  // CHECK-DAG: [[MEMPOOL:%.+]] = memref.alloc() : memref<3200xi8>
