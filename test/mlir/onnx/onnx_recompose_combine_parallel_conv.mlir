...
func.func @test_concat_order(%arg0: tensor<1x512x10x16xf32>, %wts0: tensor<256x512x3x3xf32>, %wts1: tensor<256x512x3x3xf32>, %wts2: tensor<256x512x3x3xf32>, %wts3: tensor<256x512x3x3xf32>) -> tensor<1x1024x10x16xf32> {
  %0 = onnx.Constant dense<[1, 256, 20, 32]> : tensor<4xi64>
  %1 = onnx.Constant dense<[2, 2, 256, 10, 16]> : tensor<5xi64>
  %2 = onnx.Constant dense<2.000000e-02> : tensor<256xf32>
    
  %7 = "onnx.Conv"(%arg0, %wts0, %2) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [3, 3], pads = [1, 1, 1, 1], strides = [1, 1]} : (tensor<1x512x10x16xf32>, 
    tensor<256x512x3x3xf32>, tensor<256xf32>) -> tensor<1x256x10x16xf32>    
  %8 = "onnx.Conv"(%arg0, %wts3, %2) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [3, 3], pads = [1, 1, 1, 1], strides = [1, 1]} : (tensor<1x512x10x16xf32>, tensor<256x512x3x3xf32>, tensor<256xf32>) -> tensor<1x256x10x16xf32>    
  %9 = "onnx.Conv"(%arg0, %wts1, %2) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [3, 3], pads = [1, 1, 1, 1], strides = [1, 1]} : (tensor<1x512x10x16xf32>, tensor<256x512x3x3xf32>, tensor<256xf32>) -> tensor<1x256x10x16xf32>    
  %10 = "onnx.Conv"(%arg0, %wts2, %2) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [3, 3], pads = [1, 1, 1, 1], strides = [1, 1]} : (tensor<1x512x10x16xf32>, tensor<256x512x3x3xf32>, tensor<256xf32>) -> tensor<1x256x10x16xf32>    
  %11 = "onnx.Concat"(%7, %9, %10, %8) {axis = 1 : si64} : (tensor<1x256x10x16xf32>, tensor<1x256x10x16xf32>, tensor<1x256x10x16xf32>, tensor<1x256x10x16xf32>) -> tensor<1x1024x10x16xf32>
  onnx.Return %11 : tensor<1x1024x10x16xf32>
// CHECK-LABEL:  func.func @test_concat_order
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x512x10x16xf32>, [[PARAM_1_:%.+]]: tensor<256x512x3x3xf32>, [[PARAM_2_:%.+]]: tensor<256x512x3x3xf32>, [[PARAM_3_:%.+]]: tensor<256x512x3x3xf32>, [[PARAM_4_:%.+]]: tensor<256x512x3x3xf32>) -> tensor<1x1024x10x16xf32> {
// CHECK-DAG:       [[VAR_0_:%.+]] = onnx.Constant dense<2.000000e-02> : tensor<1024xf32>
// CHECK-DAG:       [[VAR_1_:%.+]] = "onnx.Concat"([[PARAM_1_]], [[PARAM_2_]], [[PARAM_3_]], [[PARAM_4_]]) {axis = 0 : si64, onnx_node_name = "onnx.Concat_29"} : (tensor<256x512x3x3xf32>, tensor<256x512x3x3xf32>, tensor<256x512x3x3xf32>, tensor<256x512x3x3xf32>) -> tensor<1024x512x3x3xf32>
// CHECK:           [[VAR_2_:%.+]] = "onnx.Conv"([[PARAM_0_]], [[VAR_1_]], [[VAR_0_]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [3, 3], onnx_node_name = "onnx.Conv_30", pads = [1, 1, 1, 1], strides = [1, 1]} : (tensor<1x512x10x16xf32>, tensor<1024x512x3x3xf32>, tensor<1024xf32>) -> tensor<1x1024x10x16xf32>
// CHECK:           return [[VAR_2_]] : tensor<1x1024x10x16xf32>
// CHECK:         }
}

func.func @test_concat_multi_use(%arg0: tensor<1x512x10x16xf32>, %wts0: tensor<256x512x3x3xf32>, %wts1: tensor<256x512x3x3xf32>, %wts2: tensor<256x512x3x3xf32>, %wts3: tensor<256x512x3x3xf32>) -> tensor<1x1280x10x16xf32> {
  %0 = onnx.Constant dense<[1, 256, 20, 32]> : tensor<4xi64>
  %1 = onnx.Constant dense<[2, 2, 256, 10, 16]> : tensor<5xi64>
  %2 = onnx.Constant dense<2.000000e-02> : tensor<256xf32>
  ...
  %9 = "onnx.Conv"(%arg0, %wts1, %2) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [3, 3], pads = [1, 1, 1, 1], strides = [1, 1]} : (tensor<1x512x10x16xf32>, tensor<256x512x3x3xf32>, tensor<256xf32>) -> tensor<1x256x10x16xf32>    
  %10 = "onnx.Conv"(%arg0, %wts2, %2) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [3, 3], pads = [1, 1, 1, 1], strides = [1, 1]} : (tensor<1x512x10x16xf32>, tensor<256x512x3x3xf32>, tensor<256xf32>) -> tensor<1x256x10x16xf32>    
  %11 = "onnx.Concat"(%7, %9, %10, %8, %10) {axis = 1 : si64} : (tensor<1x256x10x16xf32>, tensor<1x256x10x16xf32>, tensor<1x256x10x16xf32>, tensor<1x256x10x16xf32>, tensor<1x256x10x16xf32>) -> tensor<1x1280x10x16xf32>
  onnx.Return %11 : tensor<1x1280x10x16xf32>
// CHECK-LABEL:  func.func @test_concat_multi_use
// CHECK-SAME:   ([[PARAM_0_:%.+]]: tensor<1x512x10x16xf32>, [[PARAM_1_:%.+]]: tensor<256x512x3x3xf32>, [[PARAM_2_:%.+]]: tensor<256x512x3x3xf32>, [[PARAM_3_:%.+]]: tensor<256x512x3x3xf32>, [[PARAM_4_:%.+]]: tensor<256x512x3x3xf32>) -> tensor<1x1280x10x16xf32> {
// CHECK-DAG:       [[VAR_0_:%.+]] = onnx.Constant dense<2.000000e-02> : tensor<1024xf32>
// CHECK-DAG:       [[VAR_1_:%.+]] = onnx.Constant dense<256> : tensor<4xi64>
// CHECK-DAG:       [[VAR_2_:%.+]] = "onnx.Concat"([[PARAM_3_]], [[PARAM_2_]], [[PARAM_4_]], [[PARAM_1_]]) {axis = 0 : si64, onnx_node_name = "onnx.Concat_31"} : (tensor<256x512x3x3xf32>, tensor<256x512x3x3xf32>, tensor<256x512x3x3xf32>, tensor<256x512x3x3xf32>) -> tensor<1024x512x3x3xf32>
// CHECK:           [[VAR_3_:%.+]] = "onnx.Conv"([[PARAM_0_]], [[VAR_2_]], [[VAR_0_]]) {auto_pad = "NOTSET", dilations = [1, 1], group = 1 : si64, kernel_shape = [3, 3], onnx_node_name = "onnx.Conv_32", pads = [1, 1, 1, 1], strides = [1, 1]} : (tensor<1x512x10x16xf32>, tensor<1024x512x3x3xf32>, tensor<1024xf32>) -> tensor<1x1024x10x16xf32>
// CHECK:           [[VAR_4_:%.+]]:4 = "onnx.Split"([[VAR_3_]], [[VAR_1_]]) {axis = 1 : si64, onnx_node_name = "onnx.Split_33"} : (tensor<1x1024x10x16xf32>, tensor<4xi64>) -> (tensor<1x256x10x16xf32>, tensor<1x256x10x16xf32>, tensor<1x256x10x16xf32>, tensor<1x256x10x16xf32>)
// CHECK:           [[VAR_5_:%.+]] = "onnx.Concat"([[VAR_4_]]#3, [[VAR_4_]]#1, [[VAR_4_]]#0, [[VAR_4_]]#2, [[VAR_4_]]#0) {axis = 1 : si64, onnx_node_name = "onnx.Concat_34"} : (tensor<1x256x10x16xf32>, tensor<1x256x10x16xf32>, tensor<1x256x10x16xf32>, tensor<1x256x10x16xf32>, tensor<1x256x10x16xf32>) -> tensor<1x1280x10x16xf32>
// CHECK:           return [[VAR_5_]] : tensor<1x1280x10x16xf32>
// CHECK:         }
}
