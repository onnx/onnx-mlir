...
// CHECK-DAG:       [[RES_2_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK-DAG:       [[CST_0_2_:%.+]] = arith.constant 0 : index
// CHECK:           affine.store [[CST_5_5_]], [[RES_2_]]{{.}}[[CST_0_2_]]{{.}} : memref<1xindex>
// CHECK-DAG:       [[VAR_reshape_17_:%.+]] = memref.reshape [[PARAM_1_]]([[RES_2_]]) : (memref<5xf32>, memref<1xindex>) -> memref<5xf32>
// CHECK-DAG:       [[CST_1_5_:%.+]] = arith.constant 1 : index
// CHECK-DAG:       [[CST_3_3_:%.+]] = arith.constant 3 : index
// CHECK-DAG:       [[CST_4_3_:%.+]] = arith.constant 4 : index
// CHECK-DAG:       [[CST_12_1_:%.+]] = arith.constant 12 : index
...
// CHECK-DAG:       [[RES_3_:%.+]] = memref.alloc() {{.*}}: memref<1xindex>
// CHECK-DAG:       [[CST_0_3_:%.+]] = arith.constant 0 : index
// CHECK:           affine.store [[CST_60_1_]], [[RES_3_]]{{.}}[[CST_0_3_]]{{.}} : memref<1xindex>
// CHECK-DAG:       [[VAR_reshape_26_:%.+]] = memref.reshape [[VAR_view_]]([[RES_3_]]) : (memref<3x4x5xf32>, memref<1xindex>) -> memref<60xf32>
// CHECK-DAG:       [[CST_60_2_:%.+]] = arith.constant 60 : index
// CHECK-DAG:       [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK:           [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 32 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
// CHECK:           [[CST_0_4_:%.+]] = arith.constant 0 : index
...
// CHECK:             [[VAR_1_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK-DAG:         [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_1_]]{{.}} : memref<60xf32>, vector<32xf32>
// CHECK-DAG:         [[LOAD_VAR_reshape_17_MEM_:%.+]] = vector.load [[VAR_reshape_17_]]{{.}}[[VAR_1_]]{{.}} : memref<5xf32>, vector<32xf32>
// CHECK-DAG:         [[CST_0_dot_000000_:%.+]] = arith.constant 0.000000e+00 : f32
// CHECK:             [[VAR_4_:%.+]] = vector.splat [[CST_0_dot_000000_]] : vector<32xf32>
// CHECK-DAG:         [[VAR_5_:%.+]] = arith.cmpf olt, [[LOAD_VAR_reshape_MEM_]], [[VAR_4_]] : vector<32xf32>
// CHECK-DAG:         [[VAR_6_:%.+]] = arith.mulf [[LOAD_VAR_reshape_17_MEM_]], [[LOAD_VAR_reshape_MEM_]] : vector<32xf32>
// CHECK:             [[VAR_7_:%.+]] = arith.select [[VAR_5_]], [[VAR_6_]], [[LOAD_VAR_reshape_MEM_]] : vector<32xi1>, vector<32xf32>
// CHECK:             vector.store [[VAR_7_]], [[VAR_reshape_26_]]{{.}}[[VAR_1_]]{{.}} : memref<60xf32>, vector<32xf32>
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<3x4x5xf32>
// CHECK:         }
}
...
// CHECK-DAG:       [[CST_0_2_:%.+]] = arith.constant 0 : index
// CHECK:           affine.store [[CST_5_5_]], [[RES_2_]]{{.}}[[CST_0_2_]]{{.}} : memref<1xindex>
// CHECK-DAG:       [[VAR_reshape_20_:%.+]] = memref.reshape [[PARAM_1_]]([[RES_2_]]) : (memref<1x5xf32>, memref<1xindex>) -> memref<5xf32>
// CHECK-DAG:       [[CST_1_8_:%.+]] = arith.constant 1 : index
// CHECK-DAG:       [[CST_3_3_:%.+]] = arith.constant 3 : index
// CHECK-DAG:       [[CST_4_3_:%.+]] = arith.constant 4 : index
// CHECK-DAG:       [[CST_12_1_:%.+]] = arith.constant 12 : index
...
// CHECK-DAG:       [[CST_0_3_:%.+]] = arith.constant 0 : index
// CHECK:           affine.store [[CST_60_1_]], [[RES_3_]]{{.}}[[CST_0_3_]]{{.}} : memref<1xindex>
// CHECK-DAG:       [[VAR_reshape_29_:%.+]] = memref.reshape [[VAR_view_]]([[RES_3_]]) : (memref<3x4x5xf32>, memref<1xindex>) -> memref<60xf32>
// CHECK-DAG:       [[CST_60_2_:%.+]] = arith.constant 60 : index
// CHECK-DAG:       [[LOOP_0_:%.+]] = krnl.define_loops 1
// CHECK:           [[BLOCK_TILE__0_:%.+]], [[BLOCK_IN__0_:%.+]] = krnl.block [[LOOP_0_]] 32 : (!krnl.loop) -> (!krnl.loop, !krnl.loop)
// CHECK:           [[CST_0_4_:%.+]] = arith.constant 0 : index
...
// CHECK:             [[VAR_1_:%.+]] = krnl.get_induction_var_value([[BLOCK_TILE__0_]]) : (!krnl.loop) -> index
// CHECK-DAG:         [[LOAD_VAR_reshape_MEM_:%.+]] = vector.load [[VAR_reshape_]]{{.}}[[VAR_1_]]{{.}} : memref<60xf32>, vector<32xf32>
// CHECK-DAG:         [[LOAD_VAR_reshape_20_MEM_:%.+]] = vector.load [[VAR_reshape_20_]]{{.}}[[VAR_1_]]{{.}} : memref<5xf32>, vector<32xf32>
// CHECK-DAG:         [[CST_0_dot_000000_:%.+]] = arith.constant 0.000000e+00 : f32
// CHECK:             [[VAR_4_:%.+]] = vector.splat [[CST_0_dot_000000_]] : vector<32xf32>
// CHECK-DAG:         [[VAR_5_:%.+]] = arith.cmpf olt, [[LOAD_VAR_reshape_MEM_]], [[VAR_4_]] : vector<32xf32>
// CHECK-DAG:         [[VAR_6_:%.+]] = arith.mulf [[LOAD_VAR_reshape_20_MEM_]], [[LOAD_VAR_reshape_MEM_]] : vector<32xf32>
// CHECK:             [[VAR_7_:%.+]] = arith.select [[VAR_5_]], [[VAR_6_]], [[LOAD_VAR_reshape_MEM_]] : vector<32xi1>, vector<32xf32>
// CHECK:             vector.store [[VAR_7_]], [[VAR_reshape_29_]]{{.}}[[VAR_1_]]{{.}} : memref<60xf32>, vector<32xf32>
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<3x4x5xf32>
// CHECK:         }
}
