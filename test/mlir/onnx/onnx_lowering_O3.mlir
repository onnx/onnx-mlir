...
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:         [[VAR_10_:%.+]] = vector.splat [[CST_0_dot_254829586_]] : vector<4xf32>
// CHECK-DAG:         [[CST_minus_0_dot_284496725_:%.+]] = arith.constant -0.284496725 : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:         [[VAR_11_:%.+]] = vector.splat [[CST_minus_0_dot_284496725_]] : vector<4xf32>
// CHECK-DAG:         [[CST_1_dot_42141378_:%.+]] = arith.constant 1.42141378 : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:         [[VAR_12_:%.+]] = vector.splat [[CST_1_dot_42141378_]] : vector<4xf32>
// CHECK-DAG:         [[CST_minus_1_dot_45315206_:%.+]] = arith.constant -1.45315206 : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:         [[VAR_13_:%.+]] = vector.splat [[CST_minus_1_dot_45315206_]] : vector<4xf32>
// CHECK-DAG:         [[CST_1_dot_06140542_:%.+]] = arith.constant 1.06140542 : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:         [[VAR_14_:%.+]] = vector.splat [[CST_1_dot_06140542_]] : vector<4xf32>
// CHECK-DAG:         [[CST_0_dot_327591091_:%.+]] = arith.constant 0.327591091 : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:         [[VAR_15_:%.+]] = vector.splat [[CST_0_dot_327591091_]] : vector<4xf32>
// CHECK-DAG:         [[VAR_16_:%.+]] = math.absf [[LOAD_VAR_reshape_MEM_]] : vector<4xf32>
// CHECK:             [[VAR_17_:%.+]] = arith.mulf [[VAR_15_]], [[VAR_16_]] : vector<4xf32>
// CHECK:             [[VAR_18_:%.+]] = arith.addf [[VAR_8_]], [[VAR_17_]] : vector<4xf32>
// CHECK:             [[VAR_19_:%.+]] = arith.divf [[VAR_8_]], [[VAR_18_]] : vector<4xf32>
// CHECK:             [[VAR_20_:%.+]] = arith.mulf [[VAR_14_]], [[VAR_19_]] : vector<4xf32>
// CHECK:             [[VAR_21_:%.+]] = arith.addf [[VAR_20_]], [[VAR_13_]] : vector<4xf32>
// CHECK:             [[VAR_22_:%.+]] = arith.mulf [[VAR_21_]], [[VAR_19_]] : vector<4xf32>
// CHECK:             [[VAR_23_:%.+]] = arith.addf [[VAR_22_]], [[VAR_12_]] : vector<4xf32>
// CHECK:             [[VAR_24_:%.+]] = arith.mulf [[VAR_23_]], [[VAR_19_]] : vector<4xf32>
// CHECK:             [[VAR_25_:%.+]] = arith.addf [[VAR_24_]], [[VAR_11_]] : vector<4xf32>
// CHECK:             [[VAR_26_:%.+]] = arith.mulf [[VAR_25_]], [[VAR_19_]] : vector<4xf32>
// CHECK:             [[VAR_27_:%.+]] = arith.addf [[VAR_26_]], [[VAR_10_]] : vector<4xf32>
// CHECK-DAG:         [[VAR_28_:%.+]] = arith.mulf [[VAR_27_]], [[VAR_19_]] : vector<4xf32>
// CHECK-DAG:         [[VAR_29_:%.+]] = arith.mulf [[VAR_9_]], [[VAR_16_]] : vector<4xf32>
// CHECK:             [[VAR_30_:%.+]] = arith.mulf [[VAR_29_]], [[VAR_16_]] : vector<4xf32>
// CHECK:             [[VAR_31_:%.+]] = math.exp [[VAR_30_]] : vector<4xf32>
// CHECK:             [[VAR_32_:%.+]] = arith.mulf [[VAR_28_]], [[VAR_31_]] : vector<4xf32>
// CHECK-DAG:         [[VAR_33_:%.+]] = arith.subf [[VAR_8_]], [[VAR_32_]] : vector<4xf32>
// CHECK-DAG:         [[VAR_34_:%.+]] = arith.cmpf ogt, [[LOAD_VAR_reshape_MEM_]], [[VAR_7_]] : vector<4xf32>
// CHECK:             [[VAR_35_:%.+]] = arith.mulf [[VAR_33_]], [[VAR_9_]] : vector<4xf32>
// CHECK:             [[VAR_36_:%.+]] = arith.select [[VAR_34_]], [[VAR_33_]], [[VAR_35_]] : vector<4xi1>, vector<4xf32>
// CHECK:             vector.store [[VAR_36_]], [[VAR_reshape_13_]]{{.}}[[VAR_5_]]{{.}} : memref<?xf32>, vector<4xf32>
// CHECK:           }
// CHECK:           return [[VAR_view_]] : memref<?x10xf32>
// CHECK:         }
}
