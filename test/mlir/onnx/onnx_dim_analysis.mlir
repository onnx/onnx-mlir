...
// CHECK-DAG:       [[VAR_6_:%.+]] = "onnx.Constant"() {value = dense<256> : tensor<1xi64>} : () -> tensor<1xi64>
...
// CHECK:           [[VAR_11_:%.+]] = "onnx.Constant"() {value = dense<[-1, 1, 256, 256]> : tensor<4xi64>} : () -> tensor<4xi64>
...
// CHECK:           [[VAR_13_:%.+]] = "onnx.Constant"() {value = dense<1.000000e+00> : tensor<f32>} : () -> tensor<f32>
...
// CHECK:           [[VAR_15_:%.+]] = "onnx.Constant"() {value = dense<-1.000000e+04> : tensor<f32>} : () -> tensor<f32>
...
// CHECK:           [[VAR_17_:%.+]] = "onnx.Constant"() {value = dense<[-1, 1, 256, 256]> : tensor<4xi64>} : () -> tensor<4xi64>
...
// CHECK:           [[VAR_19_:%.+]] = "onnx.Constant"() {value = dense<1.000000e+00> : tensor<f32>} : () -> tensor<f32>
...
// CHECK:           [[VAR_21_:%.+]] = "onnx.Constant"() {value = dense<-1.000000e+04> : tensor<f32>} : () -> tensor<f32>
