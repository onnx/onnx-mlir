...
// CHECK-DAG: #map2 = affine_map<(d0)[s0] -> (s0)>
...
// CHECK:           }
// CHECK:           "krnl.call"([[RES_2_]], [[X_]], [[VAR_c1_i64_]], [[VAR_c0_i64_]], [[VAR_c2_i64_]]) {funcName = "omTensorSort"} : (memref<?x?xindex>, memref<?x?xf32>, i64, i64, i64) -> ()
// CHECK:           [[LOOP_1_:%.+]]:2 = krnl.define_loops 2
// CHECK:           krnl.iterate([[LOOP_1_]]#0, [[LOOP_1_]]#1) with ([[LOOP_1_]]#0 -> [[I_5_:%.+]] = 0 to #map([[VAR_2_]]), [[LOOP_1_]]#1 -> [[I_6_:%.+]] = 0 to #map2([[VAR_2_]]){{.}}[[VAR_1_]]{{.}}){
// CHECK:             [[VAR_11_2_:%.+]]:2 = krnl.get_induction_var_value([[LOOP_1_]]#0, [[LOOP_1_]]#1) : (!krnl.loop, !krnl.loop) -> (index, index)
