...
func @test_global_maxpool(%arg0 : tensor<5x5x32x32xf32>) -> tensor<5x5x1x1xf32> {
  %0 = "onnx.GlobalMaxPool"(%arg0) : (tensor<5x5x32x32xf32>) -> tensor<5x5x1x1xf32>
  "std.return"(%0) : (tensor<5x5x1x1xf32>) -> ()
// CHECK-LABEL:  func @test_global_maxpool
// CHECK-SAME:   ([[INPUT_:%.+]]: memref<5x5x32x32xf32>) -> memref<5x5x1x1xf32> {
// CHECK-DAG:       [[CST_0_:%.+]] = constant 0xFF800000 : f32
// CHECK-DAG:       [[RES_:%.+]] = alloc() : memref<5x5x1x1xf32>
// CHECK-DAG:       [[LOOP_0_:%.+]]:2 = krnl.define_loops 2
// CHECK:           krnl.iterate([[LOOP_0_]]#0, [[LOOP_0_]]#1) with ([[LOOP_0_]]#0 -> [[I_0_:%.+]] = 0 to 5, [[LOOP_0_]]#1 -> [[I_1_:%.+]] = 0 to 5) {
// CHECK:             affine.store [[CST_0_]], [[RES_]][symbol([[I_0_]]), symbol([[I_1_]]), 0, 0] : memref<5x5x1x1xf32>
// CHECK:             [[LOOP_1_:%.+]]:2 = krnl.define_loops 2
// CHECK:             krnl.iterate([[LOOP_1_]]#0, [[LOOP_1_]]#1) with ([[LOOP_1_]]#0 -> [[I_2_:%.+]] = 0 to 32, [[LOOP_1_]]#1 -> [[I_3_:%.+]] = 0 to 32) {
// CHECK-DAG:           [[LOAD_RES_MEM_:%.+]] = affine.load [[RES_]][symbol([[I_0_]]), symbol([[I_1_]]), 0, 0] : memref<5x5x1x1xf32>
// CHECK-DAG:           [[LOAD_INPUT_MEM_:%.+]] = affine.load [[INPUT_]][symbol([[I_0_]]), symbol([[I_1_]]), symbol([[I_2_]]), symbol([[I_3_]])] : memref<5x5x32x32xf32>
// CHECK:               [[VAR_5_:%.+]] = cmpf "ogt", [[LOAD_RES_MEM_]], [[LOAD_INPUT_MEM_]] : f32
// CHECK:               [[VAR_6_:%.+]] = select [[VAR_5_]], [[LOAD_RES_MEM_]], [[LOAD_INPUT_MEM_]] : f32
// CHECK:               affine.store [[VAR_6_]], [[RES_]][symbol([[I_0_]]), symbol([[I_1_]]), 0, 0] : memref<5x5x1x1xf32>
// CHECK:             }
// CHECK:           }
// CHECK:           return [[RES_]] : memref<5x5x1x1xf32>
// CHECK:         }
}
...
func @test_global_averagepool(%arg0 : tensor<5x5x32x32xf32>) -> tensor<5x5x1x1xf32> {
  %0 = "onnx.GlobalAveragePool"(%arg0) : (tensor<5x5x32x32xf32>) -> tensor<5x5x1x1xf32>
  "std.return"(%0) : (tensor<5x5x1x1xf32>) -> ()
// CHECK-LABEL:  func @test_global_averagepool
// CHECK-SAME:   ([[INPUT_:%.+]]: memref<5x5x32x32xf32>) -> memref<5x5x1x1xf32> {
// CHECK-DAG:       [[CST_1024_:%.+]] = constant 1024 : i64
// CHECK-DAG:       [[CST_0_dot_000000_:%.+]] = constant 0.000000e+00 : f32
// CHECK-DAG:       [[RES_:%.+]] = alloc() : memref<5x5x1x1xf32>
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[NUM_ELEMENTS_:%.+]] = uitofp [[CST_1024_]] : i64 to f32
// CHECK-DAG:       [[LOOP_0_:%.+]]:2 = krnl.define_loops 2
// CHECK:           krnl.iterate([[LOOP_0_]]#0, [[LOOP_0_]]#1) with ([[LOOP_0_]]#0 -> [[I_0_:%.+]] = 0 to 5, [[LOOP_0_]]#1 -> [[I_1_:%.+]] = 0 to 5) {
// CHECK:             affine.store [[CST_0_dot_000000_]], [[RES_]][symbol([[I_0_]]), symbol([[I_1_]]), 0, 0] : memref<5x5x1x1xf32>
// CHECK:             [[LOOP_1_:%.+]]:2 = krnl.define_loops 2
// CHECK:             krnl.iterate([[LOOP_1_]]#0, [[LOOP_1_]]#1) with ([[LOOP_1_]]#0 -> [[I_2_:%.+]] = 0 to 32, [[LOOP_1_]]#1 -> [[I_3_:%.+]] = 0 to 32) {
// CHECK-DAG:           [[LOAD_RES_MEM_:%.+]] = affine.load [[RES_]][symbol([[I_0_]]), symbol([[I_1_]]), 0, 0] : memref<5x5x1x1xf32>
// CHECK-DAG:           [[LOAD_INPUT_MEM_:%.+]] = affine.load [[INPUT_]][symbol([[I_0_]]), symbol([[I_1_]]), symbol([[I_2_]]), symbol([[I_3_]])] : memref<5x5x32x32xf32>
// CHECK:               [[VAR_8_:%.+]] = addf [[LOAD_RES_MEM_]], [[LOAD_INPUT_MEM_]] : f32
// CHECK:               affine.store [[VAR_8_]], [[RES_]][symbol([[I_0_]]), symbol([[I_1_]]), 0, 0] : memref<5x5x1x1xf32>
// CHECK:             }
// CHECK:             [[LOAD_RES_MEM_1_:%.+]] = affine.load [[RES_]][symbol([[I_0_]]), symbol([[I_1_]]), 0, 0] : memref<5x5x1x1xf32>
// CHECK:             [[VAR_5_:%.+]] = divf [[LOAD_RES_MEM_1_]], [[NUM_ELEMENTS_]] : f32
// CHECK:             affine.store [[VAR_5_]], [[RES_]][symbol([[I_0_]]), symbol([[I_1_]]), 0, 0] : memref<5x5x1x1xf32>
// CHECK:           }
// CHECK:           return [[RES_]] : memref<5x5x1x1xf32>
// CHECK:         }
}
