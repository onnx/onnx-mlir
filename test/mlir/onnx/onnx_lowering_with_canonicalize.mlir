...
// CHECK:             [[VAR_31_:%.+]] = arith.cmpf ogt, [[LOAD_RES_5_MEM_]], [[LOAD_PARAM_0_MEM_]] : f32
// CHECK:             [[VAR_32_:%.+]] = arith.select [[VAR_31_]], [[LOAD_RES_5_MEM_]], [[LOAD_PARAM_0_MEM_]] : f32
...
// CHECK:             [[VAR_31_1_:%.+]] = arith.cmpf olt, [[LOAD_RES_5_MEM_1_]], [[LOAD_PARAM_0_MEM_1_]] : f32
// CHECK:             [[VAR_32_1_:%.+]] = arith.select [[VAR_31_1_]], [[LOAD_RES_5_MEM_1_]], [[LOAD_PARAM_0_MEM_1_]] : f32
...
// CHECK:           [[VAR_4_:%.+]] = arith.subf [[LOAD_RES_5_MEM_2_]], [[LOAD_RES_6_MEM_]] : f32
// CHECK:           [[VAR_5_:%.+]] = arith.divf [[VAR_4_]], [[CST_2_dot_550000_]] : f32
// CHECK:           krnl.store [[VAR_5_]], [[RES_1_]][] : memref<f32>
// CHECK:           [[VAR_6_:%.+]] = arith.subf [[CST_0_dot_000000_]], [[LOAD_RES_6_MEM_]] : f32
// CHECK:           [[VAR_7_:%.+]] = arith.divf [[VAR_6_]], [[VAR_5_]] : f32
// CHECK:           [[VAR_8_:%.+]] = arith.cmpf olt, [[VAR_7_]], [[CST_0_dot_000000_]] : f32
// CHECK:           [[VAR_9_:%.+]] = arith.select [[VAR_8_]], [[CST_0_dot_000000_]], [[VAR_7_]] : f32
// CHECK:           [[VAR_10_:%.+]] = arith.cmpf olt, [[VAR_9_]], [[CST_2_dot_550000_]] : f32
// CHECK:           [[VAR_11_:%.+]] = arith.select [[VAR_10_]], [[VAR_9_]], [[CST_2_dot_550000_]] : f32
...
// CHECK:             [[VAR_31_2_:%.+]] = arith.divf [[LOAD_PARAM_0_MEM_2_]], [[VAR_5_]] : f32
// CHECK:             [[VAR_32_2_:%.+]] = math.floor [[VAR_31_2_]] : f32
// CHECK:             [[VAR_33_:%.+]] = arith.subf [[VAR_31_2_]], [[VAR_32_2_]] : f32
// CHECK-DAG:         [[VAR_34_:%.+]] = arith.cmpf ogt, [[VAR_33_]], [[CST_5_dot_000000_]] : f32
// CHECK-DAG:         [[VAR_35_:%.+]] = arith.addf [[VAR_32_2_]], [[CST_1_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:         [[VAR_36_:%.+]] = arith.select [[VAR_34_]], [[VAR_35_]], [[VAR_32_2_]] : f32
// CHECK-DAG:         [[VAR_37_:%.+]] = arith.mulf [[VAR_32_2_]], [[CST_5_dot_000000_]] : f32
// CHECK:             [[VAR_38_:%.+]] = math.floor [[VAR_37_]] : f32
// CHECK:             [[VAR_39_:%.+]] = arith.mulf [[VAR_38_]], [[CST_2_dot_000000_]] : f32
// CHECK:             [[VAR_40_:%.+]] = arith.subf [[VAR_32_2_]], [[VAR_39_]] : f32
// CHECK-DAG:         [[VAR_41_:%.+]] = arith.cmpf oeq, [[VAR_40_]], [[CST_1_dot_000000_]] : f32
// CHECK-DAG:         [[VAR_42_:%.+]] = arith.addf [[VAR_32_2_]], [[CST_1_dot_000000_]] : f32
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:         [[VAR_43_:%.+]] = arith.select [[VAR_41_]], [[VAR_42_]], [[VAR_32_2_]] : f32
// CHECK-DAG:         [[VAR_44_:%.+]] = arith.cmpf oeq, [[VAR_33_]], [[CST_5_dot_000000_]] : f32
// CHECK:             [[VAR_45_:%.+]] = arith.select [[VAR_44_]], [[VAR_43_]], [[VAR_36_]] : f32
// CHECK:             [[VAR_46_:%.+]] = arith.addf [[VAR_45_]], [[VAR_25_]] : f32
// CHECK:             [[VAR_47_:%.+]] = arith.cmpf olt, [[VAR_46_]], [[CST_0_dot_000000_]] : f32
// CHECK:             [[VAR_48_:%.+]] = arith.select [[VAR_47_]], [[CST_0_dot_000000_]], [[VAR_46_]] : f32
// CHECK:             [[VAR_49_:%.+]] = arith.cmpf olt, [[VAR_48_]], [[CST_2_dot_550000_]] : f32
// CHECK:             [[VAR_50_:%.+]] = arith.select [[VAR_49_]], [[VAR_48_]], [[CST_2_dot_550000_]] : f32
// CHECK:             [[VAR_51_:%.+]] = arith.fptoui [[VAR_50_]] : f32 to i8
// CHECK:             [[VAR_52_:%.+]] = builtin.unrealized_conversion_cast [[VAR_51_]] : i8 to ui8
// CHECK:             krnl.store [[VAR_52_]], [[RES_]]{{.}}[[LOAD_PARAM_0_MEM_1_]]#0, [[LOAD_PARAM_0_MEM_1_]]#1] : memref<?x2xui8>
// CHECK:           }
