...
// RUN: onnx-mlir %t/invalid_output_path.mlir -o %t\abc 2>&1 | FileCheck --check-prefix=VALID %s
// RUN: onnx-mlir %t/invalid_output_path.mlir -o %t/abc 2>&1 | FileCheck --check-prefix=VALID %s
// RUN: onnx-mlir %t/invalid_output_path.mlir -o %t/abc. 2>&1 | FileCheck --check-prefix=VALID %s
// RUN: onnx-mlir %t/invalid_output_path.mlir -o %t/abc.. 2>&1 | FileCheck --check-prefix=VALID %s
// RUN: onnx-mlir %t/invalid_output_path.mlir -o %t/..abc.. 2>&1 | FileCheck --check-prefix=VALID %s

// RUN: onnx-mlir %t/invalid_output_path.mlir -o %t\ 2>&1 | FileCheck --check-prefix=INVALID %s
// RUN: onnx-mlir %t/invalid_output_path.mlir -o %t/ 2>&1 | FileCheck --check-prefix=INVALID %s
// RUN: onnx-mlir %t/invalid_output_path.mlir -o %t/. 2>&1 | FileCheck --check-prefix=INVALID %s
// RUN: onnx-mlir %t/invalid_output_path.mlir -o . 2>&1 | FileCheck --check-prefix=INVALID %s
// RUN: onnx-mlir %t/invalid_output_path.mlir -o .. 2>&1 | FileCheck --check-prefix=INVALID %s
