...
| **Cast** |13 |Cast only between float, short float, and double types. | |
...
| **MatMul** |13 | | |
| **MatMulInteger** |10 | | |
| **Max** |13 |No support for unsigned int. | |
...
| **Min** |13 |Does not support unsigned numbers. | |
| **Mish** | |unsupported | |
| **Mod** |13 |Support float, short float, and double only. | |
