...
### Check
<!--- keep this section in sync between InstallOnLinuxOSX.md and InstallOnWindows.md -->
...
To run the doc ONNX MLIR tests, use the following command after installing third_party ONNX  (see [instructions](mportONNXDefs.md)):
