...
4. The shared library to compile onnx-mlir models is generated by `PyOMCompileSession` (src/Runtime/PyOMCompileSession.hpp) and built as a shared library to `build/Debug/lib/PyCompileC.cpython-<target>.so`.
