...
4. The shared library to compile onnx-mlir models is generated by `PyOMCompilerSession` (src/Runtime/PyOMCompilerSession.hpp) and built as a shared library to `build/Debug/lib/PyCompileC.cpython-<target>.so`.
